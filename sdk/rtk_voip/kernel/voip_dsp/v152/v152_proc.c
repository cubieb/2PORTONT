...
static int voip_v152_read_proc(struct seq_file *f, void *v)
{
...
#if  defined(CONFIG_DEFAULTS_KERNEL_3_10)
static int v152_open(struct inode *inode, struct file *file)
{
	return single_open(file, voip_v152_read_proc, NULL);
}

struct file_operations proc_v152_fops = {
	.owner	= THIS_MODULE,
	.open	= v152_open,
	.read	= seq_read,
	.llseek	= seq_lseek,
	.release = single_release,
//read:   voip_v152_read_proc
};
#endif
...
#if  defined(CONFIG_DEFAULTS_KERNEL_3_10)
	create_voip_session_proc_read_entry( "v152", &proc_v152_fops );
#else		
