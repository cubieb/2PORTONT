...
const VpProfileDataType ZLR964124_IB90V_DEVICE[] =
{
/* Profile Header ---------------------------------------------------------- */
...
/* Raw MPI Section --------------------------------------------------------- */
   ...
   0x44, 0x06,             /* PCM Clock Slot = 0 TX / 0 RX; XE = Neg. */
   0x5E, 0x0C, 0x0A,       /* Device Mode Register */
...
/* Device Configuration Data - 100V BuckBoost */
const VpProfileDataType ZLR966122_BB100V_DEVICE[] =
{
/* Profile Header ---------------------------------------------------------- */
...
/* Formatted Parameters Section -------------------------------------------- */
   ...
   0x70,                   /* Dial pulse correction: 7 ms */
                           /* Switcher Configuration =
                              miSLIC BuckBoost (12 V in, 80 V out) */
   0x00, 0x00,             /* Over-current event threshold = Off */
   0x01,                   /* Leading edge blanking window = 81 ns */
   ...
   0x55, 0x55,             /* Switcher Limit Voltages 85 V, 85 V */
   0x04,                   /* Charge pump disabled */
                           /* Charge Pump Overload Protection: Disabled */
   0x3C                    /* Switcher Input 12 V */
};
...
/* Raw MPI Section --------------------------------------------------------- */
   0xC6, 0x92, 0x22,       /* DC Feed Parameters: ir_overhead = 100 ohm; */
                           ...
                           /* Maximum Voice Amplitude = 2.93 V */
/* Formatted Parameters Section -------------------------------------------- */
   0x27,                   /* Switch Hook Threshold = 14 mA */
                           /* Ground-Key Threshold = 24 mA */
   0x85,                   /* Switch Hook Debounce = 10 ms */
                           /* Ground-Key Debounce = 16 ms */
   0x58,                   /* Low-Power Switch Hook Hysteresis = 2 V */
                           /* Ground-Key Hysteresis = 6 mA */
                           /* Switch Hook Hysteresis = 2 mA */
...
const VpProfileDataType RING_MISLIC_BB_DEF_85_0[] =
{
/* Profile Header ---------------------------------------------------------- */
...
/* Raw MPI Section --------------------------------------------------------- */
   0xC0, 0x08, 0x00, 0x00, /* Ringing Generator Parameters: */
         0x00, 0x44, 0x46, /* 24.9 Hz Sine; 1.41 CF; 85.00 Vpk; 0.00 V bias */
         0x77, 0x00, 0x00, /* Ring trip cycles = 1; RTHALFCYC = 0 */
         0x00, 0x00,
/* Formatted Parameters Section -------------------------------------------- */
...
/* Default Ringing 25Hz 50Vrms, AC Trip - Use for all countries unless country profile exists */
