    ...
    VpDevCtxType *pDevCtx)
{
    ...
    if (pLineCtx != VP_NULL) {
        ...
        VpSysDebugPrintf("\n\n\rpLineObj->currentMonitor.samplingState = %d",
            pLineObj->currentMonitor.samplingState);
        VpSysDebugPrintf("\n\n\rpLineObj->currentMonitor.resultState = %d",
            pLineObj->currentMonitor.resultState);
        ...
        VpSysDebugPrintf("\n\rpLineObj->currentMonitor.transient = %s",
            ((pLineObj->currentMonitor.transient == TRUE) ? "TRUE" : "FALSE"));
#endif
