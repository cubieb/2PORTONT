 ...
 *
 * $Revision: 11719 $
 * $LastChangedDate: 2015-04-01 22:43:47 -0500 (Wed, 01 Apr 2015) $
 */
...
typedef struct VpTestDrawBreakDtType {
    uint16 drawWaitTime;    /* Indicates how long before looking for dial tone */
    uint16 freq1;           /* Indicates first frequency to look for */
    uint16 freq2;           /* Indicates first frequency to look for */
    VpDigitType breakDig;   /* Digit to use to break dial tone */
    uint16 breakWaitTime;   /* Indicates how long to wait for dial tone to be removed */
