    ...
    LtTestCtxType *pTestCtx)
{
    ...
    const int32 sFactor = ((VP890_UNIT_ADC_VAB * 10000L) /VP890_UNIT_MV);
    ...
    LtTestCtxType *pTestCtx)
{
    ...
    int16 hgMinIlg = (int16)VP890_UNIT_CONVERT(
            LT_VP890_RES_FLT_HG_MIN_ILG, VP890_UNIT_UA, VP890_UNIT_ADC_ILG);

    int16 hgMaxIlg = (int16)VP890_UNIT_CONVERT(
            LT_VP890_RES_FLT_DEFAULT_HG_MAX_ILG, VP890_UNIT_UA, VP890_UNIT_ADC_ILG);
    ...
    LtTestCtxType *pTestCtx)
{
    ...
    currentThreshold = (LT_VP890_RINGING_ST_ACRLOOP_ILR * 10000L) / 14142;

    /* Compute the rms voltage of the maximum clean sine wave, assuming
     * a defined source impedance as the only loop resistance */
    voltageThreshold = (currentThreshold * LT_VP890_RINGING_ST_SOURCE_IMPEDANCE) / 10000;
