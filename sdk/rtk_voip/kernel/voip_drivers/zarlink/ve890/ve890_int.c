            ...
            )
{
	...
	pDevObj->StartLineCap			= zarlinkLineTest;
#endif
	pDevObj->GetCalibrationCoeff	= zarlinkGetCoeff;
	pDevObj->SetCalibrationCoeff	= zarlinkSetCoeff;
	pDevObj->DoCalibration			= zarlinkDoCalibration;
