...
@comm
*/
static int32 __rtl867x_spi_init( rtl_spi_dev_t* pDev, uint32 gpioSCLK, uint32 gpioCS_, uint32 gpioSDO, uint32 gpioSDI)
{
	
	SPI_PRINTK("gpioSCLK = 0x[%x], gpioCS_ = 0x[%x], gpioSDO = 0x[%x], gpioSDI = 0x[%x]\n",
		gpioSCLK,  gpioCS_,  gpioSDO,  gpioSDI);
