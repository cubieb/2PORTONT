...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_600R_DEF[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_ETSI[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_GR57[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_AT[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_AU[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_BE[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_BG[] =
{
  /* AC Profile */
 0x0D, 0x00, 0xCB, 0x4C, 0x01, 0x49, 0xCA, 0xD4, 0x98, 0x23, 0xF1, 0x3D,
 0xA1, 0xB3, 0xA4, 0x33, 0x2B, 0xB3, 0xA5, 0x9A, 0xA2, 0xA2, 0x46, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_CH[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_CN[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_DE[] =
{
  /* AC Profile */
 0x0D, 0x00, 0xCB, 0x4C, 0x01, 0x49, 0xCA, 0xD4, 0x98, 0x23, 0xF1, 0x3D,
 0xA1, 0xB3, 0xA4, 0x33, 0x2B, 0xB3, 0xA5, 0x9A, 0xA2, 0xA2, 0x46, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_DK[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_ES[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_FI[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_FR[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_GB[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_HU[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_IE[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_IT[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_JP[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_NL[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_NO[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_NZ[] =
{
  /* AC Profile */
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_PT[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_SE[] =
{
  /* AC Profile */
 0xEE, 0x00, 0xE8, 0x4C, 0x01, 0x49, 0xCA, 0xD8, 0x98, 0x2A, 0xA2, 0x22,
 0xA1, 0x4B, 0xA2, 0x3A, 0xBF, 0x33, 0x2D, 0x9A, 0x23, 0xA2, 0x26, 0x6E,
...
const VpProfileDataType LE890_BB_AC_FXS_RF50_WB_ZA[] =
{
  /* AC Profile */
 0x0D, 0x00, 0xCB, 0x4C, 0x01, 0x49, 0xCA, 0xD4, 0x98, 0x23, 0xF1, 0x3D,
 0xA1, 0xB3, 0xA4, 0x33, 0x2B, 0xB3, 0xA5, 0x9A, 0xA2, 0xA2, 0x46, 0x6E,
