 ...
 *   Date:   Wednesday, March 25, 2015 14:40:22
...
const VpProfileDataType Le9661_DC_FXS_MISLIC_FB100V_DEF[] =
{
/* Profile Header ---------------------------------------------------------- */
...
const VpProfileDataType Le9661_DC_FXS_MISLIC_FB100V_CN[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x01, 0x00,       /* DC Profile for Le9661 device */
   0x0C,                   /* Profile length = 12 + 4 = 16 bytes */
...
const VpProfileDataType Le9661_DC_FXS_MISLIC_FB100V_ETSI[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x01, 0x00,       /* DC Profile for Le9661 device */
   0x0C,                   /* Profile length = 12 + 4 = 16 bytes */
...
const VpProfileDataType Le9661_DC_FXS_MISLIC_FB100V_US[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x01, 0x00,       /* DC Profile for Le9661 device */
   0x0C,                   /* Profile length = 12 + 4 = 16 bytes */
...
const VpProfileDataType Le9661_AC_FXS_RF14_600R_DEF[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_ETSI[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_GR57[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_AT[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_AU[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_BE[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_BG[] =
{
  /* AC Profile */
 0x6D, 0x00, 0xA7, 0x4C, 0x01, 0x49, 0xCA, 0xEA, 0x98, 0xFA, 0xE1, 0x23,
 0xA2, 0xEA, 0xCB, 0xB3, 0xAA, 0xA3, 0xB3, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_BR[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_CH[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_CN[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_DE[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_DK[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_ES[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_FI[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_FR[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_GB[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_GR[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_HU[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_IE[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_IL[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_IS[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_IT[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_JP[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_NL[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_NO[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_NZ[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_PT[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_RU[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_SE[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_TK[] =
{
  /* AC Profile */
 0xD5, 0x00, 0xEC, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x4A, 0xA1, 0x34,
 0xA2, 0xA2, 0xAC, 0x2C, 0xBB, 0x2B, 0xA4, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_ZA[] =
{
  /* AC Profile */
 0x6D, 0x00, 0xA7, 0x4C, 0x01, 0x49, 0xCA, 0xEA, 0x98, 0xFA, 0xE1, 0x23,
 0xA2, 0xEA, 0xCB, 0xB3, 0xAA, 0xA3, 0xB3, 0x9A, 0x98, 0x92, 0x97, 0x9F,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_600R_DEF[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_ETSI[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_GR57[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_AT[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_AU[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_BE[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_BG[] =
{
  /* AC Profile */
 0x30, 0x00, 0xC0, 0x4C, 0x01, 0x49, 0xCA, 0xDB, 0x98, 0xBA, 0xA1, 0xBA,
 0x22, 0x2A, 0xF4, 0xAA, 0xAB, 0x22, 0x65, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_BR[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_CH[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_CN[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_DE[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_DK[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_ES[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_FI[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_FR[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_GB[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_GR[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_HU[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_IE[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_IL[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_IS[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_IT[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_JP[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_NL[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_NO[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_NZ[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_PT[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_RU[] =
{
  /* AC Profile */
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_SE[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_TK[] =
{
  /* AC Profile */
 0xAA, 0x00, 0x9C, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xAA, 0xA3, 0x6B,
 0x22, 0x43, 0xA2, 0xAC, 0xBF, 0x22, 0xA6, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_AC_FXS_RF14_WB_ZA[] =
{
  /* AC Profile */
 0x27, 0x00, 0xD7, 0x4C, 0x01, 0x49, 0xCA, 0xDB, 0x98, 0xBA, 0xA1, 0xBA,
 0x22, 0x2A, 0xF4, 0xAA, 0xAB, 0x22, 0x65, 0x9A, 0x01, 0x90, 0x01, 0x01,
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_DEF[] =
{
/* Profile Header ---------------------------------------------------------- */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_AT[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_CA[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_FI[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_FR[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_HK[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_JP[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_KR[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_SG[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_TW[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_MISLIC_FB100V_US[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x04, 0x00,       /* Ringing Profile for Le9661 device */
   0x12,                   /* Profile length = 18 + 4 = 22 bytes */
...
const VpProfileDataType Le9661_RING_CAD_STD[] =
{
  /* Cadence Profile */
...
const VpProfileDataType Le9661_RING_CAD_SHORT[] =
{
  /* Cadence Profile */
...
const VpProfileDataType Le9661_METER_12KHZ_RF14[] =
{
/* Profile Header ---------------------------------------------------------- */
...
const VpProfileDataType Le9661_METER_16KHZ_RF14[] =
{
/* Profile Header ---------------------------------------------------------- */
   0x0D, 0x07, 0x00,       /* Metering Profile for Le9662_A device */
   0x08,                   /* Profile length = 8 + 4 = 12 bytes */
