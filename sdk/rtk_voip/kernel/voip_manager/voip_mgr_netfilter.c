...
static voip_mgr_entry_t voip_mgr_table[] = {
	...
	//! @ingroup VOIP_CONTROL
	{ M_NORMALBODY_MGR( VOIP_MGR_PCM_CFG, TstVoipCfg, ch_id ), },  
	...
	{ M_NORMAL_SND_MGR( VOIP_MGR_SLIC_OFFHOOK_ACTION, TstVoipCfg, ch_id ), },  	// only used in AudioCodes
	...
	//! @addtogroup VOIP_DSP_DTMF
	//! @ingroup VOIP_CONTROL	
	{ M_NORMAL_MGR( VOIP_MGR_SET_RFC2833_ENABLE_ABCDSIGNAL, TstVoip2833, ch_id ), }, 
	{ M_NORMAL_MGR( VOIP_MGR_SET_RFC2833_GENERATE_ABCDSIGNAL, TstVoip2833, ch_id ), },  	
	
	// Driver - SLIC
	//! @addtogroup VOIP_DRIVER_SLIC
	//! @ingroup VOIP_CONTROL	
	{ M_NORMAL_SND_MGR( VOIP_MGR_SET_MERTEPULSE, TstVoipSLICMeterPulse, chid ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_PORTDETECT, TstVoipSLICPortDetect, chid ), },	
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_LINEROH, TstVoipSLICLineRoh, chid ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_LINEVOLTAGE, TstVoipSLICLineVoltage, chid ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_LINERESFLT, TstVoipSLICLineResFlt, chid ), },	
	
	{ M_NORMAL_MGR( VOIP_MGR_SET_OFF_HOOK_TIME, TstVoipOffHook, ch_id ), },  	
	
	// Driver - GPIO  
	//! @addtogroup VOIP_DRIVER_GPIO
	//! @ingroup VOIP_CONTROL
	{ M_NORMALBODY_MGR( VOIP_MGR_GET_LED_STATUS, TstVoipLedDisplay, ch_id ), }, 	
	{ M_HOSTONLY_MGR( VOIP_MGR_SET_CALIBRATION_COEFFICIENTS, TstVoipCalibrationCoeff, ch_id ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_CALIBRATION_COEFFICIENTS, TstVoipCalibrationCoeff, ch_id ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_DO_CALIBRATION, TstVoipDoCalibration, ch_id ), },

	// Driver - SLIC
	//! @addtogroup VOIP_DRIVER_SLIC
	//! @ingroup VOIP_CONTROL
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_LINECAP, TstVoipSLICLineCap, chid ), },
	{ M_HOSTONLY_MGR( VOIP_MGR_GET_LINELOOPCURRENT, TstVoipSLICLineLoopCurrent, chid ), },		
};
...
label_not_voip_mgr_cmd:
	...
	/* FIXME:
	   diag: when running rg command with parameter containing "callback"
	   it causes the following to be invoked.
	   All functionalities were correct but the following prints a warning. */
