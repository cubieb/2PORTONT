...
M_EXTERN_DRIVER( VOIP_MGR_SET_MERTEPULSE );
M_EXTERN_DRIVER( VOIP_MGR_GET_PORTDETECT );
M_EXTERN_DRIVER( VOIP_MGR_GET_LINEROH );
M_EXTERN_DRIVER( VOIP_MGR_GET_LINEVOLTAGE );
M_EXTERN_DRIVER( VOIP_MGR_GET_LINERESFLT );
M_EXTERN_DRIVER( VOIP_MGR_SET_OFF_HOOK_TIME );
M_EXTERN_DRIVER( VOIP_MGR_SET_CALIBRATION_COEFFICIENTS );
M_EXTERN_DRIVER( VOIP_MGR_GET_CALIBRATION_COEFFICIENTS );
M_EXTERN_DRIVER( VOIP_MGR_DO_CALIBRATION );
M_EXTERN_DRIVER( VOIP_MGR_GET_LINECAP );
M_EXTERN_DRIVER( VOIP_MGR_GET_LINELOOPCURRENT );
...
M_EXTERN_DRIVER( VOIP_MGR_GET_LED_STATUS );
