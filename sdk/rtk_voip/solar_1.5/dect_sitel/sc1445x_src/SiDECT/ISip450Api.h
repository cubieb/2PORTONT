...
*
*  MODULE:                 Sip450Api
*  CONTROLLING DOCUMENT:   SIP450_API.doc   Revision: 35
*  SYSTEM DEPENDENCIES:
*
*  DESCRIPTION: Definition of the ISip450Api interface.
*
*               This file is generated by Word from the interface document:
*                  SIP450_API.doc using InterfaceMacro version 12
*
