...
voipCfgParam_t voipCfgParamDefault =
{
	...
	// ports[VOIP_PORTS]
	{
		// port 0
		{
			...
			1,					// cng
			0,					// cng threshold
			0,					// cng_gainmode, disable noise level configuration
			70,					// cng_noiselevel, -70dBov
			0,					// cng_noisegain, not change
			1,					// PLC
