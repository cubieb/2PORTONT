/*!
*  \file       cmbs_int.h
*  \brief      The file contains the internal structure and definitions of CMBS
            It does contain dependent and independent platform information
*  \author     stein
*
*  @(#)  %filespec: cfr_cmbs.h-1 %
*
*******************************************************************************
*  \par  History
*  \n==== History ============================================================\n
...
#define  CMBS_BUF_SIZE  1024      /*!< used message buffer size of each direction, especially used on target side */
...
typedef struct 
{
   ...
   u8                u8_IEBuffers[CMBS_BUF_SIZE];  /*!< buffer of a complete IE list */   
...
typedef  struct
{
   ...
   E_CMBS_ENDIAN     e_Endian;               /*!< edianess: 0 = little */
...
# if defined ( WIN32 )
   ...
   HANDLE            h_InitBlock;            /*!< handle to wait until CMBS is connected */
	...
	void *			   pv_DevCtrlHandle;		   /*!< handle of DEV control pipe */
# endif
#endif
