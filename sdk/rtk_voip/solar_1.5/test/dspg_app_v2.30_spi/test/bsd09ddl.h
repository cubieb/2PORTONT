 ...
 *
 * @(#)    %filespec: bsd09ddlo.ddl-BLRD53#E27.30 %
 */
 ...
 * -------------------------------------------------------------------
 * sergiym  14-Dec-2009   ?     added max numbers of states and events for trace process
...
#define PS_SEND_CLIP_REQ                           7  	/* = 0x07 */
#define MI_CONFERENCE_TONE_REQ                     8  	/* = 0x08 */
#define MLP_INST_RELEASED_IND                      9  	/* = 0x09 */
#define CM_CC_IWU_INFO_IND                        10  	/* = 0x0a */
#define CM_CC_MULTI_IWU_INFO_IND                  11  	/* = 0x0b */
#define MI_IWU_INFO_REQ                           12  	/* = 0x0c */
#define MI_MULTI_IWU_INFO_REQ                     13  	/* = 0x0d */
#define CM_CH_TRANS_RELEASE_REQ                   14  	/* = 0x0e */
#define CM_LINE_HOLD_REQ                          15  	/* = 0x0f */
#define CM_LINE_PARK_REQ                          16  	/* = 0x10 */
#define CM_CALL_LINE_REQ                          17  	/* = 0x11 */
#define CM_CONF_ALL_REQ                           18  	/* = 0x12 */
#define CM_CONF_ALL_EXT_REQ                       19  	/* = 0x13 */
#define CM_DROP_EXT_REQ                           20  	/* = 0x14 */
#define CM_DROP_INT_REQ                           21  	/* = 0x15 */
#define CM_CALLBACK_REQ                           22  	/* = 0x16 */
#define CM_CHANGE_ALERT_REQ                       23  	/* = 0x17 */
#define CM_CH_LINE_REQ                            24  	/* = 0x18 */
#define CM_CALLBACK_EXPIRED_REQ                   25  	/* = 0x19 */
#define CM_CALLBACK_RELEASE_REQ                   26  	/* = 0x1a */
#define CM_SPLIT_LINES_REQ                        27  	/* = 0x1b */
#define CM_SWITCH_LINE_REQ                        28  	/* = 0x1c */
#define CM_CONNECT_DTAM_REQ                       29  	/* = 0x1d */
#define CM_CC_CDC_NEGO_IND                        30  	/* = 0x1e */
#define CM_CC_MODIFY_IND                          31  	/* = 0x1f */
#define CM_CC_MODIFY_CFM                          32  	/* = 0x20 */
#define CM_CC_MOD_CHNG_IND                        33  	/* = 0x21 */
#define CM_CC_CFM_CODEC_IND                       34  	/* = 0x22 */
#define CM_TRIG_SER_CHNG_REQ                      35  	/* = 0x23 */
#define CM_CC_TRANS_TIMED_OUT                     36  	/* = 0x24 */
#define TTS_CM_END                                37  	/* = 0x25 */
#define LDS_CALL_REQ                              38  	/* = 0x26 */
#define SS_FACILITY_CFM                           39  	/* = 0x27 */
#define SS_FACILITY_IND                           40  	/* = 0x28 */
#define LA_SERVICE_RELEASE_REQ                    41  	/* = 0x29 */
#define MM_CODEC_IND                              42  	/* = 0x2a */
#define MM_IWU_INFO_IND                           43  	/* = 0x2b */
#define MM_TERM_CAP_IND                           44  	/* = 0x2c */
#define MNCM_IWU_INFO_REQ                         45  	/* = 0x2d */
#define CC_SETUP_IND                              46  	/* = 0x2e */
#define CC_CALL_IND                               47  	/* = 0x2f */
#define CC_CONNECT_IND                            48  	/* = 0x30 */
#define CC_CALL_PROC_IND                          49  	/* = 0x31 */
#define CC_ALERT_IND                              50  	/* = 0x32 */
#define CC_INFO_IND                               51  	/* = 0x33 */
#define CC_IWU_INFO_IND                           52  	/* = 0x34 */
#define CS_RELEASE_IND                            53  	/* = 0x35 */
#define SS_CS_FACILITY_IND                        54  	/* = 0x36 */
#define MM_CS_CODEC_IND                           55  	/* = 0x37 */
#define CC_SER_CHNG_IND                           56  	/* = 0x38 */
#define CC_SER_CHNG_RES                           57  	/* = 0x39 */
#define CC_UNKNOWN                                58  	/* = 0x3a */
#define PS_CALL_REQ                               59  	/* = 0x3b */
#define PS_CALL_CFM                               60  	/* = 0x3c */
#define PS_RELEASE_REQ                            61  	/* = 0x3d */
#define CM_CC_CHECKCM_IND                         62  	/* = 0x3e */
#define CM_CC_ALERT_IND                           63  	/* = 0x3f */
#define CM_CC_RELEASE_IND                         64  	/* = 0x40 */
#define CM_CC_SETUP_IND                           65  	/* = 0x41 */
#define CM_CC_CONNECT_IND                         66  	/* = 0x42 */
#define CM_CC_DIAL_IND                            67  	/* = 0x43 */
#define CM_CC_CALL_INFO_IND                       68  	/* = 0x44 */
#define CM_CC_CALL_PROC_IND                       69  	/* = 0x45 */
#define CM_CC_UPDATE_CALL_STATE_IND               70  	/* = 0x46 */
...
#define CM_CH_SWITCH_2_INT_IND                    18  	/* = 0x12 */
#define CM_CH_SPLIT_LINES_IND                     19  	/* = 0x13 */
#define CM_CH_DTAM_CONN_IND                       20  	/* = 0x14 */
#define CM_CH_USB_CONN_IND                        21  	/* = 0x15 */
#define CM_CH_DATA_CONN_IND                       22  	/* = 0x16 */
#define CM_CH_VOICE_TO_DATA_IND                   23  	/* = 0x17 */
#define CM_CH_CODEC_MOD_IND                       24  	/* = 0x18 */
#define CM_CH_TRANS_TIMED_OUT                     25  	/* = 0x19 */
#define CM_CH_CALL_TRANS_IND                      26  	/* = 0x1a */
#define CM_CH_LOC_HOLD_IND                        27  	/* = 0x1b */
#define CM_CH_CONNECT_TOG_IND                     28  	/* = 0x1c */
#define CM_CH_RELEASE_TOG_IND                     29  	/* = 0x1d */
...
#define MAX_NUMBER_OF_STATES_FOR_TRACE_PROCESS    42  	/* = 0x2a */
...
#define MAX_NUMBER_OF_EVENTS_FOR_TRACE_PROCESS    27  	/* = 0x1b */
...
;
 ...
 /* needed for some timer events in the MMI              */



/* == process FTMI: code= 11, nr.of inst.= 5, prio.= high ====== */
...
#define PS_LINE0_EXP                              30  	/* = 0x1e */
#define PS_LINE1_EXP                              31  	/* = 0x1f */
#define PS_LINE2_EXP                              32  	/* = 0x20 */
...
#define MI_PRE_OVERLAP_SENDING_LINE0_TMR_EXP     139  	/* = 0x8b */
#define MI_PRE_OVERLAP_SENDING_LINE1_TMR_EXP     140  	/* = 0x8c */
#define MI_PRE_OVERLAP_SENDING_LINE2_TMR_EXP     141  	/* = 0x8d */
#define MI_OVERLAP_SENDING_LINE0_TMR_EXP         142  	/* = 0x8e */
#define MI_OVERLAP_SENDING_LINE1_TMR_EXP         143  	/* = 0x8f */
#define MI_OVERLAP_SENDING_LINE2_TMR_EXP         144  	/* = 0x90 */
#define MI_CALL_INFO_IND                         145  	/* = 0x91 */
#define MI_KEYPAD_IND                            146  	/* = 0x92 */
#define DR_KEYPAD_IND                            147  	/* = 0x93 */
#define DR_KEYPAD_RELEASE_IND                    148  	/* = 0x94 */
#define MI_DH_DATA_IND                           149  	/* = 0x95 */
#define MI_DH_DATA_CALL_REL                      150  	/* = 0x96 */
#define MI_DH_TIMER1_EXP                         151  	/* = 0x97 */
#define MI_DH_TIMER2_EXP                         152  	/* = 0x98 */
#define MI_DH_TIMER3_EXP                         153  	/* = 0x99 */
#define MI_DH_TIMER4_EXP                         154  	/* = 0x9a */
#define MI_DATA_MODE_IND                         155  	/* = 0x9b */
#define MI_LUX_SDU_RCVD                          156  	/* = 0x9c */
#define MI_LUX_SDU_SENT                          157  	/* = 0x9d */
#define MI_LUX_SDU_SEND_ERR                      158  	/* = 0x9e */
#define MI_LUX_SESSION_CLOSED                    159  	/* = 0x9f */
#define APP_NEMO_PEND                            160  	/* = 0xa0 */
#define APP_NEMO_IND                             161  	/* = 0xa1 */
#define APP_NEMO_STOP                            162  	/* = 0xa2 */
#define APP_NEMO_WAKEUP                          163  	/* = 0xa3 */
#define SIN_FAIL_IND                             164  	/* = 0xa4 */
#define SIN_PENDING_IND                          165  	/* = 0xa5 */
#define SIN_SETUP_CFM                            166  	/* = 0xa6 */
#define SIN_STOP_CFM                             167  	/* = 0xa7 */
#define MI_MAS_READY                             168  	/* = 0xa8 */
#define MI_MAS_ARM_REQ                           169  	/* = 0xa9 */
#define MI_MAS_ARMBG_REQ                         170  	/* = 0xaa */
#define MI_MAS_REAL_REQ                          171  	/* = 0xab */
#define MI_MAS_ARM_IDLE_REQ                      172  	/* = 0xac */
#define MI_MAS_REAL_IDLE_REQ                     173  	/* = 0xad */
#define MI_SCORE_SELECT_IND                      174  	/* = 0xae */
#define MI_SCORE_PLAY_IND                        175  	/* = 0xaf */
#define MI_SCORE_STOP_IND                        176  	/* = 0xb0 */
#define MI_SCORE_PREPARED                        177  	/* = 0xb1 */
#define MI_SCORE_NOT_FOUND                       178  	/* = 0xb2 */
#define MI_SCORE_TYPE                            179  	/* = 0xb3 */
#define MI_SCORE_FILE_ERROR                      180  	/* = 0xb4 */
#define MI_SCORE_DATALATE                        181  	/* = 0xb5 */
#define MI_SCORE_LIMIT                           182  	/* = 0xb6 */
#define MI_SCORE_TEMPO                           183  	/* = 0xb7 */
#define MI_STOP_POLYPHONIC                       184  	/* = 0xb8 */
#define MI_MCV                                   185  	/* = 0xb9 */
#define MI_MCV_MThd                              186  	/* = 0xba */
#define MI_MCV_MTrk                              187  	/* = 0xbb */
#define MI_MCV_MEvent                            188  	/* = 0xbc */
#define MI_MCV_BUFSZ                             189  	/* = 0xbd */
#define MI_MCV_FILMEM                            190  	/* = 0xbe */
#define MI_MCV_FILE_NOT_FOUND                    191  	/* = 0xbf */
#define MI_MCVIO                                 192  	/* = 0xc0 */
#define MI_MCVIO_CLOSE                           193  	/* = 0xc1 */
#define MI_MCVIO_RENAME                          194  	/* = 0xc2 */
#define MI_MCVIO_DELETE                          195  	/* = 0xc3 */
#define MI_MCVIO_WRITE                           196  	/* = 0xc4 */
#define MI_MCVIO_READ                            197  	/* = 0xc5 */
#define MI_MCVIO_SEEK                            198  	/* = 0xc6 */
#define MI_MCVIO_CREATE                          199  	/* = 0xc7 */
#define MI_MCVIO_OPEN                            200  	/* = 0xc8 */
#define MI_ENCRYPTED_CALL_IND                    201  	/* = 0xc9 */
#define MI_ENCRYPT_REJECT_IND                    202  	/* = 0xca */
#define MI_CALL_REINJECT_IND                     203  	/* = 0xcb */
...
PUBLIC u8 const * const G_pu8_os09_EventNames_11[]
 ...
 = {
    ...
    (u8 const *)"PS_LINE0_EXP",
    (u8 const *)"PS_LINE1_EXP",
    (u8 const *)"PS_LINE2_EXP",
    ...
    (u8 const *)"MI_PRE_OVERLAP_SENDING_LINE0_TMR_EXP",
    (u8 const *)"MI_PRE_OVERLAP_SENDING_LINE1_TMR_EXP",
    (u8 const *)"MI_PRE_OVERLAP_SENDING_LINE2_TMR_EXP",
    (u8 const *)"MI_OVERLAP_SENDING_LINE0_TMR_EXP",
    (u8 const *)"MI_OVERLAP_SENDING_LINE1_TMR_EXP",
    (u8 const *)"MI_OVERLAP_SENDING_LINE2_TMR_EXP",
...
;
 ...
 /* make sure the next processes dont have more         */
...
/* -- states: -- */
#define FTLA_IDLE                                  0  	/* = 0x00 */
#define FTLA_RUN                                   1  	/* = 0x01 */
...
#endif
/* -- events: -- */
#define LA_EVENT_IND                               0  	/* = 0x00 */
#define LA_SERVICE_CONN_IND                        1  	/* = 0x01 */
#define LA_SERVICE_LINK_REL_IND                    2  	/* = 0x02 */
#define LA_SERVICE_RELEASE_IND                     3  	/* = 0x03 */
#define LA_IWU_INFO_IND                            4  	/* = 0x04 */
#define CSM_LA_INFO_REQ_CFM                        5  	/* = 0x05 */
#define LA_FACILITY_REQ                            6  	/* = 0x06 */
#define LA_TIME_STAMP_REQ                          7  	/* = 0x07 */
#define LA_ESCAP_TO_PROP_REQ                       8  	/* = 0x08 */
#define LA_HS_SUBSC_IND                            9  	/* = 0x09 */
#define LA_HS_DESUBSC_IND                         10  	/* = 0x0a */

#if (OS_DEBUG)
PUBLIC u8 const * const G_pu8_os09_EventNames_15[]
#ifdef cos19_c
 = {
    (u8 const *)"LA_EVENT_IND",
    (u8 const *)"LA_SERVICE_CONN_IND",
    (u8 const *)"LA_SERVICE_LINK_REL_IND",
...
/* == process TERMINAL: code= 16, nr.of inst.= 1, prio.= low ====== */
...
/* == process FTTTS: code= 17, nr.of inst.= 1, prio.= low ====== */
...
/* == process FWUP_TASK: code= 18, nr.of inst.= 1, prio.= low ====== */
...
/* == process CMBSTASK: code= 19, nr.of inst.= 1, prio.= low ====== */
...
#define OS09_NR_OF_PROCESSES        20
#define OS09_LEN_OF_STATE_TABLE     80
#define OS09_1ST_LOW_PRIO_PROCESS   16
...
#define FTCLI_ID          14
#define FTLA_ID           15
#define TERMINAL_ID       16
#define FTTTS_ID          17
#define FWUP_TASK_ID      18
#define CMBSTASK_ID       19
