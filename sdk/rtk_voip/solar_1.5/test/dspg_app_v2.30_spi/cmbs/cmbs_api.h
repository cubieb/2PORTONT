...
typedef enum
{
   ...
   CMBS_EV_DSR_HS_SUBSCRIBED,             /*!< Request information about subcribed handsets */
...
typedef enum
{
   ...
   CMBS_IE_LA_FLD_NUMBER,           /*!< List entry field 'Number' */
   CMBS_IE_LA_FLD_NAME,             /*!< List entry field 'Name' */
   CMBS_IE_LA_FLD_DATETIME,         /*!< List entry field 'Date and time' */
   CMBS_IE_LA_FLD_NEW,              /*!< List entry field 'New' */
   CMBS_IE_LA_FLD_LINE_NAME,        /*!< List entry field 'Line name' */
   CMBS_IE_LA_FLD_LINE_ID,          /*!< List entry field 'Line Id' */
   CMBS_IE_LA_FLD_NR_OF_CALLS,      /*!< List entry field 'Number of calls' */
   CMBS_IE_LA_FLD_CALL_TYPE,        /*!< List entry field 'Call type' */
   CMBS_IE_LA_FLD_FIRST_NAME,       /*!< List entry field 'First name' */
   CMBS_IE_LA_FLD_CONTACT_NR,       /*!< List entry field 'Contact number' */
   CMBS_IE_LA_FLD_ASSOC_MDY,        /*!< List entry field 'Associated melody' */
...
///DNA extension
   ...
   /* ALTDV */
   CMBS_PARAM_HS_LST,            /*!<List of registered handsets */ 
   CMBS_PARAM_MAX
} E_CMBS_PARAM;
...
/* ALTDV */
/*! \brief structure for CMBS_HS_CONTAINER */
typedef struct
{
    u16    u16_HsNo;
    u8     u8_HsName[10];
    u16    u16_Length;
}ST_HS_CONTAINER, * PST_HS_CONTAINER;
...
//*/
//    ==========  cmbs_dsr_hs_Registered  ===========
/*!
      \brief
         Request information about subcribed handsets.

         <h2>cmbs_dsr_hs_Registered</h2>
      ...
      <h3>API Functions description</h3>
         <b>
         E_CMBS_RC         cmbs_dsr_hs_Registered( void * pv_AppRefHandle )
         </b><br><br>
