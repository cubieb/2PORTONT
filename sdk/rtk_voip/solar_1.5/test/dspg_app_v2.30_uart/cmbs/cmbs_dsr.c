...
E_CMBS_RC         cmbs_dsr_hs_StopPaging( void * pv_AppRefHandle )
{
   ...
   return cmbs_int_EventSend( CMBS_EV_DSR_HS_STOP_PAGING, NULL, 0 );
}
                                             ...
                                             E_CMBS_RESPONSE e_Response)
{
   ...
   return cmbs_int_EventSend( CMBS_EV_DSR_LA_DATA_PACKET_SEND_RES, p_List->pu8_Buffer, p_List->u16_CurSize );
}
