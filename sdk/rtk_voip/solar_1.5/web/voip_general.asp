...
function cng_enable()
{
	document.sipform.cng_mode.disabled = !document.sipform.useCng.checked;
	document.sipform.Cng_noiselevel.disabled = (!document.sipform.cng_mode[1].checked) || (!document.sipform.useCng.checked) ;
	document.sipform.Cng_noisegain.disabled = (!document.sipform.cng_mode[2].checked) || (!document.sipform.useCng.checked) ;
}
...
-->
	...
	<tr>
		...
		<td bgColor=#ddeeff width=170>
		<input type=checkbox name=useCng size=20 onClick="cng_enable()" <%voip_general_get("useCng");%>>Enable
		</td>
		<td bgColor=#ddeeff></td>
	</tr>

	<tr>
		<td bgColor=#aaddff width=155 rowspan=3>CNG Noise Level</td>

		<td bgColor=#ddeeff ><input type=radio name=cng_mode value=0  onClick="cng_enable()" <%voip_general_get("cng_config_enable");%>>Disable configuration </td>
		<td bgColor=#ddeeff></td> <tr>
		<td bgColor=#ddeeff ><input type=radio name=cng_mode value=1  onClick="cng_enable()" <%voip_general_get("cng_fixed_level");%>>Fixed noise level  </td>
		<td bgColor=#ddeeff ><input type=text name=Cng_noiselevel size=4 maxlength=3 value="<%voip_general_get("Cng_noiselevel");%>"> (0>Value>127 dBov)	</td> <tr>

		<td bgColor=#ddeeff ><input type=radio name=cng_mode value=2  onClick="cng_enable()" <%voip_general_get("cng_adjust_level");%>>According to the CN payload to adjust noise level</td>
		<td bgColor=#ddeeff ><input type=text name=Cng_noisegain size=4 maxlength=4 value="<%voip_general_get("Cng_noisegain");%>">(-127~127 dBov, 0:Not change)</td> <tr>
	</tr>

<script language=javascript>cng_enable()</script>
