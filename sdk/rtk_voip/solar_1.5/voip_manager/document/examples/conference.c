	...
	for (chid=0; chid<SLIC_CH_NUM; chid++)
	{
		...
		case SIGN_HASH:
		{
			...
			else if (val == SIGN_HASH)
			{
				...
				codec_config[chid][ssid].bT38ParamEnable = 0;
				codec_config[chid][ssid].nT38MaxBuffer = 0;
				codec_config[chid][ssid].nT38RateMgt = 0;
				codec_config[chid][ssid].nT38MaxRate = 0;
				codec_config[chid][ssid].bT38EnableECM = 0;
				codec_config[chid][ssid].nT38ECCSignal = 0;
				codec_config[chid][ssid].nT38ECCData = 0;
