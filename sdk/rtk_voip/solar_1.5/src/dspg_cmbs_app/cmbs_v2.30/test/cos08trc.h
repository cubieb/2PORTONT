 ...
 * Name         Date        V.  Action
 * --------------------------------------------------------------------
 * sergiym      14-Dec-2009 ?   add trace for message put
...
void p_os18_TracePSI (u32 u32_HPrio);
void p_os18_TraceExit(u32 u32_HPrio);
#else
void p_os18_TracePSI(void);
void p_os18_TraceExit(void);
#endif
#else
#define p_os18_TracePSI()    /* nothing */
#define p_os18_TraceExit()   /* nothing */
#endif
