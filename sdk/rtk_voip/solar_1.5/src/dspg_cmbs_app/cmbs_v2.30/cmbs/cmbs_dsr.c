...
E_CMBS_RC         cmbs_dsr_param_Get( void * pv_AppRefHandle, E_CMBS_PARAM_TYPE e_ParamType, E_CMBS_PARAM e_Param )
{
   ...
   {
                                    // currently only parameter type EEPROM supported
...
E_CMBS_RC         cmbs_dsr_hs_Registered( void * pv_AppRefHandle, E_CMBS_PARAM e_Param )
{
	PST_CFR_IE_LIST   p_List;
	ST_IE_PARAMETER   st_Param;
   ...
   return cmbs_int_EventSend( CMBS_EV_DSR_HS_SUBSCRIBED, p_List->pu8_Buffer, p_List->u16_CurSize );
}
