...
{
    CMBS_IE_UNDEF,
    CMBS_IE_CALLINSTANCE,            /* 1 !< Call Instance identifier */
    CMBS_IE_CALLERPARTY,             /* 2 !< Caller ID and its properties */
    CMBS_IE_CALLERNAME,              /* 3 !< Caller Name */
    CMBS_IE_CALLEDPARTY,             /* 4 !< Called ID, e.g. handset, group, line number */
    CMBS_IE_CALLPROGRESS,            /* 5 !< Progress information e.g. ringing, alert, tone selection, etc. */
    CMBS_IE_CALLINFO,                /* 6 !< Out of band information, e.g. digits, keys, etc. */
    CMBS_IE_DISPLAY_STRING,          /* 7 !< String container to display content on handset */
    CMBS_IE_CALLRELEASE_REASON,      /* 8 !< Call Release Reason */
    CMBS_IE_CALLSTATE,               /* 9 !< Call State */
    CMBS_IE_MEDIACHANNEL,            /* 10 !< Channel ID and Type */
    CMBS_IE_MEDIA_INTERNAL_CONNECT,  /* 11 !< Channel ID and Type */
    CMBS_IE_MEDIADESCRIPTOR,         /* 12 !< Description of media properties, e.g. codec, priority, etc. */
    CMBS_IE_TONE,                    /* 13 !< Tone properties for the tone generator */
    CMBS_IE_TIMEOFDAY,               /* 14 !< Time in ms since 01.01.1970 */
    CMBS_IE_HANDSETINFO,             /* 15 !< HS number, status, type, model and IPEI */
    CMBS_IE_PARAMETER,               /* 16 !< CMBS parameter */
    CMBS_IE_SUBSCRIBED_HS_LIST,      /* 17 !< List of subscribed handsets */
    CMBS_IE_LINE_SETTINGS_LIST,      /* 18 !< List of Line settings */
    CMBS_IE_LINE_SETTINGS_TYPE,      /* 19 !< Line settings type */
    CMBS_IE_FW_VERSION,              /* 20 !< CMBS firmware module and version */
    CMBS_IE_SYS_LOG,                 /* 21 !< Base station system log string */
    CMBS_IE_RESPONSE,                /* 22 !< Response (ok or error) used in response events */
    CMBS_IE_STATUS,                  /* 23 !< Contain the CMBS status up, down, removed, etc. */
    CMBS_IE_INTEGER_VALUE,           /* 24 !< Used for internal purposes */
    CMBS_IE_LINE_ID,                 /* 25 !< External line Id */
    CMBS_IE_PARAMETER_AREA,          /* 26 !< CMBS parameter area */
    CMBS_IE_REQUEST_ID,              /* 27 !< Unique Id for requests sent from Host to CMBS */
    CMBS_IE_HANDSETS,                /* 28 !< Bit mask of one or more handsets */
    CMBS_IE_GEN_EVENT,               /* 29 !< Generic event; for internal usage */
    CMBS_IE_PROP_EVENT,              /* 30 !< Proprietary event; for internal usage */
    CMBS_IE_DATETIME,                /* 31 !< Holds the date and time of day (Y/M/D/H/M/S/Zone) */
    CMBS_IE_DATA,                    /* 32 !< Holds data and length */
    CMBS_IE_DATA_SESSION_ID,         /* 33 !< Id of the data session */
    CMBS_IE_DATA_SESSION_TYPE,       /* 34 !< Type of data (IWU-INFO,CF-Channel, etc.) */
    CMBS_IE_LA_SESSION_ID,           /* 35!< Id of the List Access Session */
    CMBS_IE_LA_LIST_ID,              /* 36 !< Id of the list being accessed via Access List Service */
    CMBS_IE_LA_FIELDS,               /* 37 !< Holds fields idetifiers of a list. */
    CMBS_IE_LA_SORT_FIELDS,          /* 38 !< Holds sort fields of a list. */
    CMBS_IE_LA_EDIT_FIELDS,          /* 39 !< Holds editable fields of a list. */
    CMBS_IE_LA_CONST_FIELDS,         /* 40 !< Holds non-edit fields of a list. */
    CMBS_IE_LA_SEARCH_CRITERIA,      /* 41 !< The criteria for the search */
    CMBS_IE_LA_ENTRY_ID,             /* 42 !< The Id of an entry in a list */
    CMBS_IE_LA_ENTRY_INDEX,          /* 43 !< The index of an entry in a list */
    CMBS_IE_LA_ENTRY_COUNT,          /* 44 !< The number of entries in a list */
    CMBS_IE_LA_IS_LAST,              /* 45 !< Boolean to hold indicate last data segment */
    CMBS_IE_LA_REJECT_REASON,        /* 46 !< Reject Reason (0 means "No Error") */
    CMBS_IE_LA_NR_OF_ENTRIES,        /* 47 !< Nr of Entries */
    CMBS_IE_CALLTRANSFERREQ,         /* 48 !< Request for call transfer approve from host*/
    CMBS_IE_HS_NUMBER,               /* 49 !< Handset Number */
    CMBS_IE_SHORT_VALUE,             /* 50 !< used for internal purpose */
    CMBS_IE_ATE_SETTINGS,            /* 51 !< used for ATE test */
    CMBS_IE_LA_READ_DIRECTION,       /* 52 !< Read direction (forward / backward) when browsing lists */
    CMBS_IE_LA_MARK_REQUEST,         /* 53 !< mark entries as read / unread / leave unchanged */
    CMBS_IE_LINE_SUBTYPE,            /* 54 !< Line SubType */
...
typedef  struct
{
    ...
    u8               pu8_Pattern[32];    /*!< Search pattern */
...
/*!
      ...
      \param[in]     u16_Handsets           bitmask for handset: bit 0 = handset 1, bit 1 = handset 2, etc.<br>
                                            0xFFFF for all
      \param[in]     u8_NumOfCalls          holds the number of unread missed calls; allowable values: 0 to 127
