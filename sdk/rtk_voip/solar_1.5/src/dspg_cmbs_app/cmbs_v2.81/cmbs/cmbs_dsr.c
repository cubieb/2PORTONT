...
E_CMBS_RC         cmbs_dsr_RxtunGpioConnect( void * pv_AppRefHandle, u16 u16_GPIO )
{
    ...
    cmbs_int_ie_GpioAdd( (void*)p_List, u16_GPIO );
...
E_CMBS_RC         cmbs_dsr_ATETestStart( void * pv_AppRefHandle, ST_IE_ATE_SETTINGS * pst_AteSettings )
{
    ...
    cmbs_int_ie_ATESettingsAdd( (void*)p_List, pst_AteSettings );
                                        ...
                                        u16 u16_TotalNumOfCalls )
{
    ...
    cmbs_int_ie_GenEventAdd( p_List, &st_GenEvent );
    cmbs_int_ie_ShortValueAdd( p_List, u16_Handsets, CMBS_IE_HANDSETS );
    cmbs_int_ie_ShortValueAdd( p_List, u16_TotalNumOfCalls, CMBS_IE_LA_NR_OF_ENTRIES );
                                        ...
                                        u8  u8_LineSubType )
{
    ...
    cmbs_int_ie_GenEventAdd( p_List, &st_GenEvent );
    cmbs_int_ie_ShortValueAdd( p_List, u16_Handsets, CMBS_IE_HANDSETS );
    cmbs_int_ie_ByteValueAdd( p_List, u8_LineSubType, CMBS_IE_LINE_SUBTYPE );
                                            ...
                                            u16 u16_Handset )
{
    ...
    cmbs_int_ie_DateTimeAdd( p_List, pst_DateTime );
    cmbs_int_ie_IntValueAdd( p_List, u16_Handset );
