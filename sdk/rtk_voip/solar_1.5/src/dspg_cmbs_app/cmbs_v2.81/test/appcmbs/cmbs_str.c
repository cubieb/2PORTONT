...
char *            getstr_E_CMBS_EVENT( E_CMBS_EVENT_ID e_Event )
{
   switch( e_Event )
   {
      ...
      caseretstr(CMBS_EV_DSR_HS_PAGE_START);
      caseretstr(CMBS_EV_DSR_HS_PAGE_START_RES);
      caseretstr(CMBS_EV_DSR_HS_PAGE_STOP);
      caseretstr(CMBS_EV_DSR_HS_PAGE_STOP_RES);
      caseretstr(CMBS_EV_DSR_HS_DELETE);
      caseretstr(CMBS_EV_DSR_HS_DELETE_RES);
      caseretstr(CMBS_EV_DSR_HS_REGISTERED);
      caseretstr(CMBS_EV_DSR_HS_IN_RANGE);
/* ALTDV */
	  caseretstr(CMBS_EV_DSR_HS_SUBSCRIBED_LIST_GET);
      caseretstr(CMBS_EV_DSR_HS_SUBSCRIBED_LIST_GET_RES);
	  caseretstr(CMBS_EV_DSR_HS_SUBSCRIBED_LIST_SET);
      caseretstr(CMBS_EV_DSR_HS_SUBSCRIBED_LIST_SET_RES);
      caseretstr(CMBS_EV_DSR_LINE_SETTINGS_LIST_GET);
      caseretstr(CMBS_EV_DSR_LINE_SETTINGS_LIST_GET_RES);
      caseretstr(CMBS_EV_DSR_LINE_SETTINGS_LIST_SET);
      caseretstr(CMBS_EV_DSR_LINE_SETTINGS_LIST_SET_RES);
...
/* ALTDV */
      ...
      caseretstr(CMBS_EV_DSR_HS_PAGE_PROGRESS);
      caseretstr(CMBS_EV_DSR_HS_PAGE_ANSWER);
      ...
      caseretstr(CMBS_EV_DCM_CALL_STATE);
      caseretstr(CMBS_EV_DEE_CALL_HOLD_RES);
      caseretstr(CMBS_EV_DEE_CALL_RESUME_RES);
      caseretstr(CMBS_EV_DEM_CHANNEL_INTERNAL_CONNECT);
      caseretstr(CMBS_EV_DEM_CHANNEL_INTERNAL_CONNECT_RES);
