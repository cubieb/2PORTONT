...
int
#ifdef MALLOC_DEBUG
__osip_message_init (osip_message_t ** sip, char *file, int line)
#else
osip_message_init (osip_message_t ** sip)
#endif
{
#ifdef MALLOC_DEBUG
  *sip = (osip_message_t *) __osip_malloc (sizeof (osip_message_t), file, line);
#else
...
#ifdef MALLOC_DEBUG
int
__osip_message_clone (const osip_message_t * sip, osip_message_t ** dest, char *file, int line)
#else
int
...
#ifdef MALLOC_DEBUG
  copy->reason_phrase = __osip_strdup (sip->reason_phrase, file, line);
#else
