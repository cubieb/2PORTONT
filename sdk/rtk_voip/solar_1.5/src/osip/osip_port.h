...
#define osip_malloc(S) __osip_malloc(S,__FILE__,__LINE__)
#define osip_calloc(N,S) __osip_calloc(N,S,__FILE__,__LINE__)
#define osip_realloc(P,S) __osip_realloc(P,S, __FILE__,__LINE__)
#define osip_free(S) free(S)
...
#ifndef osip_calloc
#define osip_calloc(N,S) calloc(N,S)
#endif
...
/**************************/
  ...
  #define osip_strdup(S) __osip_strdup(S,__FILE__,__LINE__)
#else
