...
int __osip_mutex_lock (struct osip_mutex *mut, char *file, int line);
int __osip_mutex_unlock (struct osip_mutex *mut, char *file, int line);

#define osip_mutex_lock(mut) __osip_mutex_lock(mut, __FILE__, __LINE__)
#define osip_mutex_unlock(mut) __osip_mutex_unlock(mut, __FILE__, __LINE__)
