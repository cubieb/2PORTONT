...
//if( sdp != NULL )
//{
//sdp_message_to_str( sdp , &body_str ) ;
//if( body_str != NULL )
//printf( "\n body_str 1 = %s" , body_str ) ;
//}
  ptr = next_buf;
...
#ifdef MALLOC_DEBUG
int
__sdp_message_to_str (sdp_message_t * sdp, char **dest, char *file, int line)
#else
int
...
#endif
{
  ...
  *dest = NULL;
  ...
  size = 4000;
#ifdef MALLOC_DEBUG
  tmp = (char *) __osip_malloc (size, file, line);
#else
