...
<form  onsubmit="return sendCAClicked<%voip_TLSGetCertInfo("certNum");%>(this.form);" action=/boaform/voip_TLSCertUpload method=POST enctype="multipart/form-data" name="TLScacert<%voip_TLSGetCertInfo("certNum");%>">
