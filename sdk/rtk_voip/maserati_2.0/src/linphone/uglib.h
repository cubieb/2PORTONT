...
#define DEBUG_B_CONSOLE			0x00000008	/* all message printf to console */
...
#if 0
extern void g_print(int type, const gchar *fmt, ...);
...
#else
extern void g_print(char *file, int line, char *func, int type, const gchar *fmt, ...);
#define g_warning(...) g_print(__FILE__, __LINE__, __FUNCTION__, DEBUG_B_WARNING, __VA_ARGS__)
#define g_error(...) g_print(__FILE__, __LINE__, __FUNCTION__, DEBUG_B_ERROR, __VA_ARGS__)
#define g_message(...) g_print(__FILE__, __LINE__, __FUNCTION__, DEBUG_B_MESSAGE, __VA_ARGS__)
#endif
