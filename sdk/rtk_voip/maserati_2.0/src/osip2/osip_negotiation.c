...
int
osip_negotiation_sdp_message_put_on_fax (sdp_message_t * sdp, int port, int codec)
{
	sdp_media_t *media;
	int pos;
	...
	if( 0 == port ){
		...
		{
			sdp_message_m_payload_add(sdp, 0, osip_strdup("8"));
			sdp_message_a_attribute_add(sdp, 0, osip_strdup("rtpmap"), osip_strdup("8 PCMA/8000"));
		}
		sdp_message_a_attribute_add(sdp, 0, osip_strdup ("Fax"), NULL);
