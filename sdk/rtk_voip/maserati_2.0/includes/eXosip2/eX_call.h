 ...
 * Send a NOTIFY containing the information about a call transfer.
 * 
 * THIS METHOD is coded by RTK/SD6 to replace original eXosip_transer_send_notify by using the mechanism
 * requested by 3.5 for backward compatibility.
 * 
 * @param did                  dialog id of call.
 * @param subscription_status  the subscription status.
 * @param body                 the body to attach to NOTIFY.
 */
  int rcm_eXosip_transfer_send_notify (int did, int subscription_status, char *body);
