...
#endif
#define osip_message_get_service_route(sip, pos, dest) osip_message_get_knownheaderlist((&(sip)->service_routes), pos, (void **)(dest))
/**
 * Set the To header.
 * @param sip The element to work on.
 * @param hvalue The string describing the element.
 ...
 * @param value the value of the new header.
 */
#define osip_message_set_history_info(sip,value)     osip_message_set_header((osip_message_t *)sip,(const char *)"History-Info",value)
/**
...
/*
 RTK: anson: for set replaces header 
*/
