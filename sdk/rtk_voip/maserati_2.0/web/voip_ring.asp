...
<b><% multilang(LANG_RING_CADENCE_DETECTION_SETTING); %></b>
...
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >
	...
	<tr>
    	<td bgColor=#aaddff width=155><% multilang(LANG_CADENCE); %></td>
	...
	<tr>
    	<td colspan=3 align=center>
    		<input type="submit" name="Ring_Cad" value="<% multilang(LANG_APPLY); %>" >
   	</td>
	</tr>
...
<%voip_general_get("not_ipphone_option_start");%>
<b><% multilang(LANG_SELECT_CADENCE); %></b>
<%voip_general_get("not_ipphone_option_end");%>
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >
	<tr>
    	<td bgColor=#aaddff width=155><% multilang(LANG_CADENCE); %></td>
...
<%voip_general_get("not_ipphone_option_start");%>
<b><% multilang(LANG_CUSTOM_CADENCE); %></b>
<%voip_general_get("not_ipphone_option_end");%>
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >

	<tr>
    	<td bgColor=#aaddff><% multilang(LANG_CADENCE_ON); %> (<% multilang(LANG_MSEC); %>)</td>
    	<td bgColor=#ddeeff>
	...
	<tr>
    	<td bgColor=#aaddff><% multilang(LANG_CADENCE_OFF); %> (<% multilang(LANG_MSEC); %>)</td>
    	<td bgColor=#ddeeff>
	...
	<tr>
    	<td colspan=3 align=center>
    		<input type="submit" name="Ring_Cadence" value="<% multilang(LANG_APPLY); %>" >
   	</td>
	</tr>
