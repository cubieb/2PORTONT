...
<form method="post" action=/boaform/voip_config_set name="setting_save_form">
<tr>
...
<form method="post" action=/boaform/voip_config_set enctype="multipart/form-data" name="setting_load_form">
<tr>
...
<form method="post" action="/boaform/voip_config_set" name="setting_reset_form">
<tr>
...
<form method="get" action="/boaform/voip_config_set" name=config_form>
...
<table cellSpacing=1 cellPadding=2 border=0 width=500>
<form method="get" action="/boaform/voip_config_set" name=fw_form>
