...
#undef  CONFIG_USER_WATCHDOG_WDG
...
#undef  CONFIG_LIB_LIBTERMCAP_FORCE
#define CONFIG_LIB_LIBMD5_FORCE 1
...
#undef  CONFIG_USE_XML
#define CONFIG_USER_XMLCONFIG 1
#undef  CONFIG_USE_RAW_DATA
#undef  CONFIG_USER_BOA_WITH_SSL
#define CONFIG_USER_BOA_WITH_MULTILANG 1
#define CONFIG_USER_BOA_WITH_MULTILANG_EN 1
#define CONFIG_USER_BOA_WITH_MULTILANG_ZH_TW 1
#define CONFIG_USER_BOA_WITH_MULTILANG_ZH_CN 1
#undef  CONFIG_USER_BOA_WITH_MULTILANG_RU
...
#define CONFIG_USER_CUPS 1
#define CONFIG_USER_CWMP_TR069 1
#undef  CONFIG_MIDDLEWARE
#define CONFIG_USER_TR104 1
#undef  CONFIG_USER_CWMP_UPNP_DM
#define CONFIG_USER_TR143 1
#define CONFIG_USER_CWMP_WITHOUT_SSL 1
#undef  CONFIG_USER_CWMP_WITH_OPENSSL
#undef  CONFIG_USER_CWMP_WITH_MATRIXSSL
...
#undef  CONFIG_USER_NETLOGGER_SUPPORT
...
#define CONFIG_USER_PPPOMODEM 1
...
#define CONFIG_USER_UDHCP099PRE2 1
#define CONFIG_USER_DHCP_OPT_33_249 1
#undef  CONFIG_USER_DHCP_OPT_GUI_60
...
#define CONFIG_USER_WIRELESS_MBSSID 1
...
#define CONFIG_USER_WLAN_QOS 1
#undef  CONFIG_USER_WIRELESS_MP_MODE
#undef  CONFIG_USER_WLAN_QCSAPI
...
#undef  CONFIG_USER_3G_USBTOOLS
#undef  CONFIG_USER_JAMVM
#define CONFIG_USER_DBG_SCRIPTS 1

/*
 * BusyBox
 */
#define CONFIG_USER_BUSYBOX_BUSYBOX1124 1
#undef  CONFIG_USER_BUSYBOX_BUSYBOX1221

/*
 * IPV6 Ready Logo Test
 */
#undef  CONFIG_USER_IPV6READYLOGO_NONE
#undef  CONFIG_USER_IPV6READYLOGO_HOST
#define CONFIG_USER_IPV6READYLOGO_ROUTER 1
...
/*
 * RTK User applications
 */
#define CONFIG_USER_IP_QOS 1
#undef  IP_QOS
#undef  NEW_IP_QOS_SUPPORT
#define CONFIG_USER_IP_QOS_3 1
#undef  CONFIG_USER_IP_QOS_TRAFFIC_SHAPING_BY_VLANID
#undef  CONFIG_USER_IP_QOS_TRAFFIC_SHAPING_BY_SSID
#undef  CONFIG_USER_RTK_SYSLOG
#define CONFIG_USER_RTK_WAN_CTYPE 1
#define CONFIG_USER_RTK_SYSTEMD 1
#undef  CONFIG_ENABLE_KERNEL_FW_UPDATE
#undef  CONFIG_USER_RTK_PPPOE_PASSTHROUGH
#undef  CONFIG_USER_PPPOE_2_INTERVALS_RETRY
#undef  CONFIG_USER_NO_PORT_GROUP
#define CONFIG_USER_PORTMAPPING 1
#undef  CONFIG_USER_BRIDGE_GROUPING
#undef  CONFIG_USER_VLAN_ON_LAN
#define CONFIG_USER_RTK_VOIP 1
#undef  CONFIG_RTK_VOIP_TEST_TOOL
#define CONFIG_USER_APOLLO 1
#define CONFIG_USER_APOLLO_DIAGSHELL 1
#undef  CONFIG_INIT_SCRIPTS
#undef  CONFIG_USER_TCP2DEV
#undef  CONFIG_USER_RTK_RECOVER_SETTING
#define CONFIG_USER_DHCP_SERVER 1
#undef  CONFIG_USER_RTK_WIRELESS_WAN
#undef  CONFIG_USER_WIRELESS_SITESURVEY_DISPLAY
#undef  CONFIG_USER_WIRELESS_LIMITED_STA_NUM
#undef  CONFIG_WLAN_11N_COEXIST
#define CONFIG_LUNA_FIRMWARE_UPGRADE_SUPPORT 1
#undef  CONFIG_USER_RTK_LBD
#undef  CONFIG_USER_ZM8620_ECMMODE
#define CONFIG_RESERVE_KEY_SETTING 1
#define CONFIG_LAN_PORT_NUM (2)
#undef  CONFIG_SECONDARY_IP
#undef  CONFIG_IGMPPROXY_SENDER_IP_ZERO
#undef  CONFIG_MCAST_VLAN
...
#undef  CONFIG_DOT11K_TEST_TOOL

/*
 * RTL8686 IPC User Utility
 */
#undef  CONFIG_USER_RTL8686_IPC_UTIL

/*
 * Choose DSP Image
 */
#define CONFIG_USER_SLIC_ON_HOST 1
#define CONFIG_VENDOR "Realtek"
#define CONFIG_PRODUCT "luna"
#define CONFIG_LINUXDIR "linux-2.6.x"
#define CONFIG_LANGUAGE "en_IN:en"
