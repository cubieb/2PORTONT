...
#define FWUPGRADE_LED
// When using AFED DDR mode, AFTXDPIN[1:0] and AFRXDPIN[1:0] can be used as Ext. GPO.
//#define RTL_EXT_GPO
...
#endif //CONFIG_RTL8192CD
#ifdef RTL_EXT_GPO
	GPIO_EXT_0 = 72, GPIO_EXT_1, GPIO_EXT_2, GPIO_EXT_3, // AFTXD0, AFTXD1, AFRXD0, AFRXD1
#endif
	GPIO_END
};
