...
#define PT_ESTATUS 176 /* offsetof(struct pt_regs, estatus)	 # */
#define PT_ECAUSE 180 /* offsetof(struct pt_regs, ecause)	 # */
#define PT_INTVEC 184 /* offsetof(struct pt_regs, intvec)	 # */
