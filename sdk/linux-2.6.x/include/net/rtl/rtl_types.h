...
* Abstract :                                                           
* Author :              
* $Id: rtl_types.h,v 1.8 2012/06/22 09:25:23 paula Exp $
* $Log: rtl_types.h,v $
* Revision 1.8  2012/06/22 09:25:23  paula
* support CONFIG_RTL8192CD_MODULE
*
* Revision 1.7  2012/06/21 10:50:07  krammer
* return to previous version and add 8686 config
*
* Revision 1.6  2012/06/21 04:28:20  krammer
* we only redefine mips16 when hwnat turn on
*
...
#undef __NOMIPS16
#undef __MIPS16
#if defined(__linux__)&&defined(__KERNEL__)&&(defined(CONFIG_RTL_819X)||defined(CONFIG_RTL_8676HWNAT)||defined(CONFIG_RTL8686)) && !defined(CONFIG_RTL_8196C) && !defined(CONFIG_RTL8192CD_MODULE)
...
/* ===============================================================================
		Type definition
    =============================================================================== */
#ifndef __COMMON_TYPE_H__  /*from apollo SDK*/
    #if 1
