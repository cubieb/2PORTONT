...
#if defined(CONFIG_RTL865X_ETH_PRIV_SKB_ADV)
#define SKB_PREALLOC                            (1<<0)  //indicate preallocated skb
#define SKB_DATA_PREALLOC                       (1<<1)  //indicate preallocated buffer
#define RETFREEQ_FF                                     (1<<15) //this skb is only used by driver
#define RETFREEQ_SKB                            (1<<16) //return skb back to pool
#define RETFREEQ_DATA                           (1<<17) //return buffer back to pool
#define RETFREEQ_NIC_TXRECOVER          (1<<18) //indicate this skb is gotten from NIC tx ring
#endif//end of CONFIG_RTL_ETH_PRIV_SKB_ADV
