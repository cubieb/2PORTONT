...
#ifndef __DAL_RTL9601B_TRAP_H__
#define __DAL_RTL9601B_TRAP_H__
 ...
 * Data Declaration
 */
typedef enum rtl9601b_igmpAction_e
{
    RTL9601B_IGMP_ACT_FORWARD  = 0,
    RTL9601B_IGMP_ACT_DROP,
    RTL9601B_IGMP_ACT_TRAP,
    RTL9601B_IGMP_ACT_END,
} rtl9601b_igmpAction_t;

typedef enum rtl9601b_l2_commonAct_e
{
	RTL9601B_L2_COMMON_ACT_FORWARD = 0,
	RTL9601B_L2_COMMON_ACT_DROP,
	RTL9601B_L2_COMMON_ACT_TRAP,
	RTL9601B_L2_COMMON_ACT_COPY2CPU,
	RTL9601B_L2_COMMON_ACT_END,
}rtl9601b_l2_commonAct_t;

typedef enum rtl9601b_rmaAction_e
{
    RTL9601B_RMA_ACT_FORWARD  = 0,
    RTL9601B_RMA_ACT_TRAP ,
    RTL9601B_RMA_ACT_DROP ,
    RTL9601B_RMA_ACT_FORWARD_EXCLUDE_CPU ,
    RTL9601B_RMA_ACT_END ,
} rtl9601b_rmaAction_t;
...
/* Function Name:
 *      dal_rtl9601b_trap_rmaVlanCheckEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaVlanCheckEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9601b_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9601b_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);
