...
#ifndef __DAL_RTL9602BVB_GPIO_H__
#define __DAL_RTL9602BVB_GPIO_H__

#define RTL9602BVB_GPIO_PIN_NUM 64
#define RTL9602BVB_GPIO_BASE 0xB8003300
...
enum {
RTL9602BVB_GPIO_CTRL_ABCDr= RTL9602BVB_GPIO_BASE+0x0, 	/*enable gpio function*/
RTL9602BVB_GPIO_CTRL_EFGHr= RTL9602BVB_GPIO_BASE+0x1c, 	/*enable gpio function*/
RTL9602BVB_GPIO_DIR_ABCDr	= RTL9602BVB_GPIO_BASE+0x08, 	/*configure gpio pin to gpo or gpi*/
RTL9602BVB_GPIO_DIR_EFGHr = RTL9602BVB_GPIO_BASE+0x24,	/*configure gpio pin to gpo or gpi*/
RTL9602BVB_GPIO_DATA_ABCDr= RTL9602BVB_GPIO_BASE+0x0c, 	/*datatit for input/output mode*/
RTL9602BVB_GPIO_DATA_EFGHr= RTL9602BVB_GPIO_BASE+0x28,	/*datatit for input/output mode*/
RTL9602BVB_GPIO_IMS_ABCDr = RTL9602BVB_GPIO_BASE+0x10,	/*interrupt status */
RTL9602BVB_GPIO_IMS_EFGHr = RTL9602BVB_GPIO_BASE+0x2c,	/*interrupt status */
RTL9602BVB_GPIO_IMR_ABr 	= RTL9602BVB_GPIO_BASE+0x14,  /*interrupt mask register AB */
RTL9602BVB_GPIO_IMR_CDr 	= RTL9602BVB_GPIO_BASE+0x18,  /*interrupt mask register CD*/
RTL9602BVB_GPIO_IMR_EFr	= RTL9602BVB_GPIO_BASE+0x30,	/*interrupt mask register EF*/
RTL9602BVB_GPIO_IMR_GHr	= RTL9602BVB_GPIO_BASE+0x34,	/*interrupt mask register GH*/
RTL9602BVB_GPIO_CPU0_ABCDr= RTL9602BVB_GPIO_BASE+0x38,	/*configure gpio imr to cpu 0*/
RTL9602BVB_GPIO_CPU1_ABCDr= RTL9602BVB_GPIO_BASE+0x3c,	/*configure gpio imr to cpu 1*/
...
#endif  /* __DAL_RTL9602BVB_GPIO_H__ */
