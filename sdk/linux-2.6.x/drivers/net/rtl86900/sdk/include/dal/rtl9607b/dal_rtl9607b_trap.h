...
#ifndef __DAL_RTL9607B_TRAP_H__
#define __DAL_RTL9607B_TRAP_H__
 ...
 * Data Declaration
 */
typedef enum rtl9607b_igmpAction_e
{
    RTL9607B_IGMP_ACT_FORWARD  = 0,
    RTL9607B_IGMP_ACT_DROP,
    RTL9607B_IGMP_ACT_TRAP,
    RTL9607B_IGMP_ACT_END,
} rtl9607b_igmpAction_t;

typedef enum rtl9607b_l2_commonAct_e
{
	RTL9607B_L2_COMMON_ACT_FORWARD = 0,
	RTL9607B_L2_COMMON_ACT_DROP,
	RTL9607B_L2_COMMON_ACT_TRAP,
	RTL9607B_L2_COMMON_ACT_COPY2CPU,
	RTL9607B_L2_COMMON_ACT_END,
}rtl9607b_l2_commonAct_t;

typedef enum rtl9607b_rmaAction_e
{
    RTL9607B_RMA_ACT_FORWARD  = 0,
    RTL9607B_RMA_ACT_TRAP ,
    RTL9607B_RMA_ACT_DROP ,
    RTL9607B_RMA_ACT_FORWARD_EXCLUDE_CPU ,
    RTL9607B_RMA_ACT_END ,
} rtl9607b_rmaAction_t;

typedef enum
{
    RTL9607B_TRAP_HASH_SPA = 0,
    RTL9607B_TRAP_HASH_SMAC,
    RTL9607B_TRAP_HASH_DMAC,
    RTL9607B_TRAP_HASH_SIP_INNER,
    RTL9607B_TRAP_HASH_DIP_INNER,
    RTL9607B_TRAP_HASH_SPORT_INNER,
    RTL9607B_TRAP_HASH_DPORT_INNER,
    RTL9607B_TRAP_HASH_END
} rtl9607b_trap_hash_t;
...
/* Function Name:
 *      dal_rtl9607b_trap_rmaVlanCheckEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaVlanCheckEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9607b_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9607b_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);
 ...
 */
extern int32
dal_rtl9607b_trap_uniTrapPriorityEnable_set(rtk_enable_t state);
 ...
 */
extern int32
dal_rtl9607b_trap_uniTrapPriorityEnable_get(rtk_enable_t *pState);
