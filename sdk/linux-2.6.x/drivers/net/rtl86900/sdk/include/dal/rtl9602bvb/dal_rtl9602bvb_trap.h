...
#ifndef __DAL_RTL9602BVB_TRAP_H__
#define __DAL_RTL9602BVB_TRAP_H__
 ...
 * Data Declaration
 */
typedef enum rtl9602bvb_igmpAction_e
{
    RTL9602BVB_IGMP_ACT_FORWARD  = 0,
    RTL9602BVB_IGMP_ACT_DROP,
    RTL9602BVB_IGMP_ACT_TRAP,
    RTL9602BVB_IGMP_ACT_END,
} rtl9602bvb_igmpAction_t;

typedef enum rtl9602bvb_l2_commonAct_e
{
	RTL9602BVB_L2_COMMON_ACT_FORWARD = 0,
	RTL9602BVB_L2_COMMON_ACT_DROP,
	RTL9602BVB_L2_COMMON_ACT_TRAP,
	RTL9602BVB_L2_COMMON_ACT_COPY2CPU,
	RTL9602BVB_L2_COMMON_ACT_END,
}rtl9602bvb_l2_commonAct_t;

typedef enum rtl9602bvb_rmaAction_e
{
    RTL9602BVB_RMA_ACT_FORWARD  = 0,
    RTL9602BVB_RMA_ACT_TRAP ,
    RTL9602BVB_RMA_ACT_DROP ,
    RTL9602BVB_RMA_ACT_FORWARD_EXCLUDE_CPU ,
    RTL9602BVB_RMA_ACT_END ,
} rtl9602bvb_rmaAction_t;
...
/* Function Name:
 *      dal_rtl9602bvb_trap_rmaVlanCheckEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaVlanCheckEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9602bvb_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9602bvb_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);
 ...
 */
extern int32
dal_rtl9602bvb_trap_uniTrapPriorityEnable_set(rtk_enable_t state);
 ...
 */
extern int32
dal_rtl9602bvb_trap_uniTrapPriorityEnable_get(rtk_enable_t *pState);
...
#endif /* __DAL_RTL9602BVB_TRAP_H__ */
