...
#ifndef __DAL_RTL9602BVB_CLASSIFY_H__
#define __DAL_RTL9602BVB_CLASSIFY_H__
...
/* Constant Definition                                          */
/****************************************************************/
#define RTL9602BVB_RAW_CF_ETHERTYPE_NONE			0XFFFF
#define RTL9602BVB_RAW_CF_ENTRYLEN                    2
#define RTL9602BVB_RAW_CF_UPACTTBLEN                  3
#define RTL9602BVB_RAW_CF_DSACTTBLEN                  3
#define RTL9602BVB_CF_PATTERN0_ENTRY_MAX            256
#define RTL9602BVB_CF_PATTERN1_ENTRY_MAX            255
#define RTL9602BVB_CF_PATTERN1_ENTRY_MIN              0

/****************************************************************/
/* Type Definition                                              */
/****************************************************************/
typedef enum rtl9602bvb_raw_cf_patternNum_e{
    RTL9602BVB_RAW_CF_PATTERN_0 = 0,
    RTL9602BVB_RAW_CF_PATTERN_1,
    RTL9602BVB_RAW_CF_PATTERN_END,
}rtl9602bvb_raw_cf_patternNum_t;

typedef enum rtl9602bvb_raw_cf_usPermit_e{
    RTL9602BVB_RAW_CF_US_PERMIT_NORMAL = 0,
    RTL9602BVB_RAW_CF_US_PERMIT_NOPON,
    RTL9602BVB_RAW_CF_US_PERMIT_DROP,
    RTL9602BVB_RAW_CF_US_PERMIT_END,
}rtl9602bvb_raw_cf_usPermit_t;

typedef enum rtl9602bvb_raw_cf_dsPermit_e{
    RTL9602BVB_RAW_CF_DS_PERMIT_NORMAL = 0,
    RTL9602BVB_RAW_CF_DS_PERMIT_DROP,
    RTL9602BVB_RAW_CF_DS_PERMIT_END,
}rtl9602bvb_raw_cf_dsPermit_t;

typedef enum rtl9602bvb_raw_cf_valid_e{
    CF_ENTRY_INVALID = 0,
    CF_ENTRY_VALID,
    CF_ENTRY_VALID_END,
}rtl9602bvb_raw_cf_valid_t;

typedef enum rtl9602bvb_raw_cf_enable_t
{
    CF_DISABLE = 0,
    CF_ENABLE,
    CF_ENABLE_END,
} rtl9602bvb_raw_cf_enable_t;

typedef enum rtl9602bvb_raw_cf_unmatch_action_e
{
    CF_UNMATCH_DROP = 0,
    CF_UNMATCH_PERMIT_WITHOUT_PON,
    CF_UNMATCH_PERMIT,
    CF_UNMATCH_END,
} rtl9602bvb_raw_cf_unmatch_action_t;

typedef enum rtl9602bvb_raw_cf_dirct_e
{
    CF_DIRECTION_US = 0,
    CF_DIRECTION_DS,
    CF_DIRECTION_END
}rtl9602bvb_raw_cf_dirct_t;

/*down stream action*/
typedef enum rtl9602bvb_raw_cf_ds_csact_e
{
    CF_DS_CSACT_NOP = 0,
    ...
    CF_DS_CSACT_END,
} rtl9602bvb_raw_cf_ds_csact_t;

typedef enum rtl9602bvb_raw_cf_ds_cact_e
{
    CF_DS_CACT_NOP = 0,
    ...
    CF_DS_CACT_END,
} rtl9602bvb_raw_cf_ds_cact_t;

typedef enum rtl9602bvb_raw_cf_ds_vid_act_e
{
    CF_DS_VID_ACT_NOP =0,
    ...
    CF_DS_VID_ACT_END,
} rtl9602bvb_raw_cf_ds_vid_act_t;

typedef enum rtl9602bvb_raw_cf_ds_pri_act_e
{
	CF_DS_PRI_ACT_NOP = 0,
    ...
    CF_DS_PRI_ACT_END,
} rtl9602bvb_raw_cf_ds_pri_act_t;

typedef enum rtl9602bvb_raw_cf_cf_pri_act_e
{
    CF_CF_PRI_ACT_NOP = 0,
    CF_CF_PRI_ACT_ASSIGN,
    CF_CF_PRI_ACT_END,
} rtl9602bvb_raw_cf_cf_pri_act_t;

typedef enum rtl9602bvb_raw_cf_ds_uni_act_e
{
    CF_DS_UNI_ACT_NOP = 0,
    ...
    CF_DS_UNI_ACT_END,
} rtl9602bvb_raw_cf_ds_uni_act_t;

/*up stream action*/
typedef enum rtl9602bvb_raw_cf_us_csact_e
{
    CF_US_CSACT_NOP = 0,
    ...
    CF_US_CSACT_END,
} rtl9602bvb_raw_cf_us_csact_t;

typedef enum rtl9602bvb_raw_cf_us_cact_e
{
    CF_US_CACT_NOP = 0,
    ...
    CF_US_CACT_END,
} rtl9602bvb_raw_cf_us_cact_t;

typedef enum rtl9602bvb_raw_cf_us_vid_act_e
{
    CF_US_VID_ACT_NOP =0,
    ...
    CF_US_VID_ACT_END,
} rtl9602bvb_raw_cf_us_vid_act_t;

typedef enum rtl9602bvb_raw_cf_us_pri_act_e
{
    CF_US_PRI_ACT_NOP = 0,
    ...
    CF_US_PRI_ACT_END,
} rtl9602bvb_raw_cf_us_pri_act_t;

typedef enum rtl9602bvb_raw_cf_us_sqid_act_e
{
    CF_US_SQID_ACT_ASSIGN_NOP =0,
    CF_US_SQID_ACT_ASSIGN_SID,
    CF_US_SQID_ACT_END,
} rtl9602bvb_raw_cf_us_sqid_act_t;

typedef enum rtl9602bvb_raw_cf_us_fwd_act_e
{
    CF_US_FWD_ACT_NOP =0,
    CF_US_FWD_ACT_DROP,
    CF_US_FWD_ACT_TRAP,
    ...
    CF_US_FWD_ACT_END,
} rtl9602bvb_raw_cf_us_fwd_act_t;

typedef enum rtl9602bvb_raw_cf_template_vid_cfg_e
{
    RTL9602BVB_RAW_CF_TEMPLATE_VID_CFG_INGRESS_CVID = 0,
    RTL9602BVB_RAW_CF_TEMPLATE_VID_CFG_INGRESS_OUTERTAG_VID,
    RTL9602BVB_RAW_CF_TEMPLATE_VID_CFG_INTERNAL_CVID,
    RTL9602BVB_RAW_CF_TEMPLATE_VID_CFG_END,
} rtl9602bvb_raw_cf_template_vid_cfg_t;

typedef enum rtl9602bvb_raw_cf_template_pri_cfg_e
{
    RTL9602BVB_RAW_CF_TEMPLATE_PRI_CFG_INGRESS_CPRI = 0,
    RTL9602BVB_RAW_CF_TEMPLATE_PRI_CFG_INTERNAL_PRI,
    RTL9602BVB_RAW_CF_TEMPLATE_PRI_CFG_RSVD,
    RTL9602BVB_RAW_CF_TEMPLATE_PRI_CFG_REMARK_CPRI,
    RTL9602BVB_RAW_CF_TEMPLATE_PRI_CFG_END,
} rtl9602bvb_raw_cf_template_pri_cfg_t;

typedef enum rtl9602bvb_raw_cf_ds_uni_pattern_e
{
    RTL9602BVB_RAW_CF_DS_UNI_PTN_L34_HSA_NEXTHOP = 0,
    RTL9602BVB_RAW_CF_DS_UNI_PTN_HSB_DA,
    RTL9602BVB_RAW_CF_DS_UNI_PTN_END,
} rtl9602bvb_raw_cf_ds_uni_pattern_t;


typedef struct rtl9602bvb_raw_cf_pattern_s{
    uint32 etherType;
...
}rtl9602bvb_raw_cf_pattern_t;

typedef struct rtl9602bvb_raw_cf_RuleEntry_s{
    uint32 idx;
    uint32 valid;
    rtl9602bvb_raw_cf_pattern_t data_bits;
    rtl9602bvb_raw_cf_pattern_t care_bits;
}rtl9602bvb_raw_cf_RuleEntry_t;


typedef struct rtl9602bvb_raw_cf_dsAct_s{
    uint32 idx;
    uint32 csact;
    uint32 s_vid;
    uint32 s_pri;
...
}rtl9602bvb_raw_cf_dsAct_t;

typedef struct rtl9602bvb_raw_cf_usAct_s{
    uint32 idx;
    uint32 csact;
    uint32 svid_act;
    uint32 spri_act;
...
extern int32 rtl9602bvb_raw_cf_rule_set(rtl9602bvb_raw_cf_RuleEntry_t *pattern);
extern int32 rtl9602bvb_raw_cf_rule_get(rtl9602bvb_raw_cf_RuleEntry_t *pattern);
extern int32 rtl9602bvb_raw_cf_dsAct_set(rtl9602bvb_raw_cf_dsAct_t *pCfDsAct);
extern int32 rtl9602bvb_raw_cf_dsAct_get(rtl9602bvb_raw_cf_dsAct_t *pCfDsAct);
extern int32 rtl9602bvb_raw_cf_usAct_set(rtl9602bvb_raw_cf_usAct_t *pCfUsAct);
extern int32 rtl9602bvb_raw_cf_usAct_get(rtl9602bvb_raw_cf_usAct_t *pCfUsAct);
extern int32 rtl9602bvb_raw_cf_usPermit_set(rtl9602bvb_raw_cf_usPermit_t rule);
extern int32 rtl9602bvb_raw_cf_usPermit_get(rtl9602bvb_raw_cf_usPermit_t *pRule);
...
#endif /* __DAL_RTL9602BVB_CLASSIFY_H__ */
