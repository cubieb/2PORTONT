...
/* Function Name:
 *      dal_rtl9602bvb_port_greenEnable_get
 * Description:
...
/* Function Name:
 *      dal_rtl9602bvb_port_enhancedFid_get
 * Description:
 *      Get port EFID
 * Input:
 *      port      - port id
 ...
 */
extern int32
dal_rtl9602bvb_port_enhancedFid_get(rtk_port_t port, rtk_efid_t *pEfid);

/* Function Name:
 *      dal_rtl9602bvb_port_enhancedFid_set
 * Description:
 *      Set port EFID
 * Input:
 *      port      - port id
 ...
 */
extern int32
dal_rtl9602bvb_port_enhancedFid_set(rtk_port_t port, rtk_efid_t efid);
 ...
 * Note:
 */
extern int32 rtl9602bvb_raw_port_forceDmp_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 rtl9602bvb_raw_port_forceDmp_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 rtl9602bvb_raw_port_forceDmpMask_set(rtk_port_t port, rtk_portmask_t mask);
 ...
 * Note:
 */
extern int32 rtl9602bvb_raw_port_forceDmpMask_get(rtk_port_t port, rtk_portmask_t  *pMask);
