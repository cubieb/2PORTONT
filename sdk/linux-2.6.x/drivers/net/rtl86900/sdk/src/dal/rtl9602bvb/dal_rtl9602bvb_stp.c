...
dal_rtl9602bvb_stp_init(void)
{
    ...
    for (port = 0; port <= max_port; port++)
    {
        ...
        {
            if ((ret = dal_rtl9602bvb_stp_mstpState_set(RTK_DEFAULT_MSTI, port, STP_STATE_FORWARDING)) != RT_ERR_OK)
            {
        ...
        {
            if ((ret = dal_rtl9602bvb_stp_mstpState_set(RTK_DEFAULT_MSTI, port, RTK_DEFAULT_STP_PORT_STATE)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_STP|MOD_DAL), "");
                stp_init = INIT_NOT_COMPLETED;
                return ret;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9602bvb_stp_init */


/* Function Name:
 *      dal_rtl9602bvb_stp_mstpState_get
 * Description:
 ...
 */
int32
dal_rtl9602bvb_stp_mstpState_get(uint32 msti, rtk_port_t port, rtk_stp_state_t *pStp_state)
{
    int32   ret;
    ...
    if((ret = reg_array_field_read(RTL9602BVB_MSTI_CTRLr, port , msti, RTL9602BVB_STATEf, (uint32 *) pStp_state)) != RT_ERR_OK)
    {
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9602bvb_stp_mstpState_get */


/* Function Name:
 *      dal_rtl9602bvb_stp_mstpState_set
 * Description:
 ...
 */
int32
dal_rtl9602bvb_stp_mstpState_set(uint32 msti, rtk_port_t port, rtk_stp_state_t stp_state)
{
    int32   ret;
    ...
    if((ret = reg_array_field_write(RTL9602BVB_MSTI_CTRLr, port , msti, RTL9602BVB_STATEf, (uint32 *) &stp_state)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_STP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9602bvb_stp_mstpState_set */
