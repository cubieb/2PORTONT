...
#include "mib_CallCtrlPMHD.h"
#include "mib_RtpPMHD.h"
#include "mib_VoipCfgData.h"
...
UINT32 MIB_TABLE_VOIP_LINE_STATUS_INDEX;
UINT32 MIB_TABLE_CALL_CTRL_PMHD_INDEX;
UINT32 MIB_TABLE_RTP_PMHD_INDEX;
UINT32 MIB_TABLE_VOIP_CFG_DATA_INDEX;
