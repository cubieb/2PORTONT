...

{
	...
	if (po) {
		...
		//cxy 2015-1-21: we can't set socket  state to zombie without dev_put(dev) when recv PADT. 
		//		it will cause the dev unregiseter fail.
		//		for pppoe_release and pppoe_flush_dev func have done this job, so here don't need to do any work
		#if 0
