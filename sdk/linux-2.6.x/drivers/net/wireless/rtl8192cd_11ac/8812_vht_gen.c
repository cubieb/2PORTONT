...
//VHT CAPABILITIES INFO field
...
#endif	
		input_value_32((unsigned int*)(&vht_cap->vht_cap_info), MAX_MPDU_LENGTH_S, MAX_MPDU_LENGTH_E, 0);
	...
	if(priv->pshare->CurrentChannelBW == HT_CHANNEL_WIDTH_AC_160)
		...
		value = 0;
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), CHL_WIDTH_S, CHL_WIDTH_E, value);
	...
	{
		input_value_32((unsigned int*)(&vht_cap->vht_cap_info), TX_STBC_S, TX_STBC_E, 1);
		input_value_32((unsigned int*)(&vht_cap->vht_cap_info), RX_STBC_S, RX_STBC_E, 1);
	}
	else
#endif
	{
		input_value_32((unsigned int*)(&vht_cap->vht_cap_info), TX_STBC_S, TX_STBC_E, 0);
		input_value_32((unsigned int*)(&vht_cap->vht_cap_info), RX_STBC_S, RX_STBC_E, 0);
	}
	...
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), MAX_ANT_SUPP_S, MAX_ANT_SUPP_E, 2);
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), SOUNDING_DIMENSIONS_S, SOUNDING_DIMENSIONS_E, 1);

	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), MU_BFER_S, MU_BFER_E, 0);
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), MU_BFEE_S, MU_BFEE_E, 0);
	
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), TXOP_PS_S, TXOP_PS_E, 0);

	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), HTC_VHT_S, HTC_VHT_E, 1);

	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), MAX_RXAMPDU_FACTOR_S, MAX_RXAMPDU_FACTOR_E, 7);
	
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), LINK_ADAPTION_S, LINK_ADAPTION_E, 0);
	
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), RX_ANT_PC_S, RX_ANT_PC_E, 0);
	input_value_32((unsigned int*)(&vht_cap->vht_cap_info), TX_ANT_PC_S, TX_ANT_PC_E, 0);
	...
	{
		input_value_32((unsigned int*)(&vht_cap->vht_support_mcs[0]), MCS_RX_MAP_S, MCS_RX_MAP_E, priv->pmib->dot11acConfigEntry.dot11SupportedVHT);
		value = (u2Byte)((VHTMcsToDataRate(priv)+1)>>1);
		input_value_32((unsigned int*)(&vht_cap->vht_support_mcs[0]), MCS_RX_HIGHEST_RATE_S, MCS_RX_HIGHEST_RATE_E, value);
		vht_cap->vht_support_mcs[0] = cpu_to_le32(vht_cap->vht_support_mcs[0]);

		input_value_32((unsigned int*)(&vht_cap->vht_support_mcs[1]), MCS_TX_MAP_S, MCS_TX_MAP_E, priv->pmib->dot11acConfigEntry.dot11SupportedVHT);
		value = (u2Byte)((VHTMcsToDataRate(priv)+1)>>1);
		input_value_32((unsigned int*)(&vht_cap->vht_support_mcs[1]), MCS_TX_HIGHEST_RATE_S, MCS_TX_HIGHEST_RATE_E, value);
