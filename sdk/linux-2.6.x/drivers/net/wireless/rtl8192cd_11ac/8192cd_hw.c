		...
		if (GET_CHIP_VER(priv) == VERSION_8812E) {
			if (IS_TEST_CHIP(priv)) {
				...
				if (priv->pshare->rf_ft_var.use_ext_pa && priv->pshare->rf_ft_var.use_ext_lna) {
					panic_printk("[%s][AGC_TAB_8812_n_hp]\n",__FUNCTION__);
...
//		RTL_W32(0x4c6, RTL_R32(0x4c6) | BIT(26));	// pf1, reply ack		// ?
	...
	if (GET_CHIP_VER(priv) == VERSION_8192D) {
		...
		if (GET_CHIP_VER(priv) == VERSION_8812E) {
			...
			case 18: offset = EEPROM_8812_XTAL_K;
					break;
			case 19: offset = EEPROM_5G_HT201S_TxPowerDiff+PATHA_OFFSET;
					break;
			case 20: offset = EEPROM_5G_HT201S_TxPowerDiff+PATHB_OFFSET;
					break;
			case 21: offset = EEPROM_5G_HT402S_TxPowerDiff+PATHA_OFFSET;
					break;
			case 22: offset = EEPROM_5G_HT402S_TxPowerDiff+PATHB_OFFSET;
					break;
			case 23: offset = EEPROM_5G_HT801S_TxPowerDiff+PATHA_OFFSET;
					break;
			case 24: offset = EEPROM_5G_HT801S_TxPowerDiff+PATHB_OFFSET;
					break;
			case 25: offset = EEPROM_5G_HT802S_TxPowerDiff+PATHA_OFFSET;
					break;		
			case 26: offset = EEPROM_5G_HT802S_TxPowerDiff+PATHB_OFFSET;
					break;	
			case 27: offset = EEPROM_2G_HT201S_TxPowerDiff+PATHA_OFFSET;
					break;
			case 28: offset = EEPROM_2G_HT201S_TxPowerDiff+PATHB_OFFSET;
					break;
			case 29: offset = EEPROM_2G_HT402S_TxPowerDiff+PATHA_OFFSET;
					break;		
			case 30: offset = EEPROM_2G_HT402S_TxPowerDiff+PATHB_OFFSET;
					break;
			default:
					offset = -1;
					panic_printk("NOT SUPPORT!!\n");
