		...
		)
{
	...
	u4Byte 	Backup_MACBB_REG[MACBB_REG_NUM] = {0x520, 0x550, 0x808, 0x838, 0x90c, 0xb00, 0xc00, 0xe00, 0x82c}; 
...
#else
			PHY_SetBBReg((struct rtl8192cd_priv *)pDM_Odm, rConfig_Pmpd_AntB, bMaskDWord, 0x12680000);
#endif
