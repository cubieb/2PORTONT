...
#undef DRV_RELDATE
#define DRV_RELDATE		"2013-02-21 r2837 (11ac)"
...
#else
#ifdef _PUMA6_
#define NUM_TX_DESC		768//256		// kmalloc max size issue
#else
...
#define LCK_DELAY_MS	msleep
#else
#define LCK_DELAY_MS	delay_ms
#endif
...
#undef NUM_TX_DESC
#define NUM_TX_DESC		1400		// kmalloc max size issue
#define USE_OUT_SRC					1
...
#define CONFIG_LUNA_SLAVE_PHYMEM_OFFSET 0x02100000
#else
