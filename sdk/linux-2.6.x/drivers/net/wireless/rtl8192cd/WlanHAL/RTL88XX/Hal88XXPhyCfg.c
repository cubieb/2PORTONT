    ...
    )
{
	...
	for(bPathXEnIdx = 0; bPathXEnIdx < 4 ; bPathXEnIdx++ ){
		...
		for(rate = TX_AGC_HT_NSS1_MCS7-TX_AGC_HT_NSS1_MCS0+1; rate <= TX_AGC_HT_NSS2_MCS15-TX_AGC_HT_NSS1_MCS0; rate++)
		...
		for(rate = TX_AGC_HT_NSS2_MCS15-TX_AGC_HT_NSS1_MCS0+1; rate <= TX_AGC_HT_NSS3_MCS23-TX_AGC_HT_NSS1_MCS0; rate++)
		...
		for(rate = 0; rate <= TX_AGC_VHT_NSS1_MCS7-TX_AGC_VHT_NSS1_MCS0; rate++)
		...
		for(rate = TX_AGC_VHT_NSS1_MCS7-TX_AGC_VHT_NSS1_MCS0+1; rate <= TX_AGC_VHT_NSS2_MCS7-TX_AGC_VHT_NSS1_MCS0; rate++)
		...
		for(rate = TX_AGC_VHT_NSS2_MCS7-TX_AGC_VHT_NSS1_MCS0+1; rate <= TX_AGC_VHT_NSS3_MCS7-TX_AGC_VHT_NSS1_MCS0; rate++)
...
)
{
	if (Band == RF88XX_BAND_ON_2_4G) { // 2.4G band
		...
		if (GET_CHIP_VER(Adapter) == VERSION_8881A) {
			...
			//3 RFE Type 0
			{
				panic_printk("RFE TYPE 0\n");
#if CFG_8814_C_CUT_TEMP
	            // RFE type 0
	            PHY_SetBBReg_88XX(Adapter, 0x1994, 0xf, 0xf); // (ANTSW/ANTSWB controlled by S3)
...
#else
	            // RFE type 0
	            PHY_SetBBReg_88XX(Adapter, REG_BB_A_RFE_PINMUX_AC, BIT_MASK_SET_MASKDWORD_COMMON, 0x45774577);
	            PHY_SetBBReg_88XX(Adapter, REG_BB_B_RFE_PINMUX_AC, BIT_MASK_SET_MASKDWORD_COMMON, 0x45774577);
	            PHY_SetBBReg_88XX(Adapter, REG_BB_C_RFE_PINMUX_AC, BIT_MASK_SET_MASKDWORD_COMMON, 0x45774577);
	            PHY_SetBBReg_88XX(Adapter, REG_BB_D_RFE_PINMUX_AC, BIT_MASK_SET_MASKDWORD_COMMON, 0x45774577);
#endif // CFG_8814_C_CUT_TEMP
            }
...
)
{
    ...
    s1Byte HAL_VAR_pwrdiff_40BW2S_20BW2S_X[4] = {HAL_VAR_pwrdiff_40BW2S_20BW2S_A(ch_idx), HAL_VAR_pwrdiff_40BW2S_20BW2S_B(ch_idx),
		...
		s1Byte diff_bw20_3s = 0;
		s1Byte diff_bw40_3s = 0;
		s1Byte HAL_VAR_pwrdiff_40BW3S_20BW3S_X[4] = {HAL_VAR_pwrdiff_40BW3S_20BW3S_A(ch_idx), HAL_VAR_pwrdiff_40BW3S_20BW3S_B(ch_idx), HAL_VAR_pwrdiff_40BW3S_20BW3S_C(ch_idx), HAL_VAR_pwrdiff_40BW3S_20BW3S_D(ch_idx)};		
#endif
