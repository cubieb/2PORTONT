...
#else
#define RETRY_LIMIT_SHORT_AP        0x08
...
#define HAL_VAR_CurrentTxAgcOFDM(path,chIdx)		(*(((u1Byte *)Adapter->pshare->phw->CurrentTxAgcOFDM)+path*8+chIdx))	
#define HAL_VAR_CurrentTxAgcMCS(path,chIdx)			(*(((u1Byte *)Adapter->pshare->phw->CurrentTxAgcMCS)+path*32+chIdx))	
#define HAL_VAR_CurrentTxAgcVHT(path,chIdx)			(*(((u1Byte *)Adapter->pshare->phw->CurrentTxAgcVHT)+path*40+chIdx))	
#endif
