...
ifeq ($(CONFIG_RTL_92E_SUPPORT),y)
	...
	ifeq ($(CONFIG_BEAMFORMING_SUPPORT), y)
        ...
        ifeq ($(CONFIG_EXT_LNA),y)
              ...
              CONFIG_SLOT_1_8192EE := n
              CONFIG_LNA_TYPE :=0
        endif

        ifeq ($(CONFIG_LNA_TYPE),0)
	    EXTRA_CFLAGS += -DCONFIG_LNA_TYPE_0
        endif

        ifeq ($(CONFIG_LNA_TYPE),1)
	   EXTRA_CFLAGS += -DCONFIG_LNA_TYPE_1
        endif

        ifeq ($(CONFIG_LNA_TYPE),2)
	   EXTRA_CFLAGS += -DCONFIG_LNA_TYPE_2
        endif

        ifeq ($(CONFIG_LNA_TYPE),3)
