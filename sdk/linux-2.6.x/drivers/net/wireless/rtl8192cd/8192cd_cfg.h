...
#define DRV_VERSION_L	3
#define DRV_RELDATE		"2016-03-01"
...
//-------------------------------------------------------------
// Advanced RSSI_MIN Selection
//-------------------------------------------------------------
#define ADV_RSSI_MIN_SEL
...
#endif
#else
#if defined(CONFIG_WIRELESS_LAN_MODULE) || defined(CONFIG_RTL_8198C) || (defined(CONFIG_RTL8672) && (LINUX_VERSION_CODE >= KERNEL_VERSION(3,18,0)))
#define __MIPS16
#else
#define __MIPS16			__attribute__ ((mips16))
#endif
...
#define RTK_AC_SUPPORT
	...
	#define NUM_RX_DESC		64
		...
		#elif  defined(CONFIG_WLAN_HAL_8814AE)
			#define NUM_RX_DESC     2048//512 //256 
...
//-------------------------------------------------------------
				...
				#if defined(CONFIG_WLAN_HAL_8814AE)
                    #define MAX_SKB_NUM	2048 //768
				#else	
					#define MAX_SKB_NUM     512
				#endif
			#elif defined(CONFIG_RTL_8198_GW) || defined(CONFIG_RTL_8198_AP_ROOT) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8198C)					
				#ifdef CONFIG_RTL_8812_SUPPORT					
					#ifdef CONFIG_RTL_8812AR_VN_SUPPORT    		
				    	#define MAX_SKB_NUM	480
					#elif defined(CONFIG_RTL_8198C)
