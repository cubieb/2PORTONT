...
static void mp_chk_sw_ant_8814(struct rtl8192cd_priv *priv)
{
	...
	*/
	...
	case ANTENNA_A:
		...
		PHY_SetBBReg(priv, 0xa04, 0xc000000, 0x0);	//0xa07[3:2]
		PHY_SetBBReg(priv, 0x82c, 0x0f000000, 0x6);
		PHY_SetBBReg(priv, 0x830, 0x0000000f, 0xb);		
	...
	case ANTENNA_C:
		...
		PHY_SetBBReg(priv, 0x1000, 0xff0000, 0x3);
		PHY_SetBBReg(priv, 0xa04, 0xc000000, 0x2);	 		
		PHY_SetBBReg(priv, 0x82c, 0x0f000000, 0x6);
		PHY_SetBBReg(priv, 0x830, 0x0000000f, 0xb);		
		PHY_SetRFReg(priv, 0, 0x00, 0xf0000, 1); 
		PHY_SetRFReg(priv, 1, 0x00, 0xf0000, 1);
	...
	case ANTENNA_D:
		...
		PHY_SetBBReg(priv, 0x1000, 0xff0000, 0x3);
		PHY_SetBBReg(priv, 0xa04, 0xc000000, 0x3);	
		PHY_SetBBReg(priv, 0x82c, 0x0f000000, 0x6);
		PHY_SetBBReg(priv, 0x830, 0x0000000f, 0xb);				
		PHY_SetRFReg(priv, 0, 0x00, 0xf0000, 1); 
		PHY_SetRFReg(priv, 1, 0x00, 0xf0000, 1);
	...
	case ANTENNA_CD:
		...
		break;		
	case ANTENNA_ABC:
		PHY_SetBBReg(priv, 0x82c, 0x0f000000, 0x3);
