...
//EXTERN u8* rtk_get_ie_with_oui(const u8 *in_ie, int in_len, u8 ie_to_search, u8 oui_type , int *report_ielen);
/*cfg p2p cfg p2p*/
EXTERN int rtk_p2p_is_enabled(struct rtl8192cd_priv *priv);
EXTERN u8* rtk_get_ie_with_oui(const u8 *in_ie, int in_len, u8 ie_to_search, u8* oui_input ,int oui_len, int *report_ielen);
...
EXTERN unsigned long _ioctl_copy_from_user (struct rtl8192cd_priv *priv, void * to, const void * from, unsigned long n, unsigned long *flags);
EXTERN unsigned long _ioctl_copy_to_user (struct rtl8192cd_priv *priv, void * to, const void * from, unsigned long n, unsigned long *flags);
