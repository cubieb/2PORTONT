...
)
{
	...
	HAL_RTL_W32(REG_BB_TXAGC_B_MCS15_MCS12_N, writeVal);
		...
		{
			if (HAL_TX2PATH) {
				HAL_RTL_W32(REG_BB_TXAGC_A_RATE18_06_N, (HAL_RTL_R32(REG_BB_TXAGC_A_RATE18_06_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_A_RATE54_24_N, (HAL_RTL_R32(REG_BB_TXAGC_A_RATE54_24_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_A_MCS03_MCS00_N, (HAL_RTL_R32(REG_BB_TXAGC_A_MCS03_MCS00_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_A_MCS07_MCS04_N, (HAL_RTL_R32(REG_BB_TXAGC_A_MCS07_MCS04_N) - pwrdiff));

				HAL_RTL_W32(REG_BB_TXAGC_B_RATE18_06_N, (HAL_RTL_R32(REG_BB_TXAGC_B_RATE18_06_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_B_RATE54_24_N, (HAL_RTL_R32(REG_BB_TXAGC_B_RATE54_24_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_B_MCS03_MCS00_N, (HAL_RTL_R32(REG_BB_TXAGC_B_MCS03_MCS00_N) - pwrdiff));
				HAL_RTL_W32(REG_BB_TXAGC_B_MCS07_MCS04_N, (HAL_RTL_R32(REG_BB_TXAGC_B_MCS07_MCS04_N) - pwrdiff));	
			}
...
)
{
	...
	PHY_SetBBReg_88XX(Adapter, REG_BB_TXAGC_A_CCK11_2_B_CCK11_N, 0xffffffff, writeVal);
		...
		{
			if (HAL_TX2PATH) {
				HAL_RTL_W32(REG_BB_TXAGC_A_CCK1_MCS32_N, (HAL_RTL_R32(REG_BB_TXAGC_A_CCK1_MCS32_N) - (pwrdiff & 0x0000ff00)));
				HAL_RTL_W32(REG_BB_TXAGC_B_CCK5_1_MCS32_N, (HAL_RTL_R32(REG_BB_TXAGC_B_CCK5_1_MCS32_N) - (pwrdiff & 0xffffff00)));		
				HAL_RTL_W32(REG_BB_TXAGC_A_CCK11_2_B_CCK11_N, (HAL_RTL_R32(REG_BB_TXAGC_A_CCK11_2_B_CCK11_N) - pwrdiff));
			}
