...
static struct iwpriv_arg mib_table[] = {
	...
	{"TH_L2H_ini",		RFFT_T,	_OFFSET_RFFT(TH_L2H_ini), _SIZE_RFFT(TH_L2H_ini), 0xf9},//Adaptivity()
...
//	{"antSw_dump",			RFFT_T, _OFFSET_RFFT(antSw_dump), _SIZE_RFFT(antSw_dump), 0},
	...
	{"pc0_th_idle_w56",	RFFT_T,	_OFFSET_RFFT(dfs_pc0_th_idle_w56), _SIZE_RFFT(dfs_pc0_th_idle_w56), 9},
...
//	{"mp_dig_enable",	RFFT_T, _OFFSET_RFFT(mp_dig_enable), _OFFSET_RFFT(mp_dig_enable), 0},
	...
	{"TH_L2H_ini",	ODM_DM_1UT,	_OFFSET_ODM_DM(TH_L2H_ini), _SIZE_ODM_DM(TH_L2H_ini), 0},// for odm_Adaptivity()
