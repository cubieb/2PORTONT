...
#elif defined(CONFIG_RTL_92E_SUPPORT) || defined(CONFIG_WLAN_HAL_8192EE)
	{"led_type",	INT_T,		_OFFSET(dot11OperationEntry.ledtype), _SIZE(dot11OperationEntry.ledtype), LEDTYPE_SW_LINKTXRXDATA},
#else
...
//#endif
#ifdef THREE_G_EXIST
	{"3gExist",				RFFT_T,	_OFFSET_RFFT(ThreeGExist), _SIZE_RFFT(ThreeGExist), 0},
#endif
#ifdef CONFIG_RTL_COMAPI_CFGFILE
