...
#elif (defined(CONFIG_RTL_88E_SUPPORT) || defined(CONFIG_WLAN_HAL_8192EE)) && defined (RTLWIFINIC_GPIO_CONTROL)
	if (flag)
...
void enable_sw_LED(struct rtl8192cd_priv *priv, int init)
{
	...
	// disable LED2 setting (restore to default value 0x28282)
	RTL_W32(LEDCFG, RTL_R32(LEDCFG) & 0x7ffff);
#endif
