...
//-------------------------------------------------------------
// Use Dyname memory alloc for Descriptor buffer (non-catcageable)
//-------------------------------------------------------------
//#define KMALLOC_DESC_DMA_BUF
...
//#undef RX_BUFFER_GATHER     // important
#undef DELAY_REFILL_RX_BUF  // important
...
#define __IRAM_IN_865X		__attribute__ ((section(".iram-rtkwlan")  target("code-readable=no")))
#else
...
#ifdef CONFIG_DATA_IN_IMEM
#define __IRAM_WLAN_HI		__attribute__ ((section(".iram-wapi") target("code-readable=no")))
#else
...
#undef DRV_RELDATE
#define DRV_RELDATE		"2013-05-09 r3331 (8192E)"
...
#endif
#ifdef CONFIG_DATA_IN_IMEM
#define __IRAM_IN_865X_HI	__attribute__ ((section(".iram-tx") target("code-readable=no")))
#else
...
#define MBSSID_PORT_MAPPING
#define IGMP_SNP
//#define THREE_G_EXIST
