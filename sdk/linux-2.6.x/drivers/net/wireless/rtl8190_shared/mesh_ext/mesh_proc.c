 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_mesh_auth_mpinfo(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int len = 0;
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_mesh_unEstablish_mpinfo(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int len = 0;
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_mesh_assoc_mpinfo(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int len = 0;
 ...
 */
int rtk8190_proc_flow_stats_write(struct file *file, const char *buffer, unsigned long count, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
 ...
 *	@retval	int: pos:unknow
 */
int rtk8190_proc_flow_stats(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_proc_mesh_stats(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int pos = 0;
...
int rtl8190_pathsel_routetable_info(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int len = 0;
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_proxy_table_info(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_root_info(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
 ...
 *	@retval	int: pos:Unknow
 */
int rtl8190_portal_table_info(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	int len = 0;
...
#ifdef MESH_USE_METRICOP
int rtl8190_mesh_metric_w (struct file *file, const char *buffer, unsigned long count, void *data)
{
...
int rtl8190_mesh_metric_r(char *buffer, char **buffer_location, off_t offset, int buffer_length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
...
int rtl8190_setMeshDebugLevel (struct file *file, const char *buffer, unsigned long count, void *data)
{
	unsigned char x[10];
...
int hasMeshDebugLevel (int lv) {
	return (g_nctu_mesh_dbg & (1<<lv));
}
int clearMeshDebugLevel (int lv) {
...
int isMySkb(struct sk_buff *skb)
{
	UINT8 type;
...
int decMySkb(struct sk_buff *skb)
{
	UINT8 type;
	if(memcmp(&(skb->cb[15]), tagmag, sizeof(tagmag)))
		return 0;
...
int tagMySkb(struct sk_buff *skb, UINT8 type)
{
	// if(isMySkb(skb))
		decMySkb(skb);
	...
	return incMySkb(type);
}

int showSpecificSkbs(UINT8 type)
{
	return atomic_read(&allskbs[type]);
}

// EXPORT_SYMBOL(tagMySkb);
EXPORT_SYMBOL(incMySkb);
EXPORT_SYMBOL(decMySkb);
EXPORT_SYMBOL(isMySkb);
int showAllSkbs(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	int i;
 ...
 *	@retval	int: pos:Unknow
 */
static int rtl8190_proc_mesh_clear_table(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_mesh_setMACAddr(struct file *file, const char *buffer, unsigned long count, void *data)
{
...
#ifdef MESH_BOOTSEQ_AUTH
static int rtl8190_proc_mesh_issueAuthReq(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_issueAuthRsp(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_issueDeAuth(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_openConnect(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_issueOpen(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_issueConfirm(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_issueClose(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
	struct stat_info	*pstat;
...
static int rtl8190_proc_mesh_closeConnect(char *buf, char **start, off_t offset, int length, int *eof, void *data)
{
	struct net_device *dev = (struct net_device *)data;
	struct rtl8190_priv *priv = (struct rtl8190_priv *)dev->priv;
