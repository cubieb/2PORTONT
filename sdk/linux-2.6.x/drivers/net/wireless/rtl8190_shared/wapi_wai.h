...
typedef	wapiMibType	wapiStaType;

typedef	wapiMibEncryptAlgorithm	wapiStaEncryptAlgorithm;
...
void wapiSetIE(struct rtl8190_priv	*priv);
...
int	wapiSendActiveAuthenticationPacket(struct rtl8190_priv *priv, struct stat_info *pstat, int len, uint8 *data);
