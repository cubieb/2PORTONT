	...
	)
{
	...
	if ((pDM_Odm->priv->pshare->rf_ft_var.print_table == 4) || (pDM_Odm->priv->pshare->rf_ft_var.print_table == 0xff)) {
		printk("0x%x	0x%05x\n", Addr, Data);
		watchdog_kick();
	}
}
 	...
 	)
{
    ...
    ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ConfigMACWithHeaderFile: [MAC_REG] %08X %08X\n", Addr, Data));
   	if ((pDM_Odm->priv->pshare->rf_ft_var.print_table == 1) || (pDM_Odm->priv->pshare->rf_ft_var.print_table == 0xff)) {
		printk("0x%x	0x%08x\n", Addr, Data);
		watchdog_kick();
	} 
    ...
    )
{
    ...
    ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ConfigBBWithHeaderFile: [AGC_TAB] %08X %08X\n", Addr, Data));
   	if ((pDM_Odm->priv->pshare->rf_ft_var.print_table == 3) || (pDM_Odm->priv->pshare->rf_ft_var.print_table == 0xff)) {
		printk("0x%x	0x%08x\n", Addr, Data);
		watchdog_kick();
	} 
...
{    
    ...
    ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ConfigBBWithHeaderFile: [PHY_REG] %08X %08X\n", Addr, Data));
   	if ((pDM_Odm->priv->pshare->rf_ft_var.print_table == 2) || (pDM_Odm->priv->pshare->rf_ft_var.print_table == 0xff)) {
		printk("0x%x	0x%08x\n", Addr, Data);
		watchdog_kick();
	} 
