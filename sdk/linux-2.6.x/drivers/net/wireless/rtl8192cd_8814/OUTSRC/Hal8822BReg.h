 ...
 * 
 *****************************************************************************/
#ifndef __INC_HAL8822BREG_H
#define __INC_HAL8822BREG_H
...
//
//-----------------------------------------------------
#define REG_SYS_ISO_CTRL_8822B			0x0000	// 2 Byte
#define REG_SYS_FUNC_EN_8822B			0x0002	// 2 Byte
#define REG_SYS_PW_CTRL_8822B			0x0004	// 4 Byte        
#define REG_SYS_CLKR_8822B				0x0008	// 2 Byte
#define REG_SYS_EEPROM_CTRL_8822B		0x000A	// 2 Byte        
#define REG_EE_VPD_8822B				0x000C	// 2 Byte
#define REG_SYS_SWR_CTRL1_8822B				0x0010	// 1 Byte
#define REG_SPS0_CTRL_8822B				0x0011	// 7 Byte
#define REG_SYS_SWR_CTRL3_8822B			0x0018	// 4 Byte
#define REG_RSV_CTRL_8822B				0x001C	// 3 Byte
#define REG_RF_CTRL0_8822B				0x001F	// 1 Byte
#define REG_RF_CTRL1_8822B				0x0020	// 1 Byte
#define REG_RF_CTRL2_8822B				0x0021	// 1 Byte
#define REG_LPLDO_CTRL_8822B			0x0023	// 1 Byte
#define REG_AFE_CTRL1_8822B				0x0024	// 4 Byte        
#define REG_AFE_CTRL2_8822B				0x0028	// 4 Byte        
#define REG_AFE_CTRL3_8822B				0x002c 	// 4 Byte 
#define REG_EFUSE_CTRL_8822B			0x0030
#define REG_LDO_EFUSE_CTRL_8822B		0x0034 
#define REG_PWR_DATA_8822B				0x0038
#define REG_CAL_TIMER_8822B				0x003C
#define REG_ACLK_MON_8822B				0x003E
#define REG_GPIO_MUXCFG_8822B			0x0040
#define REG_GPIO_IO_SEL_8822B			0x0042
#define REG_MAC_PINMUX_CFG_8822B		0x0043
#define REG_GPIO_PIN_CTRL_8822B			0x0044
#define REG_GPIO_INTM_8822B				0x0048
#define REG_LEDCFG0_8822B				0x004C
#define REG_LEDCFG1_8822B				0x004D
#define REG_LEDCFG2_8822B				0x004E
#define REG_LEDCFG3_8822B				0x004F
...
#define REG_MULTI_FUNC_CTRL_8822B		0x0068
#define REG_GPIO_STATUS_8822B			0x006C
#define REG_SDIO_CTRL_8822B				0x0070
#define REG_HCI_OPT_CTRL_8822B			0x0074
#define REG_RF_CTRL3_8822B				0x0076	// 1 Byte
#define REG_AFE_CTRL4_8822B				0x0078 
#define REG_8051FW_CTRL_8822B			0x0080 
...
#define REG_PBP_8822B					0x0104
#define REG_PKT_BUFF_ACCESS_CTRL_8822B	0x0106
#define REG_TRXDMA_CTRL_8822B			0x010C
#define REG_TRXFF_BNDY_8822B			0x0114
#define REG_TRXFF_STATUS_8822B			0x0118
#define REG_RXFF_BDNY_8822B				0x011C
#define REG_CPWM_8822B					0x012F
...
#define REG_RXPKTBUF_CTRL_8822B		0x0142
...
#define REG_RSVD3_8822B					0x0168
#define REG_C2HEVT_MSG_NORMAL_8822B	0x01A0
#define REG_C2HEVT_CLEAR_8822B			0x01AF
#define REG_MCUTST_1_8822B				0x01C0
#define REG_MCUTST_WOWLAN_8822B		0x01C7
#define REG_FMETHR_8822B				0x01C8
#define REG_HMETFR_8822B				0x01CC
#define REG_HMEBOX_0_8822B				0x01D0
#define REG_HMEBOX_1_8822B				0x01D4
#define REG_HMEBOX_2_8822B				0x01D8
#define REG_HMEBOX_3_8822B				0x01DC
#define REG_LLT_INIT_8822B				0x01E0
#define REG_LLT_ADDR_8822B				0x01E4 //20130415 KaiYuan add for 8814
#define REG_HMEBOX_EXT0_8822B			0x01F0
#define REG_HMEBOX_EXT1_8822B			0x01F4
#define REG_HMEBOX_EXT2_8822B			0x01F8
#define REG_HMEBOX_EXT3_8822B			0x01FC
...
#define REG_RXPKT_NUM_8822B				0x0284 // The number of packets in RXPKTBUF.
#define REG_RXDMA_CONTROL_8822B			0x0286 // ?????? Control the RX DMA.
#define REG_RXDMA_STATUS_8822B			0x0288
#define REG_RXDMA_MODE_8822B				0x0290 // ??????
#define REG_EARLY_MODE_CONTROL_8822B	0x02BC // ??????
#define REG_RSVD5_8822B					0x02F0 // ??????
...
//
//-----------------------------------------------------
#define	REG_PCIE_CTRL_REG_8822B			0x0300
#define	REG_INT_MIG_8822B				0x0304	// Interrupt Migration 
#define	REG_BCNQ_TXBD_DESA_8822B		0x0308	// TX Beacon Descriptor Address
#define	REG_MGQ_TXBD_DESA_8822B			0x0310	// TX Manage Queue Descriptor Address
#define	REG_VOQ_TXBD_DESA_8822B			0x0318	// TX VO Queue Descriptor Address
#define	REG_VIQ_TXBD_DESA_8822B			0x0320	// TX VI Queue Descriptor Address
#define	REG_BEQ_TXBD_DESA_8822B			0x0328	// TX BE Queue Descriptor Address
#define	REG_BKQ_TXBD_DESA_8822B			0x0330	// TX BK Queue Descriptor Address
#define	REG_RXQ_RXBD_DESA_8822B			0x0338	// RX Queue	Descriptor Address
...
#define	REG_RXQ_TXBD_IDX_8822B			0x03B4
...
#define REG_DBG_8822B						0x03FC
//-----------------------------------------------------
//
//	0x0400h ~ 0x047Fh	Protocol Configuration
//
//-----------------------------------------------------
#define REG_VOQ_INFORMATION_8822B		0x0400
#define REG_VIQ_INFORMATION_8822B		0x0404
#define REG_BEQ_INFORMATION_8822B		0x0408
#define REG_BKQ_INFORMATION_8822B		0x040C
#define REG_MGQ_INFORMATION_8822B		0x0410
#define REG_HGQ_INFORMATION_8822B		0x0414
#define REG_BCNQ_INFORMATION_8822B	0x0418
#define REG_TXPKT_EMPTY_8822B			0x041A
#define REG_CPU_MGQ_INFORMATION_8822B	0x041C
#define REG_FWHW_TXQ_CTRL_8822B		0x0420
#define REG_HWSEQ_CTRL_8822B			0x0423
#define REG_TXPKTBUF_BCNQ_BDNY_8822B	0x0424
//#define REG_MGQ_BDNY_8822B				0x0425
#define REG_LIFETIME_EN_8822B				0x0426
//#define REG_FW_FREE_TAIL_8822B			0x0427
...
#define REG_ARFR1_8822B					0x044C
#define REG_CCK_CHECK_8822B				0x0454
#define REG_AMPDU_MAX_TIME_8822B			0x0455
#define REG_TXPKTBUF_BCNQ1_BDNY_8822B	0x0456
...
#define REG_FAST_EDCA_CTRL_8822B		0x0460
...
#define REG_WMAC_LBK_BUF_HD_8822B		0x0478
#define REG_MGQ_PGBNDY_8822B 				0x047A
...
#define REG_NULL_PKT_STATUS_8822B 			0x04E0
#define REG_PTCL_ERR_STATUS_8822B 			0x04E2
#define REG_DROP_PKT_NUM_8822B 			0x04EC
#define REG_PTCL_TX_RPT_8822B 				0x04F0
#define REG_Dummy_8822B 					0x04FC
...
#define REG_SIFS_CTX_8822B					0x0514
#define REG_SIFS_TRX_8822B					0x0516
...
#define REG_BCN_CTRL_1_8822B				0x0551
...
#define REG_SECONDARY_CCA_CTRL_8822B		0x0577 // ??????
#define REG_PSTIMER_8822B					0x0580
#define REG_TIMER0_8822B					0x0584
#define REG_TIMER1_8822B					0x0588
#define REG_BCN_PREDL_ITV_8822B			0x058F	//Pre download beacon interval
...
//
//-----------------------------------------------------
#define REG_MAC_CR_8822B					0x0600
...
#define	REG_NAV_UPPER_8822B				0x0652	// unit of 128
#define REG_TRXPTCL_CTL_8822B				0x0668
...
#define REG_UAPSD_TID_8822B				0x0693
#define REG_WKFMCAM_NUM_8822B			0x0698
...
#define REG_TX_DATA_RSP_RATE_8822B		0x06DE
#define REG_ASSOCIATED_BFMER0_INFO_8822B	0x06E4
#define REG_ASSOCIATED_BFMER1_INFO_8822B	0x06EC
#define REG_CSI_RPT_PARAM_BW20_8822B		0x06F4
#define REG_CSI_RPT_PARAM_BW40_8822B		0x06F8
#define REG_CSI_RPT_PARAM_BW80_8822B		0x06FC
...
#define	EFUSE_CTRL_8822B					REG_EFUSE_CTRL_8822B		// E-Fuse Control.
#define	EFUSE_TEST_8822B					REG_LDO_EFUSE_CTRL_8822B		// E-Fuse Test.
#define	MSR_8822B							(REG_CR_8822B + 2)		// Media Status register
#define	ISR_8822B							REG_HISR0_8822B
#define	TSFR_8822B							REG_TSFTR_8822B			// Timing Sync Function Timer Register.
					
#define PBP_8822B							REG_PBP_8822B

// Redifine MACID register, to compatible prior ICs.
#define	IDR0_8822B							REG_MACID_8822B			// MAC ID Register, Offset 0x0050-0x0053
#define	IDR4_8822B							(REG_MACID_8822B + 4)	// MAC ID Register, Offset 0x0054-0x0055


//
// 9. Security Control Registers	(Offset: )
//
#define	RWCAM_8822B						REG_CAMCMD_8822B		//IN 8190 Data Sheet is called CAMcmd
#define	WCAMI_8822B						REG_CAMWRITE_8822B		// Software write CAM input content
#define	RCAMO_8822B						REG_CAMREAD_8822B		// Software read/write CAM config
#define	CAMDBG_8822B						REG_CAMDBG_8822B
#define	SECR_8822B							REG_SECCFG_8822B		//Security Configuration Register


//----------------------------------------------------------------------------
//       8195 IMR/ISR bits						(offset 0xB0,  8bits)
//----------------------------------------------------------------------------
#define	IMR_DISABLED_8822B					0
// IMR DW0(0x00B0-00B3) Bit 0-31
#define	IMR_TIMER2_8822B					BIT31		// Timeout interrupt 2
#define	IMR_TIMER1_8822B					BIT30		// Timeout interrupt 1	
#define	IMR_PSTIMEOUT_8822B				BIT29		// Power Save Time Out Interrupt
#define	IMR_GTINT4_8822B					BIT28		// When GTIMER4 expires, this bit is set to 1	
#define	IMR_GTINT3_8822B					BIT27		// When GTIMER3 expires, this bit is set to 1	
#define	IMR_TXBCN0ERR_8822B				BIT26		// Transmit Beacon0 Error			
#define	IMR_TXBCN0OK_8822B					BIT25		// Transmit Beacon0 OK			
#define	IMR_TSF_BIT32_TOGGLE_8822B		BIT24		// TSF Timer BIT32 toggle indication interrupt			
#define	IMR_BCNDMAINT0_8822B				BIT20		// Beacon DMA Interrupt 0			
#define	IMR_BCNDERR0_8822B					BIT16		// Beacon Queue DMA OK0			
#define	IMR_HSISR_IND_ON_INT_8822B		BIT15		// HSISR Indicator (HSIMR & HSISR is true, this bit is set to 1)
#define	IMR_BCNDMAINT_E_8822B				BIT14		// Beacon DMA Interrupt Extension for Win7			
#define	IMR_ATIMEND_8822B					BIT12		// CTWidnow End or ATIM Window End
#define	IMR_C2HCMD_8822B					BIT10		// CPU to Host Command INT Status, Write 1 clear	
#define	IMR_CPWM2_8822B					BIT9			// CPU power Mode exchange INT Status, Write 1 clear	
#define	IMR_CPWM_8822B						BIT8			// CPU power Mode exchange INT Status, Write 1 clear	
#define	IMR_HIGHDOK_8822B					BIT7			// High Queue DMA OK	
#define	IMR_MGNTDOK_8822B					BIT6			// Management Queue DMA OK	
#define	IMR_BKDOK_8822B					BIT5			// AC_BK DMA OK		
#define	IMR_BEDOK_8822B					BIT4			// AC_BE DMA OK	
#define	IMR_VIDOK_8822B					BIT3			// AC_VI DMA OK		
#define	IMR_VODOK_8822B					BIT2			// AC_VO DMA OK	
#define	IMR_RDU_8822B						BIT1			// Rx Descriptor Unavailable	
#define	IMR_ROK_8822B						BIT0			// Receive DMA OK

// IMR DW1(0x00B4-00B7) Bit 0-31
#define	IMR_MCUERR_8822B						BIT28		// Beacon DMA Interrupt 7
#define	IMR_BCNDMAINT7_8822B				BIT27		// Beacon DMA Interrupt 7
#define	IMR_BCNDMAINT6_8822B				BIT26		// Beacon DMA Interrupt 6
#define	IMR_BCNDMAINT5_8822B				BIT25		// Beacon DMA Interrupt 5
#define	IMR_BCNDMAINT4_8822B				BIT24		// Beacon DMA Interrupt 4
#define	IMR_BCNDMAINT3_8822B				BIT23		// Beacon DMA Interrupt 3
#define	IMR_BCNDMAINT2_8822B				BIT22		// Beacon DMA Interrupt 2
#define	IMR_BCNDMAINT1_8822B				BIT21		// Beacon DMA Interrupt 1
#define	IMR_BCNDOK7_8822B					BIT20		// Beacon Queue DMA OK Interrup 7
#define	IMR_BCNDOK6_8822B					BIT19		// Beacon Queue DMA OK Interrup 6
#define	IMR_BCNDOK5_8822B					BIT18		// Beacon Queue DMA OK Interrup 5
#define	IMR_BCNDOK4_8822B					BIT17		// Beacon Queue DMA OK Interrup 4
#define	IMR_BCNDOK3_8822B					BIT16		// Beacon Queue DMA OK Interrup 3
#define	IMR_BCNDOK2_8822B					BIT15		// Beacon Queue DMA OK Interrup 2
#define	IMR_BCNDOK1_8822B					BIT14		// Beacon Queue DMA OK Interrup 1
#define	IMR_ATIMEND_E_8822B				BIT13		// ATIM Window End Extension for Win7
#define	IMR_TXERR_8822B					BIT11		// Tx Error Flag Interrupt Status, write 1 clear.
#define	IMR_RXERR_8822B					BIT10		// Rx Error Flag INT Status, Write 1 clear
#define	IMR_TXFOVW_8822B					BIT9			// Transmit FIFO Overflow
#define	IMR_RXFOVW_8822B					BIT8			// Receive FIFO Overflow
