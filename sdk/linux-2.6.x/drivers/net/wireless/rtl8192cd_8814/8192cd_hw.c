...
//			ODM_RF_CALIBRATION		|
	...
	{		
		if(priv->pmib->dot11RFEntry.rfe_type == 2) {
			...
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GPA, 0x55);  // path (A,B,C,D) = (1,1,1,1)
			...
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GPA, 0xAA);	// path (A,B,C,D) = (2,2,2,2)
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_APA, 0xAA);
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GLNA, 0xAA);
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_ALNA, 0xAA);	
		} else if(priv->pmib->dot11RFEntry.rfe_type == 4) {
			panic_printk("PHY paratemters: RFE type 4 APA1+ALNA3+GPA1+GLNA1\n");
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GPA, 0x55); // path (A,B,C,D) = (2,2,2,2)
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_APA, 0x55);
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GLNA, 0x55); // path (A,B,C,D) = (3,3,3,3)
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_ALNA, 0xFF);	
			...
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_APA, 0x0);
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_GLNA, 0x0);
			ODM_CmnInfoInit(ODMPTR, ODM_CMNINFO_ALNA, 0x0);	
		}else {
...
//		phy_BB8192CD_Check_ParaFile(priv);
			...
			if (GET_CHIP_VER(priv) == VERSION_8814A) {
				...
				#endif
				RTL_W32(0x90c, 0x09004000); // disable LLTF_ch_smooth, Remove after PHY Parameter v051
