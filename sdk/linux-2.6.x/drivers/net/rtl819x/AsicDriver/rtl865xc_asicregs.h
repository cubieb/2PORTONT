...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/linux-2.6.30/drivers/net/rtl819x/AsicDriver/rtl865xc_asicregs.h,v 1.10 2012/10/24 04:12:52 ikevin362 Exp $
*
...
#if 0//def CONFIG_RTL8196C_REVISION_B	//cathy, rtl8676 do not need to toggle twice
...
#define MiiTxPktRDY_MASK					(0x3f << MiiTxPktRDY_OFFSET)
...
#define PDCR_BASE				(SWCORE_BASE + 0x00006110)/* Port-n Descriptor Counter Register */
#define P0DCR0					(0x000 + PDCR_BASE)/* Port-0 Descriptor Counter Register 0 */
#define P0DCR1					(0x004 + PDCR_BASE)/* Port-0 Descriptor Counter Register 1 */
#define P0DCR2					(0x008 + PDCR_BASE)/* Port-0 Descriptor Counter Register 2 */
