...
*
* $Id: rtl_glue.h,v 1.1.1.1 2010/05/05 09:00:48 jiunming Exp $
* $Log: rtl_glue.h,v $
* Revision 1.1.1.1  2010/05/05 09:00:48  jiunming
* check in LINUX 2.6.30
*
* Revision 1.1  2008/03/07 12:06:39  tylo
* packet processor
*
* Revision 1.3  2007/10/29 08:14:52  tony
* *: support memory leak debug mode.
*
* Revision 1.2  2007/06/20 08:11:05  tony
* *: fix ring ctrl test case(cause by trapping to cpu case:30), add interrupt
* handler.
*
* Revision 1.1  2007/06/01 05:29:01  michaelhuang
* *: added for re867x.
*
...
#define rtlglue_free(x) \
do { \
	printk("rtlglue_free(%x) call by %s %d\n",(uint32)x,__FUNCTION__,__LINE__); \
	kfree(x); \
} while(0);
#endif
...
#endif /* RTL865X_TEST || RTL865X_MODEL_USER || RTL867X_MODEL_USER */
