...
* Abstract :                                                           
* Author :              
* $Id: rtl_types.h,v 1.1.1.1 2010/05/05 09:00:48 jiunming Exp $
* $Log: rtl_types.h,v $
* Revision 1.1.1.1  2010/05/05 09:00:48  jiunming
* check in LINUX 2.6.30
*
* Revision 1.5  2009/03/25 06:15:20  yachang
* merge SVN packet processor code
*
* Revision 1.1  2008/03/07 12:06:39  tylo
* packet processor
*
* Revision 1.2  2007/06/06 09:47:33  tony
* *: support 8672 model code in kernel.
*
...
#if defined(__linux__)&&defined(__KERNEL__)&&defined(CONFIG_RTL867X)
