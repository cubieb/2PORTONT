/*
  ...
  $Header: /usr/local/dslrepos/linux-2.6.30/drivers/scsi/osst.c,v 1.1.1.1 2010/05/05 09:00:15 jiunming Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2010/05/05 09:00:15 jiunming Exp $";
