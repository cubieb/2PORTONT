/******************************************************************************
 * $Id: rtk_nand_sd5.c,v 1.5 2012/08/16 06:50:52 ccwei0908 Exp $
...
#define VERSION  "$Id: rtk_nand_sd5.c,v 1.5 2012/08/16 06:50:52 ccwei0908 Exp $"
...
//printk("%s : page %d len %d dma_counter %d\n",__FUNCTION__, page, len, dma_counter);
