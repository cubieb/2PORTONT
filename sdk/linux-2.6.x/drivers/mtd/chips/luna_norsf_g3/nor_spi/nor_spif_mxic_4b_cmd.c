...
norsf_read_cmd_t mx25l25635f_read_cmd_4b_cmd SECTION_NOR_SPIF_GEN2_PARAM = {
#if (NORSF_XREAD_EN == 1)
	.a.cmd      = 0xEC,
	.a.write_en = 0,
	.a.dummy_ck = 6,
...
norsf_cmd_info_t mx25l25635f_cmd_info_4b_cmd SECTION_NOR_SPIF_GEN2_PARAM = {
	...
	.cread = &mx25l25635f_read_cmd_4b_cmd,
};
...
int norsf_mxic_xread_en(const norsf_g2_info_t *ni,
                        const u32_t cs) {
	u8_t status;
...
SECTION_NOR_SPIF_GEN2_CORE
__attribute__ ((unused))
int norsf_mxic_xread_ex(const norsf_g2_info_t *ni,
                        const u32_t cs) {
	u8_t status;
...
norsf_g2_info_t *norsf_mxic_4b_cmd_probe(void) {
...
REG_NOR_SPIF_PROBE_FUNC(norsf_mxic_4b_cmd_probe);
