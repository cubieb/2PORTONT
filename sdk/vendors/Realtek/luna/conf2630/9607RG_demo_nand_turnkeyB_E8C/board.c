...
//	REG32(BSP_MISC_PINMUX) |= (BSP_ZSI_ISI_PINMUX_C0 | BSP_ZSI_ISI_PINMUX_C1);
...

	{
		...
		rtk_led_config_t ledConfig_100M;
		rtk_led_config_t ledConfig_1G;
		...
		rtk_led_parallelEnable_set(7,ENABLED);//1G blinks 
		...
		memset(&ledConfig_100M,0x0,sizeof(rtk_led_config_t));
		ledConfig_100M.ledEnable[LED_CONFIG_SPD100ACT] = ENABLED;
		ledConfig_100M.ledEnable[LED_CONFIG_SPD10ACT] = ENABLED;
		ledConfig_100M.ledEnable[LED_CONFIG_SPD100] = ENABLED;
		ledConfig_100M.ledEnable[LED_CONFIG_SPD10] = ENABLED;
		rtk_led_config_set(2,LED_TYPE_UTP3,&ledConfig_100M);    


		memset(&ledConfig_1G,0x0,sizeof(rtk_led_config_t));
		ledConfig_1G.ledEnable[LED_CONFIG_SPD1000ACT] = ENABLED;
		ledConfig_1G.ledEnable[LED_CONFIG_SPD500ACT] = ENABLED;
		ledConfig_1G.ledEnable[LED_CONFIG_SPD1000] = ENABLED;
		ledConfig_1G.ledEnable[LED_CONFIG_SPD500] = ENABLED;
		rtk_led_config_set(7,LED_TYPE_UTP3,&ledConfig_1G);
