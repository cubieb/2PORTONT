...
//	REG32(BSP_MISC_PINMUX) |= (BSP_ZSI_ISI_PINMUX_C0 | BSP_ZSI_ISI_PINMUX_C1);
...

    {
        ...
        rtk_led_parallelEnable_set(0,ENABLED);
	rtk_led_parallelEnable_set(3,ENABLED);
        ...
        rtk_led_config_set(0,LED_TYPE_UTP0,&ledConfig);    

        memset(&ledConfig,0x0,sizeof(rtk_led_config_t));    
        ledConfig.ledEnable[LED_CONFIG_SPD1000] = ENABLED;

        rtk_led_config_set(3,LED_TYPE_UTP0,&ledConfig);    
    }
...
/* Appended for 9601B to enable NORSF 4B mode. */
