...
//	REG32(BSP_MISC_PINMUX) |= (BSP_ZSI_ISI_PINMUX_C0 | BSP_ZSI_ISI_PINMUX_C1);
	...
	rtk_i2c_init(0);
        ...
        rtk_led_config_set(8,LED_TYPE_UTP3,&ledConfig);    
        rtk_led_config_set(4,LED_TYPE_UTP2,&ledConfig);    
        rtk_led_config_set(12,LED_TYPE_UTP1,&ledConfig);    
        rtk_led_config_set(13,LED_TYPE_UTP0,&ledConfig);    
