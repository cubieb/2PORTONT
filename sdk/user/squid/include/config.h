/*
 * $Id: config.h,v 1.1.1.1 2003/08/18 05:40:24 kaohj Exp $
 *
...
#elif defined(__CYGWIN32__)  || defined(__CYGWIN__) || defined(WIN32) || defined(WINNT) || defined(__WIN32__) || defined(__WIN32)
