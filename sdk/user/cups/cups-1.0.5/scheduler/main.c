/*
 * "$Id: main.c,v 1.2 2011/05/25 14:40:48 cathy Exp $"
 *
...
//cathy
#define CUPSDPID "/var/run/cupsd.pid"
...
//cathy
  ...
  */
  ...
  //cathy
  pid_fd = pidfile_acquire(CUPSDPID);  
  if (pid_fd < 0)
    exit(1);
  else
...
/*
 * End of "$Id: main.c,v 1.2 2011/05/25 14:40:48 cathy Exp $".
 */
