/*
 * "$Id: ipp.c,v 1.1 2011/02/22 15:42:38 cathy Exp $"
 *
  ...
  */
      ...
      strcmp(type, "octet-stream") == 0)
  {
    ...
    */
	...
	if(filetype == NULL)
		DEBUG_puts("print_job: filetype=NULL from MimeDatabase.");
	else
		DEBUG_printf(("print_job: 1 request file type is %s/%s.\n",
  ...
  if (filetype == NULL)
  {
	...
	DEBUG_puts("print_job: send_ipp_error\n");
	
	if(format) {
		DEBUG_puts("print_job: 001\n");
...
/*
 * End of "$Id: ipp.c,v 1.1 2011/02/22 15:42:38 cathy Exp $".
 */
