...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->cmdsocket_help = gengetopt_args_info_help[142] ;
  args_info->radiusoriginalurl_help = gengetopt_args_info_help[143] ;
  args_info->swapoctets_help = gengetopt_args_info_help[144] ;
  args_info->usestatusfile_help = gengetopt_args_info_help[145] ;
  args_info->statusfilesave_help = gengetopt_args_info_help[146] ;
  args_info->localusers_help = gengetopt_args_info_help[147] ;
  args_info->postauthproxy_help = gengetopt_args_info_help[148] ;
  args_info->postauthproxyport_help = gengetopt_args_info_help[149] ;
  args_info->wpaguests_help = gengetopt_args_info_help[150] ;
  args_info->openidauth_help = gengetopt_args_info_help[151] ;
  args_info->papalwaysok_help = gengetopt_args_info_help[152] ;
  args_info->mschapv2_help = gengetopt_args_info_help[153] ;
  args_info->chillixml_help = gengetopt_args_info_help[154] ;
  args_info->acctupdate_help = gengetopt_args_info_help[155] ;
  args_info->dnsparanoia_help = gengetopt_args_info_help[156] ;
  args_info->seskeepalive_help = gengetopt_args_info_help[157] ;
  args_info->usetap_help = gengetopt_args_info_help[158] ;
  args_info->noarpentries_help = gengetopt_args_info_help[159] ;
  args_info->routeif_help = gengetopt_args_info_help[160] ;
  args_info->framedservice_help = gengetopt_args_info_help[161] ;
  args_info->tcpwin_help = gengetopt_args_info_help[162] ;
  args_info->scalewin_help = gengetopt_args_info_help[163] ;
  args_info->tcpmss_help = gengetopt_args_info_help[164] ;
  args_info->maxclients_help = gengetopt_args_info_help[165] ;
  args_info->challengetimeout_help = gengetopt_args_info_help[166] ;
  args_info->challengetimeout2_help = gengetopt_args_info_help[167] ;
  args_info->redir_help = gengetopt_args_info_help[168] ;
  args_info->inject_help = gengetopt_args_info_help[169] ;
  args_info->injectext_help = gengetopt_args_info_help[170] ;
  args_info->injectwispr_help = gengetopt_args_info_help[171] ;
  args_info->routeonetone_help = gengetopt_args_info_help[172] ;
  args_info->nousergardendata_help = gengetopt_args_info_help[173] ;
  args_info->uamgardendata_help = gengetopt_args_info_help[174] ;
  args_info->uamotherdata_help = gengetopt_args_info_help[175] ;
  args_info->sslkeyfile_help = gengetopt_args_info_help[176] ;
  args_info->sslkeypass_help = gengetopt_args_info_help[177] ;
  args_info->sslcertfile_help = gengetopt_args_info_help[178] ;
  args_info->sslcafile_help = gengetopt_args_info_help[179] ;
  args_info->unixipc_help = gengetopt_args_info_help[180] ;
  args_info->uamallowpost_help = gengetopt_args_info_help[181] ;
  args_info->natip_help = gengetopt_args_info_help[182] ;
  args_info->natport_help = gengetopt_args_info_help[183] ;
  args_info->redirssl_help = gengetopt_args_info_help[184] ;
  args_info->uamuissl_help = gengetopt_args_info_help[185] ;
  args_info->dnslog_help = gengetopt_args_info_help[186] ;
  args_info->ipwhitelist_help = gengetopt_args_info_help[187] ;
  args_info->uamdomainfile_help = gengetopt_args_info_help[188] ;
  args_info->layer3_help = gengetopt_args_info_help[189] ;
  args_info->patricia_help = gengetopt_args_info_help[190] ;
  args_info->redirdnsreq_help = gengetopt_args_info_help[191] ;
  args_info->kname_help = gengetopt_args_info_help[192] ;
  args_info->moddir_help = gengetopt_args_info_help[193] ;
  args_info->module_help = gengetopt_args_info_help[194] ;
  args_info->module_min = 0;
  args_info->module_max = 0;
  args_info->dhcpopt_help = gengetopt_args_info_help[195] ;
  args_info->dhcpopt_min = 0;
  args_info->dhcpopt_max = 0;
  args_info->extadmvsa_help = gengetopt_args_info_help[196] ;
  args_info->extadmvsa_min = 0;
  args_info->extadmvsa_max = 0;
  args_info->dhcpnotidle_help = gengetopt_args_info_help[197] ;
  args_info->ipv6_help = gengetopt_args_info_help[198] ;
  args_info->ipv6only_help = gengetopt_args_info_help[199] ;
