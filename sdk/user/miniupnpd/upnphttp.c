/* $Id: upnphttp.c,v 1.8 2008/05/26 12:14:06 adsmt Exp $ */
/* Project :  miniupnp
...
static void ProcessHTTPSubscribe_upnphttp(struct upnphttp * h, const char * path)
{
	...
	/* TODO : - add to the subscriber list
...
static void ProcessHttpQuery_upnphttp(struct upnphttp * h)
{
	...
	syslog(LOG_INFO, "HTTP REQUEST : %s %s (%s)", HttpCommand, HttpUrl, HttpVer);
