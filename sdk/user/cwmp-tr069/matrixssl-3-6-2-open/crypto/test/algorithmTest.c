...
#ifndef USE_AESNI_CRYPTO
		/* This API undefined for AES_NI, so test will fail */
...
*/
    pkcs1ParsePrivBin(pool, RSA1024KEY, sizeof(RSA1024KEY), &privkey);
...
*/
    pkcs1ParsePrivBin(pool, RSA1024KEY, sizeof(RSA1024KEY), &privkey);
	psX509ParseCert(pool, RSA1024, sizeof(RSA1024), &cert, 0);
