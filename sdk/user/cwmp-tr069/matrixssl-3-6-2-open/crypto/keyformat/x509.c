...
/*baoguo_du:20141229 Start some cert files may be not 4bytes allignment*/	
	while (fileBufLen > 4) {
/*baoguo_du:20141229 END*/		
PARSEMORE:
...
/*baoguo_du:20141229 Start there are more than one certs sometimes*/
		if((strstr(end, "-----BEGIN CERTIFICATE-----") != NULL) && 
			(strstr(end, "-----END CERTIFICATE-----") != NULL) 
			)
		{
			goto PARSEMORE;
		}
...
/*baoguo_du:20141229 Start some certs support non-v3 certificate version*/
#if 0
		if (cert->version != 2) {
...
/*baoguo_du:20150615 START delete validateDateRange for OSK*/
#if 0
...
/*baoguo_du:20141231 START if there is no Extensions, we should set pathLenConstraint -1 to avoid PS_CERT_AUTH_FAIL_PATH_LEN error */		
		else
		{
			cert->extensions.bc.pathLenConstraint = -1;
		}
/*baoguo_du:20141231 END */		
/*
...
*/
/*baoguo_du:20141231 START there is no commonName for some certs*/
#if 0
...
{
	return 0;
#if 0//QL: dont do CERTIFICATE DATE VALIDITY
#ifdef POSIX
	struct tm	t;
	time_t		rawtime;
	char		*c;
...
*/
/*baoguo_du:20141231 START basicConstraints=CA:FALSE in some CA certs*/
#if 0
...
/*baoguo_du:20141231 START there is no KeyUsage ext for some certs.*/
#if 0			
