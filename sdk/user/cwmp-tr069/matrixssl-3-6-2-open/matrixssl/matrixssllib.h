...
#define SSL_FLAGS_PENDING_R		0x00200000 /* Non-blocking app record read */
#define SSL_FLAGS_PENDING_W		0x00400000 /* Non-blocking app record write */
#define SSL_FLAGS_PENDING_FLIGHT_W	0x80000000 /* mid encryptFlight (hshake) */
...
typedef struct ssl {
	...
	/* QL add below two member for sslRead */
	unsigned char   *plainBuf;	/* Start Position of plain text to read */
	uint32          plainLen;	/* plain text length */
...
extern int32 matrixValidateCerts(psPool_t *pool, psX509Cert_t *subjectCerts,
				...
				psX509Cert_t **foundIssuer, void *pkiData);
