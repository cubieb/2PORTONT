...
# $Id: configure.pl,v 1.1 2011/05/09 08:53:35 krammer Exp $
# $Source: /usr/local/dslrepos/uClinux-dist/user/samba-3.0.24/examples/LDAP/smbldap-tools-0.9.2/configure.pl,v $
