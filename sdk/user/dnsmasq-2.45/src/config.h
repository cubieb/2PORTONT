...
// Mason Yu.
// RFC6891(6.2.5): A good compromise may be the use of an EDNS maximum payload size of 4096 octets as a starting point.
// And meet CDrouter test on dns_120
//#define EDNS_PKTSZ 1280 /* default max EDNS.0 UDP packet from RFC2671 */
#define EDNS_PKTSZ 4096 /* default max EDNS.0 UDP packet from RFC2671 */
...
#define HOSTSFILE "/var/tmp/hosts"		// Mason Yu patched from version 1.8
