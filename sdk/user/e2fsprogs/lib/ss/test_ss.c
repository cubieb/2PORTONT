 ...
 *------------------------------------------------------------------
 *
 * $Source: /usr/local/dslrepos/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 2003/08/18 05:41:45 $
 * $State: Exp $
 * $Author: kaohj $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.1  2003/08/18 05:41:45  kaohj
...
static char const rcsid_test_c[] =
    "$Header: /usr/local/dslrepos/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v 1.1.1.1 2003/08/18 05:41:45 kaohj Exp $";
#endif /* lint */
