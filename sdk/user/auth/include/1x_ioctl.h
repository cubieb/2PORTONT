...
/*
 *	Attribute Error-Cause(101) value
 */
typedef enum _ErrorCauseNo{
	No_Error							=	0,
	//	Values 200-299 represent successful completion
	Residual_Session_Context_Removed	=	201,
	Invalid_EAP_Packet					=	202,
	//	Values 400-499 represent fatal errors committed by the RADIUS server
	...
	//	Values 500-599 represent fatal errors occurring on a NAS or RADIUS proxy
