...
#-------------------------------------------------------------------------------
#                                                                                                                         
# $Id: netstat-nat.c,v 1.1.1.1 2003/08/18 05:41:21 kaohj Exp $     
#       
# $Log: netstat-nat.c,v $
# Revision 1.1.1.1  2003/08/18 05:41:21  kaohj
...
static char const rcsid[] = "$Id: netstat-nat.c,v 1.1.1.1 2003/08/18 05:41:21 kaohj Exp $";
char SRC_IP[35];
char DST_IP[35];
int SNAT = 1;
int DNAT = 1;
