...
print_version(FILE *fp)
{
	...
	(void)fprintf(fp,
		      "\n" PNAME " plugin for eurodyndns.org version " VERSION ",\n"
...
update_dyndns(const int s, struct arguments *args)
{
	...
	(void)snprintf(message, BUFLEN,
                       "GET /update/?system=%s&hostname=%s&wildcard=%s"
                       "&backmx=%s&offline=%s",
