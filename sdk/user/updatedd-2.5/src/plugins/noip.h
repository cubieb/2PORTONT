...
static int noip_get_flags(struct arguments *args, int argc, char *argv[]);
static int noip_update_dyndns(int s, struct arguments *args);
static int noip_check_server_msg(int s, char *hostname);
