...
<DIV align="left" style="padding-left:20px; padding-top:5px;">
 <form id="form" action="/boaform/admin/formQosTraffictl" method="post">
   ...
   <p><% multilang("612" "LANG_TOTAL_BANDWIDTH_LIMIT"); %>:<input type="text" id="totalbandwidth" value="1005"><% multilang("627" "LANG_KB"); %></p>
   <table class="flat" id="traffictl_tbl" border="1" cellpadding="0" cellspacing="1">
       <tr class="hdb" align="center" nowrap bgcolor="#CCCCCC">
      <td><% multilang("617" "LANG_ID"); %></td>
      <td><% multilang("89" "LANG_PROTOCOL"); %></td>
      <td><% multilang("337" "LANG_SOURCE_PORT"); %></td>
      <td><% multilang("338" "LANG_DESTINATION_PORT"); %></td>
      <td><% multilang("334" "LANG_SOURCE"); %> IP</td>
      <td><% multilang("335" "LANG_DESTINATION"); %> IP</td>
      <td><div id='vlanID' style="display:<% check_display("vlanID"); %>" ><% multilang("118" "LANG_VLAN_ID"); %></div></td>
      <td><div id='ssid' style="display:<% check_display("ssid"); %>" ><% multilang("126" "LANG_SSID"); %></div></td>
      <td><% multilang("589" "LANG_RATE"); %>(kb/s)</td>
      <td><% multilang("254" "LANG_DELETE"); %></td>
      <td>IP <% multilang("622" "LANG_VERSION"); %></td>
                        <td><% multilang("330" "LANG_DIRECTION"); %></td>
      <td><div id='wan_interface' style="display:<% check_display("wan_interface"); %>" ><% multilang("369" "LANG_WAN_INTERFACE"); %></div></td>

     </tr>
   </table>
   <table><tr align="left">
   <td><input type="button" class="button" onClick="location.href='net_qos_traffictl_edit.asp';" value="<% multilang("195" "LANG_ADD"); %>"></td>
   <td><input type="button" class="button" onClick="on_submit();" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>"></td>
   <td>
   ...
   <input type="button" class="button" onClick="on_cancel_bandwidth();" value="<% multilang("626" "LANG_CANCEL_TOTAL_BANDWIDTH_LIMIT"); %>">
   </div></td>
   </tr></table>
