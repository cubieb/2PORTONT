...
<title>SNMP <% multilang("212" "LANG_CONFIGURATION"); %></title>
...
function saveChanges()
{
 ...
 alert("<% multilang("2321" "LANG_INVALID_OBJECT_ID_VALUE_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 str = str.substring(1);
  ...
  //document.write(i);
  if ( i!=6 ) {
   alert("<% multilang("2322" "LANG_INVALID_OBJECT_ID_VALUE_IT_SHOULD_BE_FILL_WITH_OID_STRING_AS_1_3_6_1_4_1_X"); %>");
   document.snmpTable.snmpSysObjectID.value = document.snmpTable.snmpSysObjectID.defaultValue;
 document.snmpTable.snmpSysObjectID.focus();
   return false;
  }
  ...
  //document.write(str2);	
  if( str2!="1.3.6.1.4.1" ) {
   alert("<% multilang("2323" "LANG_INVALID_OBJECT_ID_VALUE_IT_SHOULD_BE_FILL_WITH_PREFIX_OID_STRING_AS_1_3_6_1_4_1"); %>");
   document.snmpTable.snmpSysObjectID.value = document.snmpTable.snmpSysObjectID.defaultValue;
 document.snmpTable.snmpSysObjectID.focus();
 return false;
  }
...
<body>
<blockquote>
<h2><font color="#0000FF">SNMP <% multilang("212" "LANG_CONFIGURATION"); %></font></h2>

<form action=/boaform/formSnmpConfig method=POST name="snmpTable">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("691" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_SNMP_HERE_YOU_MAY_CHANGE_THE_SETTINGS_FOR_SYSTEM_DESCRIPTION_TRAP_IP_ADDRESS_COMMUNITY_NAME_ETC"); %>
  </font></td></tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr>
      ...
      <td><font size=2>
       <input type="radio" value="0" name="snmp_enable" <% checkWrite("snmpd-on"); %> ><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
      <input type="radio" value="1" name="snmp_enable" <% checkWrite("snmpd-off"); %> ><% multilang("222" "LANG_ENABLE"); %>&nbsp;&nbsp;
      </td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("692" "LANG_SYSTEM_DESCRIPTION"); %></b></td>
      <td width="60%"><input type="text" name="snmpSysDescr" size="50" maxlength="64" value="<% getInfo("snmpSysDescr"); %>"></td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("693" "LANG_SYSTEM_CONTACT"); %></b></td>
      <td width="60%"><input type="text" name="snmpSysContact" size="50" maxlength="64" value="<% getInfo("snmpSysContact"); %>"></td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("70" "LANG_SYSTEM"); %><% multilang("619" "LANG_NAME"); %></b></td>
      <td width="60%"><input type="text" name="snmpSysName" size="50" maxlength="64" value="<% getInfo("snmpSysName"); %>"></td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("694" "LANG_SYSTEM_LOCATION"); %></b></td>
      <td width="60%"><input type="text" name="snmpSysLocation" size="50" maxlength="64" value="<% getInfo("snmpSysLocation"); %>"></td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("695" "LANG_SYSTEM_OBJECT_ID"); %></b></td>
      <td width="60%"><input type="text" name="snmpSysObjectID" size="50" maxlength="64" value="<% getInfo("snmpSysObjectID"); %>"></td>
  </tr>

  <tr>
      <td width="40%"><font size=2><b><% multilang("696" "LANG_TRAP_IP_ADDRESS"); %></b></td>
      <td width="60%"><input type="text" name="snmpTrapIpAddr" size="15" maxlength="15" value=<% getInfo("snmpTrapIpAddr"); %>></td>
  </tr>


  <tr>
      <td width="40%"><font size=2><b><% multilang("697" "LANG_COMMUNITY_NAME_READ_ONLY"); %></b></td>
      <td width="60%"><input type="text" name="snmpCommunityRO" size="50" maxlength="64" value="<% getInfo("snmpCommunityRO"); %>"></td>
  </tr>


  <tr>
      <td width="40%"><font size=2><b><% multilang("698" "LANG_COMMUNITY_NAME_WRITE_ONLY"); %></b></td>
