...
<title>UPnP <% multilang("212" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
<body>
<blockquote>
<h2 style="color:#0000FF">UPnP <% multilang("212" "LANG_CONFIGURATION"); %></h2>
...
<table border=0 width="500" cellspacing=4 cellpadding=4 style="font-size: 13">
  <tr>
   <td>
    <% multilang("371" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_UPNP_THE_SYSTEM_ACTS_AS_A_DAEMON_WHEN_YOU_ENABLE_IT_AND_SELECT_WAN_INTERFACE_UPSTREAM_THAT_WILL_USE_UPNP"); %>
   </td>
  </tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=4 style="font-size: 13">
 <tr>
  <td><b><% multilang("28" "LANG_UPNP"); %>:</b></td>
  <td>
   <input type="radio" value="0" name="daemon" <% checkWrite("upnp0"); %> onClick="proxySelection()"><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
   <input type="radio" value="1" name="daemon" <% checkWrite("upnp1"); %> onClick="proxySelection()"><% multilang("222" "LANG_ENABLE"); %>
  </td>
 </tr>
 <% checkWrite("tr064_switch"); %>
 <tr>
  <td><b><% multilang("369" "LANG_WAN_INTERFACE"); %>:</b></td>
  <td>
