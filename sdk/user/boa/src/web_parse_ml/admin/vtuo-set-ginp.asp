...
function ginp_saveChanges()
{
 if(document.set_vtuo_ginp.DSGinpMode.selectedIndex!=0)
 {
  ...
  {
   alert('<% multilang("1983" "LANG_INVALID_VALUE_FOR_EFFECTIVE_THROUGHPUT"); %>');
