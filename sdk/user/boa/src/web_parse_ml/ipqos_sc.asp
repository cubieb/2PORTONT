...
<tr><td><font size=2>
 <% multilang("579" "LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_TO_ASSIGN_THE_PRECEDENCE_FOR_EACH_INCOMING_PACKET_IF_DISABLE_IP_QOS_TRAFFIC_SHAPING_WILL_BE_EFFECTIVE_OTHERWISE_TRAFFIC_SHAPING_IS_INVALID"); %>
</font></td></tr>
</table>
...
<tr>
 ...
 <td width=60%>
  <input type="radio" name=qosen value=0 onClick="return adminClick()"><font size=2><% multilang("161" "LANG_DISABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=qosen value=1 onClick="return adminClick()"><font size=2><% multilang("160" "LANG_ENABLED"); %>
 </td>
</tr>
<tr>
 <td width=20%><font size=2><% multilang("580" "LANG_POLICY"); %>:</td>
 <td width=60%>
...
<td colspan="2"><hr size=1 width=600 noshade align=left></td>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td colspan="2"><th colspan=4><u><% multilang("581" "LANG_SPECIFY_TRAFFIC_CLASSIFICATION_RULES"); %></u></th></td></tr>
</table>

<table border=0 width=600 cellspacing=0 cellpadding=0>
<!--<tr><td colSpan="2"><b>SET-1</b></td></tr>-->
<tr>
 <td width="200px"><% multilang("89" "LANG_PROTOCOL"); %>:</td>
...
<tr><td><% multilang("334" "LANG_SOURCE"); %> IP:</td><td><input type=text name=sip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("582" "LANG_SOURCE_MASK"); %>:</td><td><input type=text name=smask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("337" "LANG_SOURCE_PORT"); %>:</td><td><input type=text name=sport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("335" "LANG_DESTINATION"); %> IP:</td><td><input type=text name=dip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("583" "LANG_DESTINATION_MASK"); %>:</td><td><input type=text name=dmask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("338" "LANG_DESTINATION_PORT"); %>:</td><td><input type=text name=dport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
 <td><% multilang("584" "LANG_PHYSICAL_PORT"); %>:</td>
...
<td colspan="2"><hr size=1 width=600 noshade align=left></td>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td colspan="2"><th colspan=4><u><% multilang("585" "LANG_ASSIGN_PRIORITY_AND_OR_IP_PRECEDENCE_AND_OR_TYPE_OF_SERVICE_AND_OR_DSCP"); %></u></th></td></tr>
</table>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td width="200px "><font size=2><% multilang("586" "LANG_OUTBOUND_PRIORITY"); %>:</td>
 <td>
  <% pq_egress(); %>
 </td>
</tr>
