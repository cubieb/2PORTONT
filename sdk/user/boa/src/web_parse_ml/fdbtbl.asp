...
<title><% multilang("781" "LANG_BRIDGE_FORWARDING_DATABASE"); %></title>
</head>

<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("781" "LANG_BRIDGE_FORWARDING_DATABASE"); %></font></h2>
...
<tr bgcolor=#7f7f7f> <td width="10%"><font size=2><b><% multilang("187" "LANG_PORT"); %></b></td>
<td width="20%"><font size=2><b><% multilang("86" "LANG_MAC_ADDRESS"); %></b></td>
<td width="10%"><font size=2><b><% multilang("783" "LANG_IS_LOCAL"); %>?</b></td>
<td width="10%"><font size=2><b><% multilang("784" "LANG_AGEING_TIMER"); %></b></td></tr>
<% bridgeFdbList(); %>
</table>
