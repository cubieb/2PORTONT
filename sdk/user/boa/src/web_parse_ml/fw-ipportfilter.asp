...
<title>IP/Port <% multilang("324" "LANG_FILTERING"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF">IP/Port <% multilang("324" "LANG_FILTERING"); %></font></h2>
...
<tr <% checkWrite("rg_hidden_function"); %>><td><font size=2><b><% multilang("326" "LANG_OUTGOING_DEFAULT_ACTION"); %></b>&nbsp;&nbsp;
    <input type="radio" name="outAct" value=0 <% checkWrite("ipf_out_act0"); %>><% multilang("327" "LANG_DENY"); %>&nbsp;&nbsp;
    <input type="radio" name="outAct" value=1 <% checkWrite("ipf_out_act1"); %>><% multilang("328" "LANG_ALLOW"); %>&nbsp;&nbsp;
</font></td><tr>
<tr <% checkWrite("rg_hidden_function"); %>><td><font size=2><b><% multilang("329" "LANG_INCOMING_DEFAULT_ACTION"); %></b>&nbsp;&nbsp;
    <input type="radio" name="inAct" value=0 <% checkWrite("ipf_in_act0"); %>><% multilang("327" "LANG_DENY"); %>&nbsp;&nbsp;
    <input type="radio" name="inAct" value=1 <% checkWrite("ipf_in_act1"); %>><% multilang("328" "LANG_ALLOW"); %>&nbsp;&nbsp;
...
<tr>
 <td>
 <font size=2><b><% multilang("334" "LANG_SOURCE"); %> <% multilang("83" "LANG_IP_ADDRESS"); %>: </b> <input type="text" name="sip" size="10" maxlength="15">&nbsp;&nbsp;
 <b><% multilang("84" "LANG_SUBNET_MASK"); %>: </b> <input type="text" name="smask" size="10" maxlength="15">&nbsp;&nbsp;
 <b><font size=2><% multilang("187" "LANG_PORT"); %>: </b></font>
...
<tr>
 <td>
 <font size=2><b><% multilang("335" "LANG_DESTINATION"); %> <% multilang("83" "LANG_IP_ADDRESS"); %>: </b> <input type="text" name="dip" size="10" maxlength="15">&nbsp;&nbsp;
 <b><% multilang("84" "LANG_SUBNET_MASK"); %>: </b> <input type="text" name="dmask" size="10" maxlength="15">&nbsp;&nbsp;
 <b><font size=2><% multilang("187" "LANG_PORT"); %>: </b></font>
