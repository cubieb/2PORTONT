...
<body onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF"><% multilang("47" "LANG_OMCI_INFO"); %></font></h2>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr>
      <td width="40%"><font size=2><b><% multilang("59" "LANG_OMCI_VENDOR_ID"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("53" "LANG_OMCI_SW_VER1"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("54" "LANG_OMCI_SW_VER2"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("55" "LANG_OMCC_VER"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("56" "LANG_OMCI_TM_OPT"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("57" "LANG_OMCI_EQID"); %></b></td>
...
<tr>
      <td width="40%"><font size=2><b><% multilang("58" "LANG_OMCI_ONT_VER"); %></b></td>
