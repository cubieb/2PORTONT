...
<title><% multilang("191" "LANG_WLAN_ACCESS_CONTROL"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("191" "LANG_WLAN_ACCESS_CONTROL"); %></font></h2>
<form action=/boaform/admin/formWlAc method=POST name="formWlAcAdd">
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><font size=2>
 <% multilang("192" "LANG_PAGE_DESC_WLAN_ALLOW_DENY_LIST"); %>
</font></td></tr>
...
<tr>
   <td><font size=2><b>
    <% multilang("125" "LANG_MODE"); %>: &nbsp;&nbsp;&nbsp;&nbsp;
 <select size="1" name="wlanAcEnabled" onclick="updateState()">
          <option value=0 ><% multilang("161" "LANG_DISABLED"); %></option>
          <option value=1 selected ><% multilang("193" "LANG_ALLOW_LISTED"); %></option>
          <option value=2 ><% multilang("194" "LANG_DENY_LISTED"); %></option>
        </select></font></b>
   </td>
   <td><input type="submit" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>" name="setFilterMode">&nbsp;&nbsp;</td>
</tr>
<tr>
</table>
<td>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><hr size=1 noshade align=top></td></tr>
<tr><p><font size=2><b><% multilang("86" "LANG_MAC_ADDRESS"); %>: </b><input type="text" name="mac" size="15" maxlength="12">
...
<form action=/boaform/admin/formWlAc method=POST name="formWlAcDel">
  ...
  <tr><font size=2><b><% multilang("197" "LANG_CURRENT_ACCESS_CONTROL_LIST"); %>:</b></font></tr>
  <% wlAcList(); %>
  </table>
  <br>
