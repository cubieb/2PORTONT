...
<BODY>
<blockquote>
<h2><font color="#0000FF"><% multilang("14" "LANG_ATM_SETTINGS"); %></font></h2>

<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><font size=2>
    <% multilang("280" "LANG_PAGE_DESC_ATM_SETTING"); %>
</font></td></tr>
...
<tr><td>
 ...
 <p><input type="submit" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>" name="changeAtmVc" onClick="return addClick()">&nbsp;&nbsp;
  <input type="reset" value="<% multilang("281" "LANG_UNDO"); %>" name="reset" onClick="resetClicked()">
