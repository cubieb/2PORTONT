...
function saveClick()
{
 ...
 if ( document.addressMap.addressMapType.selectedIndex == 0 ) {
  ...
  //alert('You select Many-to-One.');  		
   ...
   alert('<% multilang("1965" "LANG_LOCAL_START_IP_DOMAIN_IS_DIFFERENT_FROM_LOCAL_END_IP"); %>');
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("564" "LANG_ADDRESS_MAPPING_RULE"); %></font></h2>

<form action=/boaform/formAddressMap method=POST name="addressMap">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><font size=2>
    <% multilang("565" "LANG_THIS_PAGE_IS_USED_TO_SET_AND_CONFIGURE_THE_ADDRESS_MAPPING_RULE_FOR_YOUR_DEVICE"); %>
  </tr>
