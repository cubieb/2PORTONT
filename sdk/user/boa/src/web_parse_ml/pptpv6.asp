...
<table border=0 width="500" cellspacing=0 cellpadding=0>
  ...
  <tr>
    <td width="30%"><font size=2><b><% multilang("85" "LANG_SERVER"); %>:</b></td>
  ...
  <tr>
    <td width="30%"><font size=2></b><% multilang("175" "LANG_ENCRYPTION"); %>:</b></td>
  ...
  <tr>
    <td width="30%"><font size=2><b><% multilang("79" "LANG_DEFAULT_GATEWAY"); %>:</b></td>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
      ...
      <td><input type="submit" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>" name="addPPtP" onClick="return addPPtPItf()">&nbsp;&nbsp;</td>
  </tr>
</table>
<br><br>

<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><font size=2><b>PPTP <% multilang("275" "LANG_TABLE"); %>:</b></font></tr>
  <tr>
