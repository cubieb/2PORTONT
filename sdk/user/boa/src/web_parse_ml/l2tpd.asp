...
function checkTextStr(obj)
{
 if(obj.value.length > 30){
  alert('<% multilang("2175" "LANG_LENGTH_SHOULD_LESS_THEN_32"); %>');
  obj.focus();
  return false;
 }
 ...
 for (var i=0; i<obj.value.length; i++)
 {
  ...
  {
   alert('<% multilang("2176" "LANG_INVALID_CHARACTER_IN_TEXT_AERA"); %>');
   obj.focus();
   return false;
  }
 }
...
function addL2tpAccount()
{
 ...
 if (document.l2tp.s_name.value=="") {
  alert('<% multilang("2179" "LANG_PLEASE_ENTER_L2TP_SERVER_RULE_NAME"); %>');
 ...
 if(document.l2tp.s_tunnelAuth.checked){
  if(document.l2tp.s_authKey.value ==""){
   alert('<% multilang("2180" "LANG_PLEASE_ENTER_L2TP_TUNNEL_AUTHKEY"); %>');
 ...
 {
  alert('<% multilang("2181" "LANG_PLEASE_ENTER_L2TP_SERVER_USERNAME"); %>');
 ...
 if (document.l2tp.s_password.value=="") {
  alert('<% multilang("2182" "LANG_PLEASE_ENTER_L2TP_SERVER_PASSWORD"); %>');
...
function addL2tpClient()
{
 ...
 if (document.l2tp.c_name.value=="") {
  alert('<% multilang("2183" "LANG_PLEASE_ENTER_L2TP_CLIENT_RULE_NAME"); %>');
 ...
 if (document.l2tp.mtu.value=="") {
  alert('<% multilang("2184" "LANG_PLEASE_ENTER_L2TP_CLIENT_MTU"); %>');
...
<table border=0 width="600" cellspacing=2 cellpadding=0>
  ...
  <tr>
    ...
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("1132" "LANG_TUNNEL_AUTH"); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("1133" "LANG_PPP_AUTH"); %></font></td>
