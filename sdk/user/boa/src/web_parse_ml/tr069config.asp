...
<title>TR-069 <% multilang("212" "LANG_CONFIGURATION"); %></title>
...
function saveChanges()
{
 ...
 alert("<% multilang("2335" "LANG_ACS_URL_CANNOT_BE_EMPTY"); %>");
 ...
 if ( document.tr069.interval.value=="") {
  alert("<% multilang("2336" "LANG_PLEASE_INPUT_PERIODIC_INTERVAL_TIME_"); %>");
  document.tr069.interval.focus();
  return false;
 }
 if ( validateKey( document.tr069.interval.value ) == 0 ) {
  alert("<% multilang("2337" "LANG_INTERVAL_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  document.tr069.interval.focus();
  return false;
 }
  }
 ...
 if (checkString(document.tr069.conreqpath.value) == 0) {
  alert("<% multilang("2338" "LANG_INVALID_PATH"); %>");
  document.tr069.conreqpath.focus();
  return false;
 }
  if (document.tr069.conreqport.value=="") {
 alert("<% multilang("2339" "LANG_PLEASE_INPUT_THE_PORT_NUMBER_FOR_CONNECTION_REQUEST_"); %>");
 ...
 alert("<% multilang("2340" "LANG_INVALID_PORT_NUMBER_OF_CONNECTION_REQUEST_IT_SHOULD_BE_1_65535"); %>");
 document.tr069.conreqport.value = document.tr069.conreqport.defaultValue;
 document.tr069.conreqport.focus();
 return false;
  }
...
<body>
<blockquote>
<h2><font color="#0000FF">TR-069 <% multilang("212" "LANG_CONFIGURATION"); %></font></h2>

<form action=/boaform/formTR069Config method=POST name="tr069">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("516" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_TR_069_CPE_HERE_YOU_MAY_CHANGE_THE_SETTING_FOR_THE_ACS_S_PARAMETERS"); %>
  </font></td></tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
 <tr>
  <td width="40%" style="font-weight: bold; font-size: 14"><% multilang("525" "LANG_TR069_DAEMON"); %>:</td>
  <td width="60%"><font size=2>
  <input type="radio" name=autoexec value=1 <% checkWrite("tr069-autoexec-1"); %> ><% multilang("160" "LANG_ENABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=autoexec value=0 <% checkWrite("tr069-autoexec-0"); %> ><% multilang("161" "LANG_DISABLED"); %></font>
  </td>
 </tr>
 <tr>
  <td style="font-weight: bold; font-size: 14"><% multilang("222" "LANG_ENABLE"); %>CWMP<% multilang("528" "LANG_PARAMETER"); %>:</td>
  <td><font size=2>
  <input type="radio" name=enable_cwmp value=1 <% checkWrite("tr069-enable-cwmp-1"); %> ><% multilang("160" "LANG_ENABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=enable_cwmp value=0 <% checkWrite("tr069-enable-cwmp-0"); %> ><% multilang("161" "LANG_DISABLED"); %></font>
  </td>
 </tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
 <tr>
  <td width="30%" style="font-weight: bold; font-size: 14"><% multilang("369" "LANG_WAN_INTERFACE"); %>:</td>
  <td>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
 ...
 <tr>
  <td style="font-size: 18; font-weight: bold"><% multilang("526" "LANG_ACS"); %>:</td>
 </tr>
 <tr>
  <td width="30%"><font size=2><b><% multilang("527" "LANG_URL"); %>:</b></td>
 ...
 <tr>
  <td width="30%"><font size=2><b><% multilang("517" "LANG_PERIODIC_INFORM"); %>:</b></td>
  <td width="70%"><font size=2>
  <input type="radio" name=enable value=0 <% checkWrite("tr069-inform-0"); %> onClick="return periodicSel()"><% multilang("161" "LANG_DISABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=enable value=1 <% checkWrite("tr069-inform-1"); %> onClick="return periodicSel()"><% multilang("160" "LANG_ENABLED"); %></td>
 </tr>
 <tr>
  <td width="30%"><font size=2><b><% multilang("518" "LANG_PERIODIC_INFORM_INTERVAL"); %>:</b></td>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
 ...
 <tr>
   ...
   <% multilang("519" "LANG_CONNECTION_REQUEST"); %>:
   </td>
  </tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
 <% TR069ConPageShow("ShowAuthSelect"); %>
  ...
  <tr>
      <td width="30%"><font size=2><b><% multilang("520" "LANG_PATH"); %>:</b></td>
      <td width="70%"><input type="text" name="conreqpath" size="32" maxlength="31" value=<% getInfo("conreq-path"); %>></td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("187" "LANG_PORT"); %>:</b></td>
...
-->
 ...
 <input type="reset" value=<% multilang("281" "LANG_UNDO"); %> name="reset" onClick="resetClick()">
