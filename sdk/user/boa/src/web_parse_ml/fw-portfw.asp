...
<title><% multilang("19" "LANG_PORT_FORWARDING"); %></title>
...
function addClick()
{
 ...
 if (document.formPortFwAdd.portFwcap[0].checked)
  return true;
    ...
    if (mutli_localIPAddr[0].value=="" && mutli_localFromPort[0].value=="" &&
     ...
     alert('<% multilang("2131" "LANG_LOCAL_SETTINGS_CANNOT_BE_EMPTY"); %>');
   return false;
 }
 ...
 for(var i=0;i<mutli_localFromPort.length;i++)
 {
  ...
  if (mutli_localIPAddr[i].value!="")
  {
   ...
   {
    alert('<% multilang("2132" "LANG_INVALID_LOCAL_IP_ADDRESS"); %>');
  ...
  if ( mutli_remoteIPAddr[i].value!="" ) {
   if (!checkHostIP(mutli_remoteIPAddr[i], 0))
            {
    alert('<% multilang("2133" "LANG_INVALID_REMOTE_IP_ADDRESS"); %>');
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("19" "LANG_PORT_FORWARDING"); %></font></h2>

<table border=0 width="500" cellspacing=0 cellpadding=0>
<tr><td><font size=2>
 <% multilang("341" "LANG_PAGE_DESC_NAT_FIREWALL_FILTER_TABLE"); %>
</font></td></tr>
...
<tr><td><font size=2><b><% multilang("19" "LANG_PORT_FORWARDING"); %>:</b>
 <input type="radio" value="0" name="portFwcap" <% checkWrite("portFw-cap0"); %> onClick="updateState()"><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
 <input type="radio" value="1" name="portFwcap" <% checkWrite("portFw-cap1"); %> onClick="updateState()"><% multilang("222" "LANG_ENABLE"); %>&nbsp;&nbsp;
 <input type="submit" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>" name="apply">&nbsp;&nbsp;
</font></td></tr>
<tr><td><hr size=1 noshade align=top></td></tr>
<table border=0 width="500" cellspacing=0 cellpadding=0>
 <tr>
  <td><font size=2>
   <b><% multilang("222" "LANG_ENABLE"); %></b>
  </td>
  <td><font size=2>
   <input type="checkbox" name="fw_enable" value="1" checked>
  </td>
  <td><font size=2>
   <b><% multilang("349" "LANG_APPLICATION"); %></b>
  </td>
  <td><font size=2>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
    <tr>
  <td>
   <font size=2><b><% multilang("343" "LANG_COMMENT"); %>
  </td>
  <td>
   <font size=2><b><% multilang("350" "LANG_LOCAL_IP"); %>
  </td>
  <td>
   <font size=2><b><% multilang("351" "LANG_LOCAL_PORT_FROM"); %>
  </td>
  <td>
   <font size=2><b><% multilang("352" "LANG_LOCAL_PORT_TO"); %>
  </td>
  <td>
   <font size=2><b><% multilang("89" "LANG_PROTOCOL"); %>
  </td>
  <td <% checkWrite("rg_hidden_function"); %>>
   <font size=2><b><% multilang("353" "LANG_REMOTE_IP"); %>
  </td>
  <td>
   <font size=2><b><% multilang("354" "LANG_REMOTE_PORT_FROM"); %>
  </td>
  <td>
   <font size=2><b><% multilang("355" "LANG_REMOTE_PORT_TO"); %>
  </td>
  <td>
   <font size=2><b><% multilang("66" "LANG_INTERFACE"); %> </b><br>
  </td>
    </tr>
 ...
 <tr> <!-- 0 -->
  ...
  <td><font size=2>
   <select name="protocol[]">
    <option select value=4><% multilang("342" "LANG_BOTH"); %></option>
 ...
 <tr>
  <td>
   <input type="submit" value="<% multilang("195" "LANG_ADD"); %>" name="addPortFw" onClick="return addClick()">
...
<form action=/boaform/formPortFw method=POST name="formPortFwDel">
 <table border=0 width=500>
  <tr><font size=2><b><% multilang("347" "LANG_CURRENT_PORT_FORWARDING_TABLE"); %>:</b></font></tr>
  <% portFwList(); %>
 </table>

 <br><input type="submit" value="<% multilang("198" "LANG_DELETE_SELECTED"); %>" name="deleteSelPortFw" onClick="return deleteClick()">&nbsp;&nbsp;
     <input type="submit" value="<% multilang("199" "LANG_DELETE_ALL"); %>" name="deleteAllPortFw" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
