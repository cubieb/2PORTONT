...
<title><% multilang("1134" "LANG_WIRELESS_WAN"); %></title>
 ...
 with (document.forms[0])
 {
  ...
  if(typeof enable_opt_125 !== 'undefined' &&enable_opt_125.checked)
  {
   ...
   if (checkString(serial_num.value) == 0) {
    alert("<% multilang("1922" "LANG_INVALID_SERIAL_NUMBER"); %>");
    serial_num.focus();
    return false;
   }
  }
...
<BODY onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF"><% multilang("1134" "LANG_WIRELESS_WAN"); %></font></h2>
<form action=/boaform/admin/formWanEth method=POST name="ethwan">
<table border="0" cellspacing="4" width="800">
  <tr><td><font size=2>
    <% multilang("1135" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAPETERS_FOR_WIRELESS_WAN_OF_YOUR_ROUTER"); %>
  </font></td></tr>
