	...
	<DIV align="left" style="padding-left:20px; padding-top:5px;">
		<form id="form" action="/boaform/admin/formQosTraffictlEdit" method="post">
			...
			<table cellSpacing="1" cellPadding="0" border="0">								
				<tr><td width="150px">IP <% multilang(LANG_VERSION); %>:</td>
			...
			<table cellSpacing="1" cellPadding="0" border="0">		
			<tr>
					<td width="150px"><% multilang(LANG_DIRECTION);%>:</td>
					<td>
			...
			<table cellSpacing="1" cellPadding="0" border="0">			
				<tr>
					 <td width="150px"><% multilang(LANG_VLAN); %> ID:</td>
			...
			<table cellSpacing="1" cellPadding="0" border="0">			
				<tr>
					 <td width="150px"><% multilang(LANG_SSID); %> ID:</td>
			...
			<table cellSpacing="1" cellPadding="0" border="0">		
				<tr> 
					<td width="150px"><div id='wan_interface'  style="display:<% check_display("wan_interface"); %>" ><% multilang(LANG_INTERFACE); %>:</div></td>
				...
				<tr>
					<td width="150px"><% multilang(LANG_PROTOCOL); %>:</td>
					<td>
...
<!--							<option value="4">TCP/UDP</option> -->
			...
			<table cellSpacing="1" cellPadding="0" border="0">
				...
				<tr>
			  		<td width="150px"><% multilang(LANG_SOURCE_PREFIX_LENGTH); %>:</td>
				...
				<tr>
			  		<td width="150px"><% multilang(LANG_DESTINATION_PREFIX_LENGTH); %>:</td>
			...
			<table cellSpacing="1" cellPadding="0" border="0">
				<tr>
					<td width="150px"><% multilang(LANG_SOURCE_PORT); %>:</td>
					<td><input type="text" name="sport" size="6" style="width:80px"></td>
				</tr>
				<tr>
			  		<td width="150px"><% multilang(LANG_DESTINATION_PORT); %>:</td>
					<td><input type="text" name="dport" size="6" style="width:80px"></td>
				</tr>
				
				<tr>
					 <td width="150px"><% multilang(LANG_RATE_LIMIT); %>:</td>
