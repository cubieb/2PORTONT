...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_PORT_FORWARDING); %> - <% multilang(LANG_ADVANCED_SETTINGS); %></font></h2>

<form action=/boaform/formPFWAdvance method=POST name="portfwAdvance">
   <table border=0 width="500" cellspacing=4 cellpadding=0>
      <hr size=2 noshade align=top>
      <tr>
          <td><font size=2><b><% multilang(LANG_CATEGORY); %>: </b>
   ...
   <table border=0 width="500" cellspacing=4 cellpadding=0>
      <hr size=2 noshade align=top>
      <tr>
       <td><font size=2><b><% multilang(LANG_INTERFACE); %>:</b> 
