...
<body>
<blockquote>
<h2><font color="#0000FF">ACL <% multilang(LANG_CONFIGURATION); %></font></h2>
...
<input type="hidden" name="lan_mask" value=<% getInfo("lan-subnet"); %>>
  <tr>
      <td><font size=2><b>ACL <% multilang(LANG_CAPABILITY); %>:</b></td>
      <td><font size=2>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr>
   <td width="20%"><input type="submit" value="<% multilang(LANG_ADD); %>" name="addIP" onClick="return addClick()">&nbsp;&nbsp;</td>
  </tr>
</table>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><hr size=1 noshade align=top></td></tr>
  <tr><td><font size=2><b>ACL <% multilang(LANG_TABLE); %>:</b></font></td></tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <% showACLTable(); %>
</table>
