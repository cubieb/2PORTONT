...
<blockquote>
<h2><font color="#0000FF">DoS<% multilang(LANG_CONFIGURATION); %></font></h2>
...
<form action=/boaform/admin/formDosCfg method=POST name="DosCfg">
  ...
  <tr><td width="200" ><font size=2><b><input type="checkbox" name="dosEnabled" value="ON" onclick="dosEnabledClick()">&nbsp;&nbsp;<% multilang(LANG_ENABLE_DOS_BLOCK); %></b></font></td></tr>
  <br>
  ...
  <tr><td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="sourceIPblock"  value="ON" > <font size=2><b> <% multilang(LANG_ENABLE_SOURCE_IP_BLOCKING); %> </b></font></td>

   <td width="40%"><input type="text" name="IPblockTime" size="4" maxlength="3" value=<% getInfo("blockTime"); %> > <font size=2><b> <% multilang(LANG_BLOCK_INTERVAL); %> (<% multilang(LANG_SECONDS); %>)</b></font><br></td></tr>
