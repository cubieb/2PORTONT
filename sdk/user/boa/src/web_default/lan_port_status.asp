...
<h2><b><font color="#0000FF"><% multilang(LANG_LAN_PORT_STATUS); %></font></b></h2>
...
<table width=400 border=0>
  <tr>
    <td width=100% colspan="2" bgcolor="#008000"><font color="#FFFFFF" size=2><b><% multilang(LANG_LAN_PORT_STATUS); %></b></font></td>
  </tr>
  <% showLANPortStatus(); %>
<!--  <tr bgcolor="#EEEEEE">
