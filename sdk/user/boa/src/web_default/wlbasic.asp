...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_WLAN_BASIC_SETTINGS); %></font></h2>
...
<table border=0 width="500" cellspacing=4>
  <tr>
      <td width="100%" colspan=2><font size=2><b>
   	<input type="checkbox" name="wlanDisabled" value=<% wlanStatus(); %> 
   	 ONCLICK=updateState(document.wlanSetup)>&nbsp;&nbsp;<% multilang(LANG_DISABLE_WLAN_INTERFACE); %></b>
     </td>
  </tr>

  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_BAND); %>:</b></td>
  ...
  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_MODE); %>:</b></td>
  ...
  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_SSID); %>:</b></td>
  ...
  <table border="0" width=500>
  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_CHANNEL_WIDTH); %>:</b></td>
  ...
  <tr <% checkWrite("wlan_qtn_hidden_function"); %> >
      <td width="26%"><font size=2><b><% multilang(LANG_CONTROL_SIDEBAND); %>:</b></td>
  ...
  <table border="0" width=500>
  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_CHANNEL_NUMBER); %>:</b></td>
  ...
  <tr <% checkWrite("wlan_qtn_hidden_function"); %>>
      <td width="26%"><font size=2><b><% multilang(LANG_RADIO_POWER); %>:</b></td>
  ...
  <tr id="wl_limit_stanum" style="display:none">
      <td width="26%"><font size=2><b><% multilang(LANG_STA_NUMBER); %>:</b></td>
  ...
  <tr>
      <td width="26%"><font size=2><b><% multilang(LANG_ASSOCIATED_CLIENTS); %>:</b></td>
  ...
  <tr id="wifi_regdomain_demo" style="display:none">
      <td width="26%"><font size=2><b><% multilang(LANG_REGDOMAIN); %>:</b></td>
