...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_ACTIVE_WLAN_CLIENTS); %></font></h2>
...
<tr bgcolor=#7f7f7f><td width="25%"><font size=2><b><% multilang(LANG_MAC_ADDRESS); %></b></td>
<td width="15%"><font size=2><b><% multilang(LANG_TX_PACKETS); %></b></td>
<td width="15%"><font size=2><b><% multilang(LANG_RX_PACKETS); %></b></td>
<td width="15%"><font size=2><b><% multilang(LANG_TX_RATE_MBPS); %></b></td>
<td width="15%"><font size=2><b><% multilang(LANG_POWER_SAVING); %></b></td>
<td width="15%"><font size=2><b><% multilang(LANG_EXPIRED_TIME_SEC); %></b></td></tr>
<% wirelessClientList(); %>
</table>
