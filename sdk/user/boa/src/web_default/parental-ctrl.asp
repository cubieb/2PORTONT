...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_PARENTAL_CONTROL); %></font></h2>
...
<form action=/boaform/admin/formParentCtrl method=POST name="formParentCtrl">
	<tr>
		<td><font size=2><b><% multilang(LANG_PARENTAL_CONTROL); %>:</b></font></td>
		<td><font size=2>
...
<tr><td>
     <p><font size=2>        
        <b><% multilang(LANG_USER); %><% multilang(LANG_NAME); %>:&nbsp;&nbsp; </b> <input type="text" name="usrname" size="32" maxlength="31">&nbsp;&nbsp;
     </p>
     
	 <p><font size=2><b><% multilang(LANG_SPECIFIED_PC); %>:</b>
	 ...
	 <p><font size=2>
		<b><% multilang(LANG_IP_ADDRESS); %>: </b><input type="text" name="ipstart" size="15" maxlength="15" value= >--
		<input type="text" name="ipend" size="15" maxlength="15" value= >
	 </font></p>
     <p><font size=2>        
        <b><% multilang(LANG_MAC_ADDRESS); %>:&nbsp;&nbsp; </b> <input type="text" name="mac" size="15" maxlength="12">(ex. 00e086710502)&nbsp;&nbsp;
     </p>
  ...
  <table border='0' cellpadding="0" cellspacing="0" >
               ...
               <tr>
                  <td><font size=2><b><% multilang(LANG_CONTROLLED_DAYS); %> </b></font></td>
 ...
 <p><font size=2>        
        <b><% multilang(LANG_START_BLOCKING_TIME); %>:&nbsp;&nbsp; </b> <input type="text" name="starthr" size="2" maxlength="2"><b>:</b>
         <input type="text" name="startmin" size="2" maxlength="2">
 </p>    
 <p><font size=2>        
        <b><% multilang(LANG_END_BLOCKING_TIME); %>:&nbsp;&nbsp; </b> <input type="text" name="endhr" size="2" maxlength="2"><b>:</b>
