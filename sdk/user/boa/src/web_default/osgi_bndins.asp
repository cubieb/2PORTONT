...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_BUNDLE_INSTALLATION); %></font></h2>
 ...
 <% multilang(LANG_THIS_PAGE_ALLOWS_YOU_TO_INSTALL_NEW_BUNDLE); %>
  ...
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_INSTALL_BUNDLE_FROM_FILE); %>:</b></font></td>
    <td width="30%"><font size=2><input type="file" value="<% multilang(LANG_CHOOSE_FILE); %>" name="binary" size=24></font></td>
    <td width="20%"><font size=2><input type="submit" value="<% multilang(LANG_INSTALL); %>" name="load" onclick="return uploadClick()"></font></td>
