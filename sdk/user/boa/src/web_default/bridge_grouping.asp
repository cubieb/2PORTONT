...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(Bridge Grouping); %><% multilang(LANG_CONFIGURATION); %></font></h2>
...
<table border="0" cellpadding="0" cellspacing="0">
   <tr>
      <td width="150"><font size=2><b><% multilang(LANG_GROUPED_INTERFACES); %></b></font></td>
      <td width="100"></td>
      <td width="150"><font size=2><b><% multilang(LANG_AVAILABLE_INTERFACES); %></b></font></td>
   </tr>
   <tr>
      <td>
