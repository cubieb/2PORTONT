...
<tr>
	<td><font size=2><b>IP QoS:</b>
		<input type="radio" name=qosen value=0 onClick="return adminClick()"><% multilang(LANG_DISABLED); %>&nbsp;&nbsp;
...
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
<tr>
<th colspan=4><u><% multilang(LANG_SPECIFY_TRAFFIC_CLASSIFICATION_RULES); %></u></th>
</tr>
<tr>
	<td colspan=4>
		<align=left><font size=2><b><% multilang(LANG_SOURCE); %> IP:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>
		<align=left><input type=text name=sip size=20 maxlength=15>
		<align=left><font size=2><b><% multilang(LANG_NETMASK); %>: </b>
		<align=left><input type=text name=smask size=20 maxlength=15>
		<align=left><font size=2><b><% multilang(LANG_PORT); %>: </b>
		<align=left><input type=text name=sport size=6 maxlength=5>
	</td>
</tr>
<tr>
	<td colspan=4><font size=2><b><% multilang(LANG_DESTINATION); %> IP: </b>
...
<tr>
	<td colspan=4><font size=2><b><% multilang(LANG_PROTOCOL); %>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>
	...
	<align=left><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <% multilang(LANG_PHYSICAL_PORT); %>:</b>
...
<tr>
<th colspan=4><u><% multilang(LANG_CLASSIFICATION_RESULTS); %></u></th>
</tr>
<tr>
	<td align=left><font size=2><b><% multilang(LANG_CLASSQUEUE); %>:</b></td>
	<td align=left>
	<% pq_egress(); %>
	</td>
