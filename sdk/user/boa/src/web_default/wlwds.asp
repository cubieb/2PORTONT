...
<body>
<blockquote>
<h2><font color="#0000FF">WDS <% multilang(LANG_SETTINGS); %></font></h2>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	...
	<tr>
	   <td><font size=2><b>
	   <input type="checkbox" name="wlanWdsEnabled" value="ON" <% checkWrite("wlanWdsEnabled"); %>  onclick="updateState()">&nbsp;&nbsp;<% multilang(LANG_ENABLE); %> WDS</b></td>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	<tr>
		<td width="10%" nowrap><font size=2><b><% multilang(LANG_MAC_ADDRESS); %>:</b></td>
		<td><input type="text" name="mac" size="15" maxlength="12"></td>
	</tr>
	<tr id="wds_txrate" <% checkWrite("wlan_qtn_hidden_function"); %>>
		<td width="10%" nowrap><font size=2><b><% multilang(LANG_DATA_RATE); %>:</b></td>
...
<% checkWrite("wl_txRate"); %>
	...
	<tr <% checkWrite("wlan_qtn_hidden_function"); %>>
		<td width="10%" nowrap><b><font size=2><% multilang(LANG_COMMENT); %>:</b></td>
