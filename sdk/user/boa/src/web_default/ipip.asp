...
<body>
<blockquote>
<h2><font color="#0000FF">IPIP VPN <% multilang(LANG_CONFIGURATION); %></font></h2>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_LOCAL); %> <% multilang(LANG_IP_ADDRESS); %>:</b></td>
    <td width="60%"><input type="text" name="local" size="20" maxlength="30"></td>
  </tr>
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_REMOTE); %> <% multilang(LANG_IP_ADDRESS); %>:</b></td>
...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  ...
  <tr>
    ...
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang(LANG_LOCAL); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang(LANG_REMOTE); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang(LANG_DEFAULT_GATEWAY); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang(LANG_ACTION); %></font></td>
  </tr>
	<% ipipList(); %>
</table>
<br>
