...
<body>
<blockquote>
<h2><font color="#0000FF">VLAN on LAN <% multilang(LANG_CONFIGURATION); %></font></h2>
...
<form action=/boaform/formVLANonLAN method=POST name="formVLANonLAN">
	<table border=0 width="500" cellspacing=0 cellpadding=0>
	<tr>
		<td><font size=2><b>LAN1 <% multilang(LANG_VLAN); %> <% multilang(LANG_ID); %>:  </b></font></td>
	...
	<tr>
		<td><font size=2><b>LAN2 <% multilang(LANG_VLAN); %> <% multilang(LANG_ID); %>:  </b></font></td>
	...
	<tr>
		<td><font size=2><b>LAN3 <% multilang(LANG_VLAN); %> <% multilang(LANG_ID); %>:  </b></font></td>
	...
	<tr>
		<td><font size=2><b>LAN4 <% multilang(LANG_VLAN); %> <% multilang(LANG_ID); %>:  </b></font></td>
