...
<body>
<blockquote>
<h2><font color="#0000FF">IP <% multilang(LANG_QOS_QUEUE); %></font></h2>
...
<table id=body_header border=0 width=600>
	<tr><td width=100% colspan=7><font size=2><b><% multilang(LANG_QUEUE_CONFIG_LIST); %></b></font></td></tr>
		...
		<tr>
			<td>
	                    <table border="0" cellpadding="0" cellspacing="0" width=100%>
	                           <tr>
                                      <td width=30%><% multilang(LANG_QUEUE_DESCRIPTION); %>&nbsp;:</td>
                                      <td width=70%><input type="text" name="queuedesc" size="16" maxlength="30" readonly>                                                     
                                      </td>
                                   </tr>
                                   
                                   <tr>
                                      <td width=30%><% multilang(LANG_QUEUE_STATUS); %>&nbsp;:</td>
                                      <td width=70%>
                                   ...
                                   <tr>
                                      <td width=30%><% multilang(LANG_QUEUE_INTERFACE); %>&nbsp;:</td>
					  ...
					  <% if_wan_list("queueITF"); %>                  
                                   ...
                                   <tr>
                                      <td width=30%><% multilang(LANG_QUEUE_PRIORITY); %>&nbsp;:</td>
                                      <td width=70%>
