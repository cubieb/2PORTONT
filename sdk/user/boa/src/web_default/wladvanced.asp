...
<blockquote>
<body>
<h2><font color="#0000FF"><% multilang(LANG_WLAN_ADVANCED_SETTINGS); %></font></h2>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
    ...
    <tr <% checkWrite("wlan_qtn_hidden_function"); %>>
      <td width="30%"><font size=2><b><% multilang(LANG_FRAGMENT_THRESHOLD); %>:</b></td>
      <td width="70%"><font size=2><input type="text" name="fragThreshold" size="10" maxlength="4" value=<% getInfo("fragThreshold"); %>>(256-2346)</td>
    </tr>
    <tr>
      <td width="30%"><font size=2><b><% multilang(LANG_RTS_THRESHOLD); %>:</b></td>
      <td width="70%"><font size=2><input type="text" name="rtsThreshold" size="10" maxlength="4" value=<% getInfo("rtsThreshold"); %>>(0-2347)</td>
    </tr>
    <tr>
      <td width="30%"><font size=2><b><% multilang(LANG_BEACON_INTERVAL); %>:</b></td>
      <td width="70%"><font size=2><input type="text" name="beaconInterval" size="10" maxlength="4" value=<% getInfo("beaconInterval"); %>> (20-1024 <% multilang(LANG_MS); %>)</td>
    </tr>

    <tr>
      <td width="30%"><font size=2><b><% multilang(LANG_DATA_RATE); %>:</b></td>
