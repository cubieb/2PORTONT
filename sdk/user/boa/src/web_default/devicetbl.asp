...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_DEVICE); %> <% multilang(LANG_IP_RANGE); %><% multilang(LANG_TABLE_2); %></font></h2>
...
<tr>
    <td width=30%><font size=2><% multilang(LANG_DEVICE); %><% multilang(LANG_NAME); %>:&nbsp;&nbsp;</td>
    <td><input type="text" name="name" size="20" maxlength="20"></td>
</tr>
    <td><font size=2><% multilang(LANG_START_ADDRESS); %>:&nbsp;&nbsp;</td>
    <td><input type="text" name="sIp" size="20" maxlength="15"></td>
</tr>
<tr>
    <td><font size=2><% multilang(LANG_END_ADDRESS); %>:&nbsp;&nbsp;</td>
    <td><input type="text" name="dIp" size="20" maxlength="15"></td>
</tr>
<tr>
    <td><font size=2><% multilang(LANG_GATEWAY_ADDRESS); %>:&nbsp;&nbsp;</td>
    <td><input type="text" name="gwIp" size="20" maxlength="15"></td>
</tr>
<tr>
    <td><font size=2><% multilang(LANG_OPTION60); %>:&nbsp;&nbsp;</td>
...
<tr>
	<td width=30%><font size=2><% multilang(LANG_DEVICE_TYPE); %>:&nbsp;&nbsp;</td>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
	 <tr>
		<td width=30%><font size=2><% multilang(LANG_RESERVED_OPTION); %>:&nbsp;&nbsp;</td>
	 ...
	 <tr>
		<td><font size=2><% multilang(LANG_OPTION_STRING); %></td>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>	
	<tr>
	 ...
	 <tr>
	 	<td><font size=2><% multilang(LANG_DNS1); %>:</td>
	 	<td><input type="text" name="stbdns1" value=<% getInfo("stb-dns1"); %>></td>
	 </tr>
	 <tr>
	 	<td><font size=2><% multilang(LANG_DNS2); %>:</td>
