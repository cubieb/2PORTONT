...
<table border=0 width="500" cellspacing=4 cellpadding=0>
		...
		<td colspan="2">	
			<table width="100%" border="0" cellpadding="0" cellspacing="4">			
				...
				<tr id="show_dotIEEE80211W" style="display:none">
					<td width="30%" class="bgblue"><font size="2"><b><% multilang(LANG_IEEE_802_11W); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_sha256" style="display:none">
					<td width="30%" class="bgblue"><font size="2"><b><% multilang(LANG_SHA256); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang(LANG_GROUP_KEY_UPDATE_TIMER); %>:</b></font></td>
	...
	<tr id="show_8021x_eap" style="display:none">
        ...
        <tr>
           ...
           <td width="100%" colspan="2"><input type=submit value="<% multilang(LANG_APPLY_CHANGES); %>" name=save onClick="return saveChanges()">&nbsp;
           </td>
        </tr>
</table>
</div>
