...
<tr><td>
     <p><font size=2>        
        <b><% multilang(LANG_MAC_ADDRESS); %> (xx-xx-xx-xx-xx-xx): </b> <input type="text" name="hostMac" size="20" maxlength="17">&nbsp;&nbsp;
     </p>
     <p><font size=2>        
        <b><% multilang(LANG_ASSIGNED_IP_ADDRESS); %> (xxx.xxx.xxx.xxx): </b> <input type="text" name="hostIp" size="20" maxlength="15">&nbsp;&nbsp;
     </p>
</td></tr>
