...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_WI_FI_PROTECTED_SETUP); %></font></h2>
...
<tr>
  <td width="40%"><font size="2"><b>WPS <% multilang(LANG_STATUS); %>:</b></font></td>  
...
<script>
  ...
  <td width="40%"><font size="2"><b>WPS <% multilang(LANG_VERSION); %>:</b></font></td>  
  <td width="60%"><font size="2">
...
<tr <% checkWrite("wlan_qtn_hidden_function"); %>>
  <td width="40%"><font size="2"><b><% multilang(LANG_AUTO_LOCK_DOWN_STATE); %>:</b></font></td>
  <td width="60%"><font size="2">  	
<script>
...
<tr>
  <td width="40%"><font size="2"><b><% multilang(LANG_SELF_PIN_NUMBER); %>:</b></font></td>
...
<tr>
  <td width="40%"><font size="2"><b>PIN <% multilang(LANG_CONFIGURATION); %>:</b></font></td> 
  <td width="60%"><font size="2">
...
<tr>
  <td width="40%"><font size="2"><b><% multilang(LANG_PUSH_BUTTON); %> <% multilang(LANG_CONFIGURATION); %>:</b></font></td> 
  <td width="60%"><font size="2">
...
<tr>
   <td width="100%" colspan="2"  height=40><input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="save" onClick="return saveChangesWPS(document.formWsc)">&nbsp;&nbsp;
...
<tr><td><font size=2><b><% multilang(LANG_CURRENT_KEY_INFO); %>:</b></td></tr>
<table border='1' width="500">
<tr bgcolor=#7f7f7f>
   <td width="30%"><font size=2><b><% multilang(LANG_AUTHENTICATION); %></b></td>
   <td width="20%"><font size=2><b><% multilang(LANG_ENCRYPTION); %></b></td>
   <td width="50%"><font size=2><b><% multilang(LANG_KEY); %></b></td>
</tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr>
  <td width="40%"><font size="2"><b><% multilang(LANG_CLIENT_PIN_NUMBER); %>:</b></font></td>
