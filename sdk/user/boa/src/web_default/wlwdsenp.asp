...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_WDS_SECURITY_SETTINGS); %> <% if (getIndex("wlan_num")>1) write("-wlan"+(checkWrite("wlan_idx")+1));
%></font></h2>
...
<table border=0 width="500" cellspacing=4>
  <tr>
      <td width="30%"><font size=2><b><% multilang(LANG_ENCRYPTION); %>:</b></font></td>
  ...
  <tr>
      <td width="30%"><font size=2><b>WEP <% multilang(LANG_KEY_FORMAT); %>:</b></font></td>
  ...
  <tr>
      <td width="30%"><font size=2><b>WEP <% multilang(LANG_KEY); %>:</b></font></td>
      <td width="70%"><font size=2>
     	<input type="text" name="wepKey<% checkWrite("wlan_idx"); %>" size="26" maxlength="26">
      </font></td>
  </tr>
  <tr>
      <td width="30%"><font size="2"><b><% multilang(LANG_PRE_SHARED_KEY_FORMAT); %>:</b></font></td>
      <td width="70%"><font size="2"><select size="1" name="pskFormat<% checkWrite("wlan_idx"); %>">
          <% checkWrite("wdsPskFormat"); %>
      </select></font></td>
  </tr>
  <tr>
      <td width="30%"><font size="2"><b><% multilang(LANG_PRE_SHARED_KEY); %>:</b></font></td>
