...
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_FAST_BSS_TRANSITION_802_11R); %></font></h2>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
		...
		<tr>
			<td width="35%"><font size="2"><b><% multilang(LANG_ENCRYPTION); %>:</b></font></td>
			<td width="65%">
				<font size="2">
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	...
	<tr id="show_ft_enable">
		<td width="30%" class="bgblue">
			<font size="2"><b><% multilang(LANG_IEEE_802_11R); %>:</b></font>
		</td>
	...
	<tr id="show_ft_mdid">
		<td width="30%" bgcolor="#FFFFFF" class="bgblue">
			<font size="2"><b><% multilang(LANG_MOBILITY_DOMAIN_ID); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
	...
	<tr id="show_ft_over_ds">
		<td width="30%" class="bgblue">
			<font size="2"><b><% multilang(LANG_SUPPORT_OVER_DS); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
			<font size="2">
	...
	<tr id="show_ft_res_request" style="display:none">
		<td width="30%" class="bgblue">
			<font size="2"><b><% multilang(LANG_SUPPORT_RESOURCE_REQUEST); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
			<font size="2">
	...
	<tr id="show_ft_r0key_timeout">
		<td width="30%" bgcolor="#FFFFFF" class="bgblue">
			<font size="2"><b><% multilang(LANG_KEY_EXPIRATION_TIMEOUT); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
	...
	<tr id="show_ft_reasoc_timeout">
		<td width="30%" bgcolor="#FFFFFF" class="bgblue">
			<font size="2"><b><% multilang(LANG_REASSOCIATION_TIMEOUT); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
	...
	<tr id="show_ft_r0kh_id">
		<td width="30%" bgcolor="#FFFFFF" class="bgblue">
			<font size="2"><b><% multilang(LANG_NAS_IDENTIFIER); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
	...
	<tr id="show_ft_push">
		<td width="30%" class="bgblue">
			<font size="2"><b><% multilang(LANG_SUPPORT_KEY_PUSH); %>:</b></font>
		</td>
		<td width="70%" class="bggrey">
			<font size="2">
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	<tr>
		<td colspan="2"><font size="2"><b><% multilang(LANG_KEY_HOLDER_CONFIGURATION); %>:</b></font></td>
	</tr>
...
<table border=0 width="700">
	<tr>
		<td colspan="4"><font size=2><b><% multilang(LANG_CURRENT_KEY_HOLDER_INFORMATION); %>:</b></font></td>
	</tr>
	<% wlFtKhList(); %>
