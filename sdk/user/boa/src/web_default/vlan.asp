...
<body onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_VLAN_SETTINGS); %></font></h2>
...
<td width="10%"><font size=2><b><% multilang(LANG_AUTO); %></b></td>
...
<td colspan="2" width="90%"><font size=2><b><% multilang(LANG_MANUAL); %></b></td>
</tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr>
...
<td width="80%"><font size=2><b><% multilang(LANG_TRANSPARENT_MODE); %></b></td>
</tr>
<tr>
<td width="10%"></td>
...
<td width="80%"><font size=2><b><% multilang(LANG_TAGGING_MODE); %></b>: 
...
<td width="80%"><font size=2><b><% multilang(LANG_REMOTE_ACCESS_MODE); %></b></td>
</tr>
<tr>
<td width="10%"></td>
...
<td width="80%"><font size=2><b><% multilang(LANG_SPECIAL_CASE_MODE); %></b></td>
</tr>
</table>
<br>
