...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_BACKUP_AND_RESTORE_SETTINGS); %></font></h2>
 ...
 <% multilang(LANG_THIS_PAGE_ALLOWS_YOU_TO_BACKUP_CURRENT_SETTINGS_TO_A_FILE_OR_RESTORE_THE_SETTINGS_FROM_THE_FILE_WHICH_WAS_SAVED_PREVIOUSLY_BESIDES_YOU_COULD_RESET_THE_CURRENT_SETTINGS_TO_FACTORY_DEFAULT); %>
  ...
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_BACKUP_SETTINGS_TO_FILE); %>:</b></font></td>
  ...
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_BACKUP_DEFAULT_SETTINGS_TO_FILE); %>:</b></font></td>
    <td width="30%"><font size=2>
      <input type="submit" value="<% multilang(LANG_BACKUP); %>..." name="save_ds">
    </font></tr>  
  </form>  

  <form action=/boaform/formSaveConfig method=POST name="saveHSConfig">
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_BACKUP_HARDWARE_SETTINGS_TO_FILE); %>:</b></font></td>
    <td width="30%"><font size=2>
  ...
  <tr>
    <td width="40%"><font size=2><b><% multilang(LANG_RESTORE_SETTINGS_FROM_FILE); %>:</b></font></td>
    <td width="30%"><font size=2><input type="file" value="<% multilang(LANG_CHOOSE_FILE); %>" name="binary" size=24></font></td>
    <td width="20%"><font size=2><input type="submit" value="<% multilang(LANG_RESTORE); %>" name="load" onclick="return uploadClick()"></font></td>
  ...
  <tr>
    <td width="70%"><font size=2><b><% multilang(LANG_RESET_SETTINGS_TO_DEFAULT); %>:</b></font></td>
    <td width="30%"><font size=2>
    <input type="submit" value="<% multilang(LANG_RESET); %>" name="reset" onclick="return resetClick()"></font></td>
    <input type="hidden" value="/saveconf.asp" name="submit-url">
   </tr>
  </form>
</table>
