...
<body>
<blockquote>
<h2><font color="#0000FF">RIP <% multilang(LANG_CONFIGURATION); %></font></h2>
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
	<tr>
		<td><font size=2><b><% multilang(LANG_RIP); %>:</b></font></td>
		<td><font size=2>
...
<table border=0 width="500" cellspacing=0 cellpadding=0> 
	<tr>
		<td><font size=2><b><% multilang(LANG_INTERFACE); %>:</b></td>
		<td>
			<select name="rip_if">
	...
	<tr>
		<td><font size=2><b><% multilang(LANG_RECEIVE_MODE); %>:</b></td>
		<td>
	...
	<tr>
		<td><font size=2><b><% multilang(LANG_SEND_MODE); %>:</b></td>
		<td>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
	<tr><td><hr size=1 noshade align=top></td></tr>
	<tr><td><font size=2><b><% multilang(LANG_RIP_CONFIG_TABLE); %>:</b></font></td></tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
	<% showRipIf(); %>
</table>
