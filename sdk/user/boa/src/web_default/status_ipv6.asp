...
<h2><b><font color="#0000FF">IPv6 <% multilang(LANG_STATUS); %></font></b></h2>
...
<table width=400 border=0>
  ...
  <tr bgcolor="#EEEEEE">
    <td width=40%><font size=2><b><% multilang(LANG_IPV6_ADDRESS); %></b></td>
    <td width=60%><font size=2><% getInfo("ip6_global"); %></td>
  </tr>
  <tr bgcolor="#DDDDDD">
    <td width=40%><font size=2><b><% multilang(LANG_IPV6_LINK_LOCAL_ADDRESS); %></b></td>
...
<table width=400 border=0>
  <tr>
    <td width=100% colspan="2" bgcolor="#008000"><font color="#FFFFFF" size=2><b><% multilang(LANG_PREFIX_DELEGATION); %></b></font></td>
  </tr>
  <tr bgcolor="#EEEEEE">
    <td width=40%><font size=2><b><% multilang(LANG_PREFIX); %></b></td>
...
<table width=600 border=0>
 <tr>
    <td width=100% colspan=6 bgcolor="#008000"><font color="#FFFFFF" size=2><b><% multilang(LANG_WAN); %><% multilang(LANG_CONFIGURATION); %></b></font></td>
  </tr>
  <% wanip6ConfList(); %>
</table>
