...
<table cellSpacing="1" cellPadding="0" border="0">
   <tr>
	  <td width="150px"><font size=2><b><% multilang(LANG_SOURCE); %> <% multilang(LANG_IP_ADDRESS); %>:</b></td>
	  <td><input type="text" size="16" name="sip6Start" style="width:150px"> - <input type="text" size="16" name="sip6End" style="width:150px"></td>
   </tr>

   <tr>
	  <td width="150px"><font size=2><b><% multilang(LANG_SOURCE); %> <% multilang(LANG_PREFIX_LENGTH); %>:</b></td>
	  <td><input type="text" size="16" name="sip6PrefixLen" style="width:150px"></td>
   </tr>
   <tr>
	  <td width="150px"><font size=2><b><% multilang(LANG_DESTINATION); %> <% multilang(LANG_IP_ADDRESS); %>:</b></td>
	  <td><input type="text" size="16" name="dip6Start" style="width:150px"> - <input type="text" size="16" name="dip6End" style="width:150px"></td>
   </tr>
   <tr>
	  <td width="150px"><font size=2><b><% multilang(LANG_DESTINATION); %> <% multilang(LANG_PREFIX_LENGTH); %>:</b></td>
