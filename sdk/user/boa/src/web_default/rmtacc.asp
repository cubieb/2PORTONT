...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_REMOTE_ACCESS); %><% multilang(LANG_CONFIGURATION); %></font></h2>
...
<tr>
	<td width=150 align=left><font size=2><b><% multilang(LANG_SERVICE); %><% multilang(LANG_NAME); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang(LANG_LAN); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang(LANG_WAN); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang(LANG_WAN_PORT); %></b></td>
</tr>
<% rmtaccItem(); %>
</table>
<br>
