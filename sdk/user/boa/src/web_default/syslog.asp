...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_SYSTEM_LOG); %></font></h2>
<form action=/boaform/formSysLog method=POST name=formSysLog>
<table border="0" cellspacing="4" width="500">
<tr><hr size=1 noshade align=top></tr>
<tr>
	<td width="25%"><font size=2><b><% multilang(LANG_SYSTEM_LOG); %>&nbsp;:</b></td>
...
<TBODY id='sysgroup'>
<tr>
	<td><font size=2><b><% multilang(LANG_LOG_LEVEL); %>&nbsp;:</b></td>
	<td><select name='levelLog' size="1">
		<% checkWrite("syslog-log"); %>
	</select></td>
</tr>
<tr>
	<td><font size=2><b><% multilang(LANG_DISPLAY_LEVEL); %>&nbsp;:</b></td>
...
<tr>
	<td width="45%">	<input type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply" onClick="return saveClick()"></td>
</tr>
   
<tr>
	<td width="25%"><font size=2><b><% multilang(LANG_SAVE_LOG_TO_FILE); %>:</b></td>
	<td width="30%"><font size=2><input type="submit" value="<% multilang(LANG_SAVE); %>..." name="save_log"></td>
</tr>
<tr>
	<td width="25%"><font size=2><b><% multilang(LANG_CLEAR_LOG); %>:</b></td>
	<td width="30%"><font size=2><input type="submit" value="<% multilang(LANG_RESET); %>" name="clear_log"></td>
</tr>
</table>
<table border="0" cellspacing="4" width="500">
<tr><hr size=1 noshade align=top></tr>
