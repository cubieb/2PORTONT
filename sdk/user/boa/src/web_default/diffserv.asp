...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_DIFFERENTIATED_SERVICES); %></font></h2>
...
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
<tr>
	<td><font size=2><b><% multilang(LANG_DIFFERENTIATED_SERVICES); %>:</b></td>
	<td><font size=2>
...
<tr>
	<td><font size=2><b><% multilang(LANG_PHB_GROUPS); %>:</b></td>
	...
	<td><font size=2><b><% multilang(LANG_RATE_LIMIT); %>:</b></td>
	<td><font size=2><input type="text" name="htbrate" size="6" maxlength="6" value="512">Kb</td>
</tr>
<tr>
	<td><font size=2><b><% multilang(LANG_WAN_INTERFACE); %>:</b></td>
	<td><font size=2><select name="interface">
		<% if_wan_list("all"); %>
	</select></td>
	<td></td>
	<td><font size=2><b><% multilang(LANG_MIN); %>:</b> 100Kb; <b><% multilang(LANG_MAX); %></b>: <% multilang(LANG_TOTAL_BANDWIDTH_LIMIT); %> - 100Kb</td>
</tr>
<tr>
	<td><font size=2><b><% multilang(LANG_TOTAL_BANDWIDTH_LIMIT); %>:</b></td>
	<td><font size=2><input type="text" name="totalbandwidth" size="6" maxlength="6" value="1024">Kb</td>
</tr>
<tr>
	<td><font size=2><b><% multilang(LANG_MAX_DESIRED_LATENCY); %>:</b></td>
