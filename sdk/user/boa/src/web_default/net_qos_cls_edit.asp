	...
	with ( document.forms[0] )	{
		...
		if ( qostype_select_type==2 ) {
			...
			if((document.forms[0].IpProtocolType.value == 0 ) && (qostype_select_type!=1) ) {  //EtherType don'e need IPVersion
				alert("<% multilang(LANG_PLEASE_ASSIGN_IP_VERSION); %>");
				return;
			}
		}
		...
		else if(qostype_select_type ==2)
		{
			...
			if (proto.value==5) {//RTP
				...
				{
					alert("<% multilang(LANG_PROTOCOL_IS_RTP_CAN_NOT_SPECIFY_DST_PORT); %>");
					return;
				}
			}
	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px;">
			<form id="form" action="/boaform/admin/formQosRuleEdit" method="post"  name="qosrule">
				<h2><font color="#0000FF"><% multilang(LANG_ADD_QOS_CLASSIFICATION_RULES); %></font></h2>				
				...
				<table cellSpacing="1" cellPadding="0" border="0">				
				        <tr><td width="260px"><font size=2><b><% multilang(LANG_RULE); %><% multilang(LANG_NAME); %>:</b></td><td><input type="text" id="name" size="22" style="width:200px "></td></tr>					
					
					<tr><td colspan="2">&nbsp; </td></tr>
					<tr><td colspan="2"><b><% multilang(LANG_ASSIGN); %> IP <% multilang(LANG_PRECEDENCE); %>/DSCP/802.1p</b></td></tr>					
					<tr><td colspan="2">&nbsp; </td></tr>
					
					<tr><td width="160px"> <div id='vid_mark'  style="display:<% check_display("vid_mark"); %>;"><font size=2><b><% multilang(LANG_VLAN_ID); %> (1~4095): </b></div></td><td><div id='vid_mark_input'  style="display:<% check_display("vid_mark"); %>;"><input type="text" id="mvid" size="15" maxlength="4"></div></td></tr>					
			
					<tr><td width="160px"><font size=2><b><% multilang(LANG_PRECEDENCE); %>:</b></td><td><select id="prio" size="1"></select></td></tr>
					...
					<tr><td colspan="2">&nbsp; </td></tr>
					<tr><td colspan="2"><b><% multilang(LANG_SPECIFY_TRAFFIC_CLASSIFICATION_RULES); %></b></td></tr>
					<tr><td colspan="2">&nbsp; </td></tr>
				

					<table cellSpacing="1" cellPadding="0" border="0">
					<tr>
						<td><b><% multilang(LANG_IP_QOS_RULE); %>:</b></td>
					...
					<tr><div id='wan_interface'  style="display:<% check_display("wan_interface"); %>;" > <td width="260px" colspan="2"><font size=2><b><% multilang(LANG_WAN); %>:</b></td><td><select id="outif" size="1" onChange="onchange_sel1();"><% if_wan_list("queueITF"); %></select></td></div></tr>
					
	
					<div id="port_base" style="display:none;">
				       <table cellSpacing="1" cellPadding="0" border="0">
				        <tr><td colSpan="1">&nbsp; </td></tr>
					<tr><td width="260px" colspan="2"><font size=2><b><% multilang(LANG_PHYSICAL_PORT); %>:</b></td><td><select id="phypt" size="1" onChange="onchange_sel1();"></select></td></tr>
				       </table>
				</div>

				<div id='ipprotbl' style="display:none">
				<table cellSpacing="1" cellPadding="0" border="0">								
					<tr><td width="260px"><font size=2><b>IP <% multilang(LANG_VERSION); %>:</b></td>
				...
				<div id="ip_proto_base" style="display:none;">
					...
					<table cellSpacing="1" cellPadding="0" border="0">
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><td width="260px"><font size=2><b><% multilang(LANG_PROTOCOL); %>:</b></td><td><select id="proto" size="1" onChange="onChange_proto();"></select></td></tr>
					...
					<table cellSpacing="1" cellPadding="0" border="0">
						<tr><td width="260px"><font size=2><b><% multilang(LANG_SOURCE); %> IP: </b></td><td><input type="text" id="sip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><td width="160px"><font size=2><b><% multilang(LANG_SOURCE_MASK); %>: </b></td><td><input type="text" id="smsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
						<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION); %> IP: </b></td><td><input type="text" id="dip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION_MASK); %>: </b></td><td><input type="text" id="dmsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
					</table>				
					</div>
				
					<div id='ip6tbl' style="display:none">
					<table cellSpacing="1" cellPadding="0" border="0">
						<tr><td width="260px"><font size=2><b><% multilang(LANG_SOURCE); %> IP: </b></td><td><input type="text" id="sip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><td width="160px"><font size=2><b><% multilang(LANG_SOURCE_PREFIX_LENGTH); %>: </b></td><td><input type="text" id="sip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
						<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION); %> IP: </b></td><td><input type="text" id="dip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();"></td></tr>
						<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION_PREFIX_LENGTH); %>: </b></td><td><input type="text" id="dip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();"></td></tr>					
					</table>
					 </div>
					<table cellSpacing="1" cellPadding="0" border="0">
					<tr><td width="260px"><font size=2><b><% multilang(LANG_SOURCE_PORT); %>: </b></td><td><input type="text" id="spts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:<input type="text" id="spte" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();"></td></tr>
					<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION_PORT); %>: </b></td><td><input type="text" id="dpts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:<input type="text" id="dpte" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();"></td></tr>
				...
				<div id="mac_base" style="display:none;">
					<table cellSpacing="1" cellPadding="0" border="0">
					<tr><td colSpan="1">&nbsp; </td></tr>
					<tr><td width="160px"><font size=2><b><% multilang(LANG_SOURCE); %> MAC:</b></td><td><input type="text" id="smac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();"></td></tr>
					<tr><td width="160px"><font size=2><b><% multilang(LANG_DESTINATION); %> MAC:</b></td><td><input type="text" id="dmac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();"></td></tr>
					</table>
				</div>	
				...
				<table cellSpacing="1" cellPadding="0" border="0">
                                    	<tr><td colSpan="1"><font size=2><b><% multilang(LANG_DHCP_OPTIONS); %>:</b></font> </td>
...
<div id="dhcp_opt_base_opt61" style="display:none;">                                  
	<table cellSpacing="1" cellPadding="0" border="0">
	<font size=2><% multilang(LANG_DHCP_OPTIONS_61); %>:</td>
...
<div id="dhcp_opt_base_opt125" style="display:none;">                                  
	<table cellSpacing="1" cellPadding="0" border="0">
    <font size=2><% multilang(LANG_DHCP_OPTIONS_125); %>:</td>
</tr>
...
<p>
				<div id="configuration_2" style="display:none;">
					<table cellSpacing="1" cellPadding="0" border="0">
					<tr><td colSpan="2">&nbsp; </td></tr>
					<tr><td colSpan="2"><font size=2><b><% multilang(LANG_CONFIGURATION); %> - 2</b></td></tr>
