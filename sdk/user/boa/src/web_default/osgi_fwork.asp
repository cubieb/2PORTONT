...
<table width=400 border=0>
  <tr>
    <td width=100% colspan="2" bgcolor="#008000"><font color="#FFFFFF" size=2><b><% multilang(LANG_OSGI_FRAMEWORK_INFORMATION); %></b></font></td>
  </tr>
  <tr bgcolor="#EEEEEE">
    <td width=40%><font size=2><b><% multilang(LANG_FRAMEWORK_NAME); %></b></td>
    <td width=60%><font size=2><% getOSGIInfo("fwname"); %></td>
  </tr>
  <tr bgcolor="#EEEEEE">
    <td width=40%><font size=2><b><% multilang(LANG_FRAMEWORK_VERSION); %></b></td>
    <td width=60%><font size=2><% getOSGIInfo("fwver"); %></td>
  </tr>
   <tr bgcolor="#EEEEEE">
    <td width=40%><font size=2><b><% multilang(LANG_FRAMEWORK_STATUS); %></b></td>
