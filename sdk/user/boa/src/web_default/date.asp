...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang(LANG_SYSTEM_DATE_AND_TIME_MODIFICATION); %></font></h2>
...
<table border='1' width="80%">
  <tr>
      <td width=30%><font size=2><b><% multilang(LANG_DATE); %>:</b></td>
      <td width=70%>
  ...
  <tr>
      <td width=30%><font size=2><b><% multilang(LANG_TIME); %>:</b></td>
      <td width=70%>
  ...
  <tr>
      <td width=30%><font size=2><b><% multilang(LANG_TIME_ZONE); %>:</b></td>
      <td width=70%>
      	<select name="sys_tz">
