...
static LZSS_TYPE		match_position, match_length;  /* of longest match.  These are
			set by the InsertNode() procedure. */
//LZSS_TYPE		lson[N + 1], rson[N + 257], dad[N + 1];  /* left & right children &
static LZSS_TYPE		*lson, *rson, *dad;  /* left & right children &
