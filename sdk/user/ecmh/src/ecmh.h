...
***************************************
 $Author: masonyu $
 $Id: ecmh.h,v 1.4 2011/06/17 11:53:29 masonyu Exp $
 $Date: 2011/06/17 11:53:29 $
**************************************/
...
#define __IPV6_ADDR_SCOPE_RESERVED	0x0

#define IN6_IS_ADDR_MC_RESERVED(a)                                     \
        (IN6_IS_ADDR_MULTICAST(a) &&                                    \
          ((((__const uint8_t *) (a))[1] & 0xf) == __IPV6_ADDR_SCOPE_RESERVED))
...
struct conf
{
	...
	char			*downstream;		/* Downstream interface */   // Mason Yu. MLD Proxy
