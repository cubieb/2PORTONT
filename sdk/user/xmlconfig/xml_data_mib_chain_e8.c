...
XML_ENTRY_PRIMITIVE2("svtype", svtype, atmvc, "%hhu", (atmvc+atmvc_Idx)->svtype, 0);   //BYTE_T
...
XML_ENTRY_PRIMITIVE2("br_route_flag", br_route_flag, atmvc, "%hhu", (atmvc+atmvc_Idx)->br_route_flag, 0);   //BYTE_T
#endif
#ifdef CONFIG_IPV6
...
XML_ENTRY_PRIMITIVE2("IPv6PrefixOrigin", IPv6PrefixOrigin, atmvc, "%hhu", (atmvc+atmvc_Idx)->IPv6PrefixOrigin, 0);   //BYTE_T
XML_ENTRY_ADDR6("Ipv6Prefix", Ipv6Prefix, atmvc, (atmvc+atmvc_Idx)->Ipv6Prefix, 0);   //IA6_T
XML_ENTRY_PRIMITIVE2("Ipv6AddrPrefixLen", Ipv6AddrPrefixLen, atmvc, "%hhu", (atmvc+atmvc_Idx)->Ipv6AddrPrefixLen, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("IPv6PrefixPltime", IPv6PrefixPltime, atmvc, "%u", (atmvc+atmvc_Idx)->IPv6PrefixPltime, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("IPv6PrefixVltime", IPv6PrefixVltime, atmvc, "%u", (atmvc+atmvc_Idx)->IPv6PrefixVltime, 0);   //DWORD_T
XML_ENTRY_STRING2("IPv6DomainName", IPv6DomainName, atmvc, (atmvc+atmvc_Idx)->IPv6DomainName, 0);   //STRING_T
...
XML_ENTRY_STRING2("Ipv6AddrAlias", Ipv6AddrAlias, atmvc, (atmvc+atmvc_Idx)->Ipv6AddrAlias, 0);   //STRING_T
XML_ENTRY_STRING2("Ipv6PrefixAlias", Ipv6PrefixAlias, atmvc, (atmvc+atmvc_Idx)->Ipv6PrefixAlias, 0);   //STRING_T
...
XML_ENTRY_PRIMITIVE2("CheckBR", check_br_pm, atmvc, "%d", (atmvc+atmvc_Idx)->check_br_pm, 0);   //INTEGER_T
#endif
#if defined(CONFIG_GPON_FEATURE)
XML_ENTRY_PRIMITIVE2("Sid", sid, atmvc, "%hhu", (atmvc+atmvc_Idx)->sid, 0);	 //BYTE_T
#endif
#ifdef _PRMT_X_CT_COM_DHCP_
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_enable", dhcpv6_opt16_enable, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_enable, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_type", dhcpv6_opt16_type, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_type, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_value_mode", dhcpv6_opt16_value_mode, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_value_mode, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_value1", dhcpv6_opt16_value1, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_value[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_value2", dhcpv6_opt16_value2, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_value[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_value3", dhcpv6_opt16_value3, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_value[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt16_value4", dhcpv6_opt16_value4, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt16_value[3], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_enable", dhcpv6_opt17_enable, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_enable, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_type", dhcpv6_opt17_type, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_type, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_sub_code", dhcpv6_opt17_sub_code, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_sub_code, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_sub_data1", dhcpv6_opt17_sub_data1, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_sub_data[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_sub_data2", dhcpv6_opt17_sub_data2, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_sub_data[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_sub_data3", dhcpv6_opt17_sub_data3, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_sub_data[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_sub_data4", dhcpv6_opt17_sub_data4, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_sub_data[3], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_value1", dhcpv6_opt17_value1, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_value[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_value2", dhcpv6_opt17_value2, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_value[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_value3", dhcpv6_opt17_value3, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_value[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcpv6_opt17_value4", dhcpv6_opt17_value4, atmvc, (atmvc+atmvc_Idx)->dhcpv6_opt17_value[3], 0); //BYTE_ARRAY_T

XML_ENTRY_BYTE_ARRAY("dhcp_opt60_enable", dhcp_opt60_enable, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_enable, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_type", dhcp_opt60_type, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_type, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_value_mode", dhcp_opt60_value_mode, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_value_mode, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_value1", dhcp_opt60_value1, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_value[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_value2", dhcp_opt60_value2, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_value[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_value3", dhcp_opt60_value3, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_value[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt60_value4", dhcp_opt60_value4, atmvc, (atmvc+atmvc_Idx)->dhcp_opt60_value[3], 0); //BYTE_ARRAY_T

XML_ENTRY_BYTE_ARRAY("dhcp_opt125_enable", dhcp_opt125_enable, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_enable, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_type", dhcp_opt125_type, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_type, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_sub_code", dhcp_opt125_sub_code, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_sub_code, 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_sub_data1", dhcp_opt125_sub_data1, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_sub_data[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_sub_data2", dhcp_opt125_sub_data2, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_sub_data[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_sub_data3", dhcp_opt125_sub_data3, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_sub_data[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_sub_data4", dhcp_opt125_sub_data4, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_sub_data[3], 0); //BYTE_ARRAY_T

XML_ENTRY_BYTE_ARRAY("dhcp_opt125_value1", dhcp_opt125_value1, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_value[0], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_value2", dhcp_opt125_value2, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_value[1], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_value3", dhcp_opt125_value3, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_value[2], 0); //BYTE_ARRAY_T
XML_ENTRY_BYTE_ARRAY("dhcp_opt125_value4", dhcp_opt125_value4, atmvc, (atmvc+atmvc_Idx)->dhcp_opt125_value[3], 0); //BYTE_ARRAY_T
#endif

#if 0//de CONFIG_USER_DHCP_OPT_GUI_60
...
XML_ENTRY_PRIMITIVE2("dslite_aftr_mode", dslite_aftr_mode, atmvc, "%hhu", (atmvc+atmvc_Idx)->dslite_aftr_mode, 0);	 //BYTE_T
...
XML_ENTRY_STRING2("Name", name, ipportfilter, (ipportfilter+ipportfilter_Idx)->name, 0);   //STRING_T
XML_ENTRY_ADDR("SrcIP2", srcIp2, ipportfilter, (ipportfilter+ipportfilter_Idx)->srcIp2, 0);   //IA_T
XML_ENTRY_ADDR("DstIP2", dstIp2, ipportfilter, (ipportfilter+ipportfilter_Idx)->dstIp2, 0);   //IA_T
#ifdef CONFIG_IPV6
XML_ENTRY_PRIMITIVE2("IpProtocol", IpProtocol, ipportfilter, "%hhu", (ipportfilter+ipportfilter_Idx)->IpProtocol, 0); //BYTE_T
XML_ENTRY_ADDR6("Sip6Start", sip6Start, ipportfilter, (ipportfilter+ipportfilter_Idx)->sip6Start, 0);   //IA6_T
XML_ENTRY_ADDR6("Sip6End", sip6End, ipportfilter, (ipportfilter+ipportfilter_Idx)->sip6End, 0);   //IA6_T
XML_ENTRY_ADDR6("Dip6Start", dip6Start, ipportfilter, (ipportfilter+ipportfilter_Idx)->dip6Start, 0);   //IA6_T
XML_ENTRY_ADDR6("Dip6End", dip6End, ipportfilter, (ipportfilter+ipportfilter_Idx)->dip6End, 0);   //IA6_T
XML_ENTRY_PRIMITIVE2("Sip6PrefixLen", sip6PrefixLen, ipportfilter, "%hhu", (ipportfilter+ipportfilter_Idx)->sip6PrefixLen, 0); //BYTE_T
XML_ENTRY_PRIMITIVE2("Dip6PrefixLen", dip6PrefixLen, ipportfilter, "%hhu", (ipportfilter+ipportfilter_Idx)->dip6PrefixLen, 0); //BYTE_T
#endif
...
MIB_VIRTUAL_SVR_T _mmvtlsvr[VIRTUAL_SERVER_RULES];
MIB_VIRTUAL_SVR_Tp mvtlsvr = _mmvtlsvr;
XML_DIR_ARRAY("MIB_VIRTUAL_SVR_TBL", mvtlsvr, root, mvtlsvr_Idx, VIRTUAL_SERVER_RULES, MIB_VIRTUAL_SVR_TBL);
XML_ENTRY_ADDR("serverIp", serverIp, mvtlsvr, (mvtlsvr+mvtlsvr_Idx)->serverIp, 0);   //IA_T
...
XML_ENTRY_PRIMITIVE2("lanPort", lanPort, mvtlsvr, "%hu", (mvtlsvr+mvtlsvr_Idx)->lanPort, 0);   //WORD_T
XML_ENTRY_PRIMITIVE2("protoType", protoType, mvtlsvr, "%hhu",(mvtlsvr+mvtlsvr_Idx)->protoType, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("InstanceNum", InstanceNum, mvtlsvr, "%u", (mvtlsvr+mvtlsvr_Idx)->InstanceNum, 0);   //DWORD_T
...
/* CHAIN WIFI_TIMER_EX_TBL*/
static int wltimer_ex_Idx=0;
MIB_CE_WIFI_TIMER_EX_T _wltimer_ex[MAX_WIFI_TIMER_EX_NUM];
MIB_CE_WIFI_TIMER_EX_Tp wltimer_ex = _wltimer_ex;
XML_DIR_ARRAY("WIFI_TIMER_EX_TBL", wltimer_ex, root, wltimer_ex_Idx, MAX_WIFI_TIMER_EX_NUM, MIB_WIFI_TIMER_EX_TBL);
XML_ENTRY_PRIMITIVE2("enable", enable, wltimer_ex, "%hhu", (wltimer_ex+wltimer_ex_Idx)->enable, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("onoff", onoff, wltimer_ex, "%hhu", (wltimer_ex+wltimer_ex_Idx)->onoff, 0);   //BYTE_T
XML_ENTRY_STRING2("Time", Time, wltimer_ex, (wltimer_ex+wltimer_ex_Idx)->Time, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("day", day, wltimer_ex, "%hhu", (wltimer_ex+wltimer_ex_Idx)->day, 0);   //BYTE_T
/* CHAIN WIFI_TIMER_EX_TBL END*/
/* CHAIN WIFI_TIMER_TBL*/
static int wltimer_Idx=0;
MIB_CE_WIFI_TIMER_T _wltimer[MAX_WIFI_TIMER_NUM];
MIB_CE_WIFI_TIMER_Tp wltimer = _wltimer;
XML_DIR_ARRAY("WIFI_TIMER_TBL", wltimer, root, wltimer_Idx, MAX_WIFI_TIMER_NUM, MIB_WIFI_TIMER_TBL);
XML_ENTRY_STRING2("startTime", startTime, wltimer, (wltimer+wltimer_Idx)->startTime, 0);   //STRING_T
XML_ENTRY_STRING2("endTime", endTime, wltimer, (wltimer+wltimer_Idx)->endTime, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("controlCycle", controlCycle, wltimer, "%hhu", (wltimer+wltimer_Idx)->controlCycle, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("enable", enable, wltimer, "%hhu", (wltimer+wltimer_Idx)->enable, 0);   //BYTE_T
/* CHAIN WIFI_TIMER_TBL END*/
#endif
#endif
...
XML_ENTRY_PRIMITIVE2("modeTr69", modeTr69, ipqos, "%hhu", (ipqos+ipqos_Idx)->modeTr69, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("minphyPort", minphyPort, ipqos, "%hhu", (ipqos+ipqos_Idx)->minphyPort, 0);   //BYTE_T
XML_ENTRY_BYTE_ARRAY("cttypemap", cttypemap, ipqos, (ipqos+ipqos_Idx)->cttypemap, 0);   //STRING_T
#endif
...
#endif
#if 0//def CONFIG_BRIDGE_EBT_DHCP_OPT
...
XML_ENTRY_PRIMITIVE2("smb", smb, acc, "%hhu", (acc+acc_Idx)->smb, 0);   //BYTE_T
...
MIB_CE_URL_FQDN_T _urlfqdn[100];
MIB_CE_URL_FQDN_Tp urlfqdn=_urlfqdn;
XML_DIR_ARRAY("URL_FQDN_TBL", urlfqdn, root, urlfqdn_Idx, 100, MIB_URL_FQDN_TBL);
XML_ENTRY_STRING2("fqdn", fqdn, urlfqdn, (urlfqdn+urlfqdn_Idx)->fqdn, 0);   //STRING_T
XML_ENTRY_STRING2("URL", url, urlfqdn, (urlfqdn+urlfqdn_Idx)->url, 0);   //STRING_T
XML_ENTRY_STRING2("KEY", key, urlfqdn, (urlfqdn+urlfqdn_Idx)->key, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("port", port, urlfqdn, "%hu", (urlfqdn+urlfqdn_Idx)->port, 0);   //WORD_T
...
static int cwmp_ct_alarm_Idx=0;
CWMP_CT_ALARM_T _cwmp_ct_alarm[MAX_CT_ALARM_MONITOR];
CWMP_CT_ALARM_Tp cwmp_ct_alarm=_cwmp_ct_alarm;
XML_DIR_ARRAY("CWMP_CT_ALARM_TBL", cwmp_ct_alarm, root, cwmp_ct_alarm_Idx, MAX_CT_ALARM_MONITOR, CWMP_CT_ALARM_TBL);
XML_ENTRY_STRING2("para", para, cwmp_ct_alarm, (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->para, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("alarmNumber", alarmNumber, cwmp_ct_alarm, "%u", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->alarmNumber, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("period", period, cwmp_ct_alarm, "%u", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->period, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("mode", mode, cwmp_ct_alarm, "%u", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->mode, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("limitMin", limitMin, cwmp_ct_alarm, "%d", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->limitMin, 0);   //INTEGER_T
XML_ENTRY_PRIMITIVE2("limitMax", limitMax, cwmp_ct_alarm, "%d", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->limitMax, 0);   //INTEGER_T
XML_ENTRY_PRIMITIVE2("InstanceNum", InstanceNum, cwmp_ct_alarm, "%u", (cwmp_ct_alarm+cwmp_ct_alarm_Idx)->InstanceNum, 0);   //DWORD_T



static int cwmp_ct_monitor_Idx=0;
CWMP_CT_MONITOR_T _cwmp_ct_monitor[MAX_CT_ALARM_MONITOR];
CWMP_CT_MONITOR_Tp cwmp_ct_monitor=_cwmp_ct_monitor;
XML_DIR_ARRAY("CWMP_CT_MONITOR_TBL", cwmp_ct_monitor, root, cwmp_ct_monitor_Idx, MAX_CT_ALARM_MONITOR, CWMP_CT_MONITOR_TBL);
XML_ENTRY_STRING2("para", para, cwmp_ct_monitor, (cwmp_ct_monitor+cwmp_ct_monitor_Idx)->para, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("period", period, cwmp_ct_monitor, "%u", (cwmp_ct_monitor+cwmp_ct_monitor_Idx)->period, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("InstanceNum", InstanceNum, cwmp_ct_monitor, "%u", (cwmp_ct_monitor+cwmp_ct_monitor_Idx)->InstanceNum, 0);   //DWORD_T
#endif



#ifdef _PRMT_X_CT_COM_PING_
static int cwmp_ct_ping_Idx=0;
CWMP_CT_PING_T _cwmp_ct_ping[MAX_CT_PING];
CWMP_CT_PING_Tp cwmp_ct_ping=_cwmp_ct_ping;
XML_DIR_ARRAY("CWMP_CT_PING_TBL", cwmp_ct_ping, root, cwmp_ct_ping_Idx, MAX_CT_PING, CWMP_CT_PING_TBL);
XML_ENTRY_PRIMITIVE2("diag_state", diag_state, cwmp_ct_ping, "%hhu", (cwmp_ct_ping+cwmp_ct_ping_Idx)->diag_state, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("InstanceNum", InstanceNum, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->InstanceNum, 0);   //DWORD_T
XML_ENTRY_STRING2("interface", interface, cwmp_ct_ping, (cwmp_ct_ping+cwmp_ct_ping_Idx)->interface, 0);   //STRING_T
XML_ENTRY_STRING2("host", host, cwmp_ct_ping, (cwmp_ct_ping+cwmp_ct_ping_Idx)->host, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("repetitions", repetitions, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->repetitions, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("timeout", timeout, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->timeout, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("size", size, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->size, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("dscp", dscp, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->dscp, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("interval", interval, cwmp_ct_ping, "%u", (cwmp_ct_ping+cwmp_ct_ping_Idx)->interval, 0);   //DWORD_T
#endif
#endif /*_CWMP_MIB_*/
...
XML_ENTRY_STRING2("ifname", ifname, ddns, (ddns+ddns_Idx)->ifname, 0);   //STRING_T
...
XML_ENTRY_PRIMITIVE2("instnum", instnum, mbssid, "%hhu", (mbssid+mbssid_Idx)->instnum, 0);   //BYTE_T
#endif
...
#endif
#ifdef CTCOM_WLAN_REQ
XML_ENTRY_PRIMITIVE2("instnum", instnum, wlan1_mbssid, "%hhu", (wlan1_mbssid+wlan1_mbssid_Idx)->instnum, 0);   //BYTE_T
#endif
...
/* CHAIN MIB_REDIRECT_URL_LIST*/
static int redirecturl_Idx=0;
MIB_REDIRECT_URL_LIST_T _redirecturl[MAX_REDIRECT_URL_LIST];
MIB_REDIRECT_URL_LIST_Tp redirecturl = _redirecturl;
XML_DIR_ARRAY("REDIRECT_URL_LIST", redirecturl, root, redirecturl_Idx, MAX_REDIRECT_URL_LIST, MIB_REDIRECT_URL_LIST);
XML_ENTRY_STRING2("srcUrl", srcUrl, redirecturl, (redirecturl+redirecturl_Idx)->srcUrl, 0);   //STRING_T
XML_ENTRY_STRING2("dstUrl", dstUrl, redirecturl, (redirecturl+redirecturl_Idx)->dstUrl, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("number", number, redirecturl, "%u", (redirecturl+redirecturl_Idx)->number, 0);   //IA_T
XML_ENTRY_PRIMITIVE2("ipChanges", ipChanges, redirecturl, "%u", (redirecturl+redirecturl_Idx)->ipChanges, 0);   //IA_T
/* CHAIN MIB_REDIRECT_URL_LIST END*/
/* CHAIN MIB_REDIRECT_WHITE_LIST_T*/
static int redirectwhite_Idx=0;
MIB_REDIRECT_WHITE_LIST_T _redirectwhite[MAX_REDIRECT_WHITE_LIST];
MIB_REDIRECT_WHITE_LIST_Tp redirectwhite = _redirectwhite;
XML_DIR_ARRAY("REDIRECT_WHITE_LIST", redirectwhite, root, redirectwhite_Idx, MAX_REDIRECT_WHITE_LIST, MIB_REDIRECT_WHITE_LIST);
XML_ENTRY_STRING2("url", url, redirectwhite, (redirectwhite+redirectwhite_Idx)->url, 0);   //STRING_T
XML_ENTRY_STRING2("keyword", keyword, redirectwhite, (redirectwhite+redirectwhite_Idx)->keyword, 0);   //STRING_T
/* CHAIN MIB_REDIRECT_WHITE_LIST_T END*/
#endif
...
XML_ENTRY_PRIMITIVE2("RGWANIndex", rg_wan_idx, pptp, "%u", (pptp+pptp_Idx)->rg_wan_idx, 0);   //INTEGER_T
#endif
/* CHAIN PPTP_TBL END*/
...
#endif
#ifdef CONFIG_RTK_RG_INIT
XML_ENTRY_PRIMITIVE2("RGWANIndex", rg_wan_idx, l2tp, "%u", (l2tp+l2tp_Idx)->rg_wan_idx, 0);   //INTEGER_T
...
static int bg_macfilter_Idx=0;
MIB_CE_BRGMAC_T _bg_macfilter[16];
MIB_CE_BRGMAC_Tp bg_macfilter = _bg_macfilter;
XML_DIR_ARRAY("MAC_FILTER_EBTABLES_TBL", bg_macfilter, root, bg_macfilter_Idx, 16, MIB_MAC_FILTER_EBTABLES_TBL);
XML_ENTRY_PRIMITIVE2("ProtoType", protoType, bg_macfilter, "%hhu", (bg_macfilter+bg_macfilter_Idx)->protoType, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Direction", direction, bg_macfilter, "%hhu", (bg_macfilter+bg_macfilter_Idx)->direction, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("AllPort", allPort, bg_macfilter, "%hhu", (bg_macfilter+bg_macfilter_Idx)->allPort, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("PortNum", portNum, bg_macfilter, "%hhu", (bg_macfilter+bg_macfilter_Idx)->portNum, 0);  //BYTE_T
XML_ENTRY_INT_ARRAY("IFIndex", ifIndex, bg_macfilter, (bg_macfilter+bg_macfilter_Idx)->ifIndex, 0);	 //BYTE_ARRAY_T
XML_ENTRY_STRING2("DestMac", dmac, bg_macfilter, (bg_macfilter+bg_macfilter_Idx)->dmac, 0);   //STRING_T
XML_ENTRY_STRING2("SrcMac", smac, bg_macfilter, (bg_macfilter+bg_macfilter_Idx)->smac, 0);   //STRING_T

static int rt_macfilter_Idx=0;
MIB_CE_ROUTEMAC_T _rt_macfilter[16];
MIB_CE_ROUTEMAC_Tp rt_macfilter = _rt_macfilter;
XML_DIR_ARRAY("MAC_FILTER_ROUTER_TBL", rt_macfilter, root, rt_macfilter_Idx, 16, MIB_MAC_FILTER_ROUTER_TBL);
XML_ENTRY_STRING2("Mac", mac, rt_macfilter, (rt_macfilter+rt_macfilter_Idx)->mac, 0);   //STRING_T
XML_ENTRY_STRING2("DevName", devname, rt_macfilter, (rt_macfilter+rt_macfilter_Idx)->devname, 0);   //STRING_T

#if defined(CONFIG_RTL867X_VLAN_MAPPING) || defined(CONFIG_APOLLO_ROMEDRIVER)
static int port_binding_Idx=0;
MIB_CE_PORT_BINDING_T _port_binding[10];
MIB_CE_PORT_BINDING_Tp port_binding=_port_binding;
XML_DIR_ARRAY("PORT_BINDING_TBL", port_binding, root, port_binding_Idx, 10, MIB_PORT_BINDING_TBL);
...
static int upnpdm_cfg_profile_Idx = 0;
MIB_CE_UPNPDM_CFG_PROFILE_T _upnpdm_cfg_profile[UPNPDM_MAX];
MIB_CE_UPNPDM_CFG_PROFILE_Tp upnpdm_cfg_profile = _upnpdm_cfg_profile;
XML_DIR_ARRAY("UPNPDM_CFG_PROFILE", upnpdm_cfg_profile, root, upnpdm_cfg_profile_Idx, UPNPDM_MAX, UPNPDM_CFG_PROFILE_TBL);
XML_ENTRY_PRIMITIVE2("inst_num", inst_num, upnpdm_cfg_profile, "%u", (upnpdm_cfg_profile+upnpdm_cfg_profile_Idx)->inst_num, 0);  //DWORD_T
XML_ENTRY_STRING2("rule", rule, upnpdm_cfg_profile, (upnpdm_cfg_profile+upnpdm_cfg_profile_Idx)->rule, 0);   //STRING_T
XML_ENTRY_STRING2("cfg_path", cfg_path, upnpdm_cfg_profile, (upnpdm_cfg_profile+upnpdm_cfg_profile_Idx)->cfg_path, 0);   //STRING_T
XML_ENTRY_STRING2("provisioning_code", provisioning_code, upnpdm_cfg_profile, (upnpdm_cfg_profile+upnpdm_cfg_profile_Idx)->provisioning_code, 0);   //STRING_T


static int upnpdm_cfg_temp_ap_internet_Idx = 0;
MIB_CE_UPNPDM_CFG_TEMP_AP_T _upnpdm_cfg_temp_ap_internet[UPNPDM_MAX];
MIB_CE_UPNPDM_CFG_TEMP_AP_Tp upnpdm_cfg_temp_ap_internet = _upnpdm_cfg_temp_ap_internet;
XML_DIR_ARRAY("UPNPDM_CFG_TEMP_AP_INTERNET", upnpdm_cfg_temp_ap_internet, root, upnpdm_cfg_temp_ap_internet_Idx, UPNPDM_MAX, UPNPDM_CFG_TEMP_AP_INTERNET_TBL);
XML_ENTRY_PRIMITIVE2("inst_num", inst_num, upnpdm_cfg_temp_ap_internet, "%u", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->inst_num, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Enable", Enable, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->Enable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Channel", Channel, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->Channel, 0);  //BYTE_T
XML_ENTRY_STRING2("SSID", SSID, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->SSID, 0);	 //STRING_T
XML_ENTRY_PRIMITIVE2("BeaconType", BeaconType, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->BeaconType, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Standard", Standard, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->Standard, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyIndex", WEPKeyIndex, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKeyIndex, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPEncryptionLevel", WEPEncryptionLevel, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPEncryptionLevel, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("BasicAuthenticationMode", BasicAuthenticationMode, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->BasicAuthenticationMode, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPAEncryptionModes", WPAEncryptionModes, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WPAEncryptionModes, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("SSIDHide", SSIDHide, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->SSIDHide, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RFBand", RFBand, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->RFBand, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("VLAN", VLAN, upnpdm_cfg_temp_ap_internet, "%d", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->VLAN, 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("ChannelWidth", ChannelWidth, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->ChannelWidth, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("GuardInterval", GuardInterval, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->GuardInterval, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RetryTimeout", RetryTimeout, upnpdm_cfg_temp_ap_internet, "%u", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->RetryTimeout, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Powerlevel", Powerlevel, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->Powerlevel, 0);  //BYTE_T
//PowerValue
XML_ENTRY_PRIMITIVE2("APModuleEnable", APModuleEnable, upnpdm_cfg_temp_ap_internet, "%hhu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->APModuleEnable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPSKeyWord", WPSKeyWord, upnpdm_cfg_temp_ap_internet, "%hu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WPSKeyWord, 0);  //BYTE_T
XML_ENTRY_STRING2("MaxBitRate", MaxBitRate, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->MaxBitRate, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("MACAddressControlEnabled", MACAddressControlEnabled, upnpdm_cfg_temp_ap_internet, "%hu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->MACAddressControlEnabled, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyNumberOfEntries", WEPKeyNumberOfEntries, upnpdm_cfg_temp_ap_internet, "%hu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WEPKey1", WEPKey1, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKey1, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey2", WEPKey2, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKey2, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey3", WEPKey3, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKey3, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey4", WEPKey4, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WEPKey4, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("PreSharedKeyNumberOfEntries", PreSharedKeyNumberOfEntries, upnpdm_cfg_temp_ap_internet, "%hu", (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->PreSharedKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WPAPSK", WPAPSK, upnpdm_cfg_temp_ap_internet, (upnpdm_cfg_temp_ap_internet+upnpdm_cfg_temp_ap_internet_Idx)->WPAPSK, 0);   //STRING_T



static int upnpdm_cfg_temp_ap_iptv_Idx = 0;
MIB_CE_UPNPDM_CFG_TEMP_AP_T _upnpdm_cfg_temp_ap_iptv[UPNPDM_MAX];
MIB_CE_UPNPDM_CFG_TEMP_AP_Tp upnpdm_cfg_temp_ap_iptv = _upnpdm_cfg_temp_ap_iptv;
XML_DIR_ARRAY("UPNPDM_CFG_TEMP_AP_IPTV", upnpdm_cfg_temp_ap_iptv, root, upnpdm_cfg_temp_ap_iptv_Idx, UPNPDM_MAX, UPNPDM_CFG_TEMP_AP_IPTV_TBL);
XML_ENTRY_PRIMITIVE2("inst_num", inst_num, upnpdm_cfg_temp_ap_iptv, "%u", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->inst_num, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Enable", Enable, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->Enable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Channel", Channel, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->Channel, 0);  //BYTE_T
XML_ENTRY_STRING2("SSID", SSID, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->SSID, 0);	 //STRING_T
XML_ENTRY_PRIMITIVE2("BeaconType", BeaconType, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->BeaconType, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Standard", Standard, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->Standard, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyIndex", WEPKeyIndex, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKeyIndex, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPEncryptionLevel", WEPEncryptionLevel, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPEncryptionLevel, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("BasicAuthenticationMode", BasicAuthenticationMode, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->BasicAuthenticationMode, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPAEncryptionModes", WPAEncryptionModes, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WPAEncryptionModes, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("SSIDHide", SSIDHide, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->SSIDHide, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RFBand", RFBand, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->RFBand, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("VLAN", VLAN, upnpdm_cfg_temp_ap_iptv, "%d", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->VLAN, 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("ChannelWidth", ChannelWidth, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->ChannelWidth, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("GuardInterval", GuardInterval, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->GuardInterval, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RetryTimeout", RetryTimeout, upnpdm_cfg_temp_ap_iptv, "%u", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->RetryTimeout, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Powerlevel", Powerlevel, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->Powerlevel, 0);  //BYTE_T
//PowerValue
XML_ENTRY_PRIMITIVE2("APModuleEnable", APModuleEnable, upnpdm_cfg_temp_ap_iptv, "%hhu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->APModuleEnable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPSKeyWord", WPSKeyWord, upnpdm_cfg_temp_ap_iptv, "%hu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WPSKeyWord, 0);  //BYTE_T
XML_ENTRY_STRING2("MaxBitRate", MaxBitRate, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->MaxBitRate, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("MACAddressControlEnabled", MACAddressControlEnabled, upnpdm_cfg_temp_ap_iptv, "%hu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->MACAddressControlEnabled, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyNumberOfEntries", WEPKeyNumberOfEntries, upnpdm_cfg_temp_ap_iptv, "%hu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WEPKey1", WEPKey1, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKey1, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey2", WEPKey2, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKey2, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey3", WEPKey3, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKey3, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey4", WEPKey4, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WEPKey4, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("PreSharedKeyNumberOfEntries", PreSharedKeyNumberOfEntries, upnpdm_cfg_temp_ap_iptv, "%hu", (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->PreSharedKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WPAPSK", WPAPSK, upnpdm_cfg_temp_ap_iptv, (upnpdm_cfg_temp_ap_iptv+upnpdm_cfg_temp_ap_iptv_Idx)->WPAPSK, 0);   //STRING_T



static int upnpdm_cfg_temp_ap_voip_Idx = 0;
MIB_CE_UPNPDM_CFG_TEMP_AP_T _upnpdm_cfg_temp_ap_voip[UPNPDM_MAX];
MIB_CE_UPNPDM_CFG_TEMP_AP_Tp upnpdm_cfg_temp_ap_voip = _upnpdm_cfg_temp_ap_voip;
XML_DIR_ARRAY("UPNPDM_CFG_TEMP_AP_VOIP", upnpdm_cfg_temp_ap_voip, root, upnpdm_cfg_temp_ap_voip_Idx, UPNPDM_MAX, UPNPDM_CFG_TEMP_AP_VOIP_TBL);
XML_ENTRY_PRIMITIVE2("inst_num", inst_num, upnpdm_cfg_temp_ap_voip, "%u", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->inst_num, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Enable", Enable, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->Enable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Channel", Channel, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->Channel, 0);  //BYTE_T
XML_ENTRY_STRING2("SSID", SSID, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->SSID, 0);	 //STRING_T
XML_ENTRY_PRIMITIVE2("BeaconType", BeaconType, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->BeaconType, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("Standard", Standard, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->Standard, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyIndex", WEPKeyIndex, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKeyIndex, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPEncryptionLevel", WEPEncryptionLevel, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPEncryptionLevel, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("BasicAuthenticationMode", BasicAuthenticationMode, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->BasicAuthenticationMode, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPAEncryptionModes", WPAEncryptionModes, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WPAEncryptionModes, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("SSIDHide", SSIDHide, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->SSIDHide, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RFBand", RFBand, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->RFBand, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("VLAN", VLAN, upnpdm_cfg_temp_ap_voip, "%d", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->VLAN, 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("ChannelWidth", ChannelWidth, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->ChannelWidth, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("GuardInterval", GuardInterval, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->GuardInterval, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("RetryTimeout", RetryTimeout, upnpdm_cfg_temp_ap_voip, "%u", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->RetryTimeout, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("Powerlevel", Powerlevel, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->Powerlevel, 0);  //BYTE_T
//PowerValue
XML_ENTRY_PRIMITIVE2("APModuleEnable", APModuleEnable, upnpdm_cfg_temp_ap_voip, "%hhu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->APModuleEnable, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WPSKeyWord", WPSKeyWord, upnpdm_cfg_temp_ap_voip, "%hu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WPSKeyWord, 0);  //BYTE_T
XML_ENTRY_STRING2("MaxBitRate", MaxBitRate, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->MaxBitRate, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("MACAddressControlEnabled", MACAddressControlEnabled, upnpdm_cfg_temp_ap_voip, "%hu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->MACAddressControlEnabled, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("WEPKeyNumberOfEntries", WEPKeyNumberOfEntries, upnpdm_cfg_temp_ap_voip, "%hu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WEPKey1", WEPKey1, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKey1, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey2", WEPKey2, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKey2, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey3", WEPKey3, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKey3, 0);   //STRING_T
XML_ENTRY_STRING2("WEPKey4", WEPKey4, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WEPKey4, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("PreSharedKeyNumberOfEntries", PreSharedKeyNumberOfEntries, upnpdm_cfg_temp_ap_voip, "%hu", (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->PreSharedKeyNumberOfEntries, 0);  //BYTE_T
XML_ENTRY_STRING2("WPAPSK", WPAPSK, upnpdm_cfg_temp_ap_voip, (upnpdm_cfg_temp_ap_voip+upnpdm_cfg_temp_ap_voip_Idx)->WPAPSK, 0);   //STRING_T



static int upnpdm_file_profile_Idx = 0;
MIB_CE_UPNPDM_FILE_PROFILE_T _upnpdm_file_profile[UPNPDM_MAX];
MIB_CE_UPNPDM_FILE_TYPE_Tp upnpdm_file_profile = _upnpdm_file_profile;
XML_DIR_ARRAY("UPNPDM_FILE_PROFILE", upnpdm_file_profile, root, upnpdm_file_profile_Idx, UPNPDM_MAX, UPNPDM_FILE_PROFILE_TBL);
XML_ENTRY_PRIMITIVE2("inst_num", inst_num, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->inst_num, 0);  //DWORD_T
XML_ENTRY_STRING2("rule", rule, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->rule, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("file_type", file_type, upnpdm_file_profile, "%hhu", (upnpdm_file_profile+upnpdm_file_profile_Idx)->file_type, 0);  //BYTE_T
XML_ENTRY_STRING2("url", url, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->url, 0);   //STRING_T
XML_ENTRY_STRING2("sw_ver", sw_ver, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->sw_ver, 0);   //STRING_T
XML_ENTRY_STRING2("hw_ver", hw_ver, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->hw_ver, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("channel", channel, upnpdm_file_profile, "%d", (upnpdm_file_profile+upnpdm_file_profile_Idx)->channel, 0);  //INTEGER_T
XML_ENTRY_STRING2("username", username, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->username, 0);   //STRING_T
XML_ENTRY_STRING2("password", password, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->password, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("tw_inst_num1", tw_inst_num1, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_inst_num[0], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_inst_num2", tw_inst_num2, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_inst_num[1], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_start1", tw_start1, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_start[0], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_start2", tw_start2, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_start[1], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_end1", tw_end1, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_end[0], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_end2", tw_end2, upnpdm_file_profile, "%u", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_end[1], 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("tw_mode1", tw_mode1, upnpdm_file_profile, "%hhu", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_mode[0], 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("tw_mode2", tw_mode2, upnpdm_file_profile, "%hhu", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_mode[1], 0);  //BYTE_T
XML_ENTRY_STRING2("tw_user_msg1", tw_user_msg1, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_user_msg[0], 0);   //STRING_T
XML_ENTRY_STRING2("tw_user_msg2", tw_user_msg2, upnpdm_file_profile, (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_user_msg[1], 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("tw_max_retries1", tw_max_retries1, upnpdm_file_profile, "%d", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_max_retries[0], 0);  //INTEGER_T
XML_ENTRY_PRIMITIVE2("tw_max_retries2", tw_max_retries2, upnpdm_file_profile, "%d", (upnpdm_file_profile+upnpdm_file_profile_Idx)->tw_max_retries[1], 0);  //INTEGER_T
#endif	//CONFIG_USER_CWMP_UPNP_DM

#ifdef CONFIG_MULTI_FTPD_ACCOUNT
/* CHAIN FTP_ACCOUNT_TBL */
static int ftpAccount_Idx=0;
MIB_CE_FTP_ACCOUNT_T _ftpAccount[6];
MIB_CE_FTP_ACCOUNT_Tp ftpAccount= _ftpAccount;
XML_DIR_ARRAY("FTP_ACCOUNT_TBL", ftpAccount, root, ftpAccount_Idx, 6, MIB_FTP_ACCOUNT_TBL);
XML_ENTRY_STRING2("username", username, ftpAccount, (ftpAccount+ftpAccount_Idx)->username, 0);   //STRING_T
XML_ENTRY_STRING2("password", password, ftpAccount, (ftpAccount+ftpAccount_Idx)->password, 0);   //STRING_T
/* CHAIN FTP_ACCOUNT_TBL END*/
#endif //CONFIG_MULTI_FTPD_ACCOUNT
#ifdef CONFIG_MULTI_SMBD_ACCOUNT
/* CHAIN SMBD_ACCOUNT_TBL */
static int smbAccount_Idx=0;
MIB_CE_SMB_ACCOUNT_T _smbAccount[6];
MIB_CE_SMB_ACCOUNT_Tp smbAccount= _smbAccount;
XML_DIR_ARRAY("SMBD_ACCOUNT_TBL", smbAccount, root, smbAccount_Idx, 6, MIB_SMBD_ACCOUNT_TBL);
XML_ENTRY_STRING2("username", username, smbAccount, (smbAccount+smbAccount_Idx)->username, 0);   //STRING_T
XML_ENTRY_STRING2("password", password, smbAccount, (smbAccount+smbAccount_Idx)->password, 0);   //STRING_T
/* CHAIN SMBD_ACCOUNT_TBL END*/
#endif //CONFIG_MULTI_SMBD_ACCOUNT
#ifdef CONFIG_LED_INDICATOR_TIMER
static int led_sched_Idx=0;
MIB_CE_DAY_SCHED_T _led_sched_table[8];
MIB_CE_DAY_SCHED_Tp led_sched_table = _led_sched_table;
XML_DIR_ARRAY("LED_INDICATOR_TIMER_TBL", led_sched_table, root, led_sched_Idx, 1, MIB_LED_INDICATOR_TIMER_TBL);
XML_ENTRY_PRIMITIVE2("enable", enable, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->enable, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("ctlCycle", ctlCycle, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->ctlCycle, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("startHour", startHour, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->startHour, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("startMin", startMin, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->startMin, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("endHour", endHour, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->endHour, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("endMin", endMin, led_sched_table, "%hhu", (led_sched_table+led_sched_Idx)->endMin, 0);   //BYTE_T
#endif


#ifdef CONFIG_RG_SLEEPMODE_TIMER
static int sleepmode_sched_Idx=0;
MIB_CE_RG_SLEEPMODE_SCHED_T _sleepmode_sched_table[100];
MIB_CE_RG_SLEEPMODE_SCHED_Tp sleepmode_sched_table = _sleepmode_sched_table;
XML_DIR_ARRAY("SLEEP_MODE_SCHED_TBL", sleepmode_sched_table, root, sleepmode_sched_Idx, MAX_RG_POWERSAVE_SCHED_NUM, MIB_SLEEP_MODE_SCHED_TBL);
XML_ENTRY_PRIMITIVE2("enable", enable, sleepmode_sched_table, "%hhu", (sleepmode_sched_table+sleepmode_sched_Idx)->enable, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("onoff", ctlCycle, sleepmode_sched_table, "%hhu", (sleepmode_sched_table+sleepmode_sched_Idx)->onoff, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("hour", startHour, sleepmode_sched_table, "%hhu", (sleepmode_sched_table+sleepmode_sched_Idx)->hour, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("minute", startMin, sleepmode_sched_table, "%hhu", (sleepmode_sched_table+sleepmode_sched_Idx)->minute, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("day", endHour, sleepmode_sched_table, "%hhu", (sleepmode_sched_table+sleepmode_sched_Idx)->day, 0);   //BYTE_T
#endif


#ifdef CTC_DNS_SPEED_LIMIT
static int dns_limit_domain_Idx = 0;
MIB_CE_DNS_LIMIT_DOMAIN_T _dns_limit_domain[DNS_LIMIT_MAX];
MIB_CE_DNS_LIMIT_DOMAIN_Tp dns_limit_domain = _dns_limit_domain;
XML_DIR_ARRAY("DNS_LIMIT_DOMAIN", dns_limit_domain, root, dns_limit_domain_Idx, DNS_LIMIT_MAX, DNS_LIMIT_DOMAIN_TBL);
XML_ENTRY_STRING2("domain", domain, dns_limit_domain, (dns_limit_domain+dns_limit_domain_Idx)->domain, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("limit", limit, dns_limit_domain, "%u", (dns_limit_domain+dns_limit_domain_Idx)->limit, 0);  //DWORD_T

static int dns_limit_dev_info_Idx = 0;
MIB_CE_DNS_LIMIT_DEV_INFO_T _dns_limit_dev_info[DNS_LIMIT_MAX];
MIB_CE_DNS_LIMIT_DEV_INFO_Tp dns_limit_dev_info = _dns_limit_dev_info;
XML_DIR_ARRAY("DNS_LIMIT_DEV_INFO", dns_limit_dev_info, root, dns_limit_dev_info_Idx, DNS_LIMIT_MAX, DNS_LIMIT_DEV_INFO_TBL);
XML_ENTRY_STRING2("domain", domain, dns_limit_dev_info, (dns_limit_dev_info+dns_limit_dev_info_Idx)->domain, 0);   //STRING_T
XML_ENTRY_PRIMITIVE2("ip_ver", ip_ver, dns_limit_dev_info, "%hhu", (dns_limit_dev_info+dns_limit_dev_info_Idx)->ip_ver, 0);  //DWORD_T
XML_ENTRY_ADDR("ip_addr", ip_addr, dns_limit_dev_info, (dns_limit_dev_info+dns_limit_dev_info_Idx)->ip_addr, 0);   //IA_T
XML_ENTRY_ADDR6("ip6_addr", ip6_addr, dns_limit_dev_info, (dns_limit_dev_info+dns_limit_dev_info_Idx)->ip6_addr, 0);   //IA6_T
XML_ENTRY_BYTE6("mac", mac, dns_limit_dev_info, (dns_limit_dev_info+dns_limit_dev_info_Idx)->mac, 0);   //BYTE6_T
#endif

#ifdef SUPPORT_ACCESS_RIGHT
static int lan_host_access_right_Idx=0;
MIB_LAN_HOST_ACCESS_RIGHT_T _lan_host_access_right[16];
MIB_LAN_HOST_ACCESS_RIGHT_Tp lan_host_access_right = _lan_host_access_right;
XML_DIR_ARRAY("LAN_HOST_ACCESS_RIGHT_TBL", lan_host_access_right, root, lan_host_access_right_Idx, 16, MIB_LAN_HOST_ACCESS_RIGHT_TBL);
XML_ENTRY_BYTE6("Mac", mac, lan_host_access_right, (lan_host_access_right+lan_host_access_right_Idx)->mac, 0);   //BYTE6_T
XML_ENTRY_PRIMITIVE2("InternetAccessRight", internetAccessRight, lan_host_access_right, "%hhu", (lan_host_access_right+lan_host_access_right_Idx)->internetAccessRight, 0);  //BYTE_T
XML_ENTRY_PRIMITIVE2("StorageAccessRight", storageAccessRight, lan_host_access_right, "%hhu", (lan_host_access_right+lan_host_access_right_Idx)->storageAccessRight, 0);  //BYTE_T
#endif

#ifdef CONFIG_USER_LAN_BANDWIDTH_CONTROL
static int lan_host_bandwidth_Idx=0;
MIB_LAN_HOST_BANDWIDTH_T _lan_host_bandwidth[16];
MIB_LAN_HOST_BANDWIDTH_Tp lan_host_bandwidth = _lan_host_bandwidth;
XML_DIR_ARRAY("LAN_HOST_BANDWIDTH_TBL", lan_host_bandwidth, root, lan_host_bandwidth_Idx, 16, MIB_LAN_HOST_BANDWIDTH_TBL);
XML_ENTRY_BYTE6("Mac", mac, lan_host_bandwidth, (lan_host_bandwidth+lan_host_bandwidth_Idx)->mac, 0);   //BYTE6_T
XML_ENTRY_PRIMITIVE2("MaxUsBandwidth", maxUsBandwidth, lan_host_bandwidth, "%u", (lan_host_bandwidth+lan_host_bandwidth_Idx)->maxUsBandwidth, 0);  //DWORD_T
XML_ENTRY_PRIMITIVE2("MaxDsBandwidth", maxDsBandwidth, lan_host_bandwidth, "%u", (lan_host_bandwidth+lan_host_bandwidth_Idx)->maxDsBandwidth, 0);  //DWORD_T
#endif
...
#endif
#ifdef VIRTUAL_SERVER_SUPPORT
	{MIB_VIRTUAL_SVR_TBL, _mmvtlsvr, sizeof(MIB_VIRTUAL_SVR_T)},
#endif
...
#endif
#ifdef WIFI_TIMER_SCHEDULE
    {MIB_WIFI_TIMER_EX_TBL, _wltimer_ex, 	sizeof(MIB_CE_WIFI_TIMER_EX_T)},
    {MIB_WIFI_TIMER_TBL, 	_wltimer, 		sizeof(MIB_CE_WIFI_TIMER_T)},
#endif
#endif
...
#endif
#ifdef _PRMT_X_CT_COM_ALARM_MONITOR_
	{CWMP_CT_ALARM_TBL, _cwmp_ct_alarm, sizeof(CWMP_CT_ALARM_T)},
	{CWMP_CT_MONITOR_TBL, _cwmp_ct_monitor, sizeof(CWMP_CT_MONITOR_T)},
#endif
#ifdef _PRMT_X_CT_COM_PING_
	{CWMP_CT_PING_TBL, _cwmp_ct_ping, sizeof(CWMP_CT_PING_T)},
#endif
#endif /*_CWMP_MIB_*/
...
#endif
#ifdef SUPPORT_WEB_REDIRECT
	{MIB_REDIRECT_URL_LIST, _redirecturl, sizeof(MIB_REDIRECT_URL_LIST_T)},
	{MIB_REDIRECT_WHITE_LIST, _redirectwhite, sizeof(MIB_REDIRECT_WHITE_LIST_T)},
#endif
#ifdef WLAN_QoS
...
#endif
	{MIB_MAC_FILTER_EBTABLES_TBL, _bg_macfilter, sizeof(MIB_CE_BRGMAC_T)},
	{MIB_MAC_FILTER_ROUTER_TBL, _rt_macfilter, sizeof(MIB_CE_ROUTEMAC_T)},
#ifdef CONFIG_USER_RTK_LBD
	{MIB_LBD_VLAN_TBL, _lbd_vlan, sizeof(MIB_CE_LBD_VLAN_T)},
#endif
#ifdef CONFIG_USER_CWMP_UPNP_DM
	{UPNPDM_CFG_PROFILE_TBL, _upnpdm_cfg_profile, sizeof(MIB_CE_UPNPDM_CFG_PROFILE_T)},
	{UPNPDM_CFG_TEMP_AP_INTERNET_TBL, _upnpdm_cfg_temp_ap_internet, sizeof(MIB_CE_UPNPDM_CFG_TEMP_AP_T)},
	{UPNPDM_CFG_TEMP_AP_IPTV_TBL, _upnpdm_cfg_temp_ap_iptv, sizeof(MIB_CE_UPNPDM_CFG_TEMP_AP_T)},
	{UPNPDM_CFG_TEMP_AP_VOIP_TBL, _upnpdm_cfg_temp_ap_voip, sizeof(MIB_CE_UPNPDM_CFG_TEMP_AP_T)},
	{UPNPDM_FILE_PROFILE_TBL, _upnpdm_file_profile, sizeof(MIB_CE_UPNPDM_FILE_PROFILE_T)},
#endif
#ifdef CONFIG_MULTI_FTPD_ACCOUNT
	{MIB_FTP_ACCOUNT_TBL, _ftpAccount, sizeof(MIB_CE_FTP_ACCOUNT_T)},
#endif
#ifdef CONFIG_MULTI_SMBD_ACCOUNT
	{MIB_SMBD_ACCOUNT_TBL, _smbAccount, sizeof(MIB_CE_SMB_ACCOUNT_T)},
#endif
#ifdef CONFIG_LED_INDICATOR_TIMER
	{MIB_LED_INDICATOR_TIMER_TBL, _led_sched_table, sizeof(MIB_CE_DAY_SCHED_T)},
#endif
#ifdef CONFIG_RG_SLEEPMODE_TIMER
	{MIB_SLEEP_MODE_SCHED_TBL, _sleepmode_sched_table, sizeof(MIB_CE_RG_SLEEPMODE_SCHED_T)},
#endif

#ifdef CTC_DNS_SPEED_LIMIT
	{DNS_LIMIT_DOMAIN_TBL, _dns_limit_domain, sizeof(MIB_CE_DNS_LIMIT_DOMAIN_T)},
	{DNS_LIMIT_DEV_INFO_TBL, _dns_limit_dev_info, sizeof(MIB_CE_DNS_LIMIT_DEV_INFO_T)},
#endif
#ifdef SUPPORT_ACCESS_RIGHT
	{MIB_LAN_HOST_ACCESS_RIGHT_TBL, _lan_host_access_right, sizeof(MIB_LAN_HOST_ACCESS_RIGHT_T)},
#endif
#ifdef CONFIG_USER_LAN_BANDWIDTH_CONTROL
	{MIB_LAN_HOST_BANDWIDTH_TBL, _lan_host_bandwidth, sizeof(MIB_LAN_HOST_BANDWIDTH_T)},
#endif
    {0}
};
