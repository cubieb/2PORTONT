...
#ifdef CONFIG_VDSL
#ifdef CONFIG_E8B
XML_ENTRY_PRIMITIVE2("OLD_DSL_MODE", oldDslMode, config_setting, "%hhu", config->oldDslMode, MIB_OLD_DSL_MODE);	//BYTE_T
#endif
...
XML_ENTRY_PRIMITIVE2("IPIP_ENABLE", ipipenable, config_setting, "%u", config->ipipenable, MIB_IPIP_ENABLE); //INTEGER_T
...
XML_ENTRY_PRIMITIVE2("NTP_IF_TYPE", ntpIfType, config_setting, "%hhu", config->ntpIfType, MIB_NTP_IF_TYPE);	//BYTE_T
XML_ENTRY_PRIMITIVE2("NTP_IF_WAN", ntpIfWan, config_setting, "%u", config->ntpIfWan, MIB_NTP_IF_WAN);	//DWORD_T
XML_ENTRY_PRIMITIVE2("NTP_INTERVAL", ntpInterval, config_setting, "%u", config->ntpInterval, MIB_NTP_INTERVAL);	//DWORD_T
#endif	// defined(TIME_ZONE)
XML_ENTRY_PRIMITIVE2("UPNP_DAEMON", upnp, config_setting, "%hhu", config->upnp, MIB_UPNP_DAEMON);	//BYTE_T
...
XML_ENTRY_PRIMITIVE2("CWMP_CT_DHCPS_CHECK_OPT_60", cwmp_CT_dhcps_opt60, config_setting, "%hhu", config->cwmp_CT_dhcps_opt60,CWMP_CT_DHCPS_CHECK_OPT_60); //BYTE_T
XML_ENTRY_PRIMITIVE2("CWMP_CT_DHCPS_SEND_OPT_125", cwmp_CT_dhcps_opt125, config_setting, "%hhu", config->cwmp_CT_dhcps_opt125,CWMP_CT_DHCPS_SEND_OPT_125); //BYTE_T
XML_ENTRY_PRIMITIVE2("CWMP_CT_DHCP6S_CHECK_OPT_16", cwmp_CT_dhcp6s_opt16, config_setting, "%hhu", config->cwmp_CT_dhcp6s_opt16,CWMP_CT_DHCP6S_CHECK_OPT_16); //BYTE_T
XML_ENTRY_PRIMITIVE2("CWMP_CT_DHCP6S_SEND_OPT_17", cwmp_CT_dhcp6s_opt17, config_setting, "%hhu", config->cwmp_CT_dhcp6s_opt17,CWMP_CT_DHCP6S_SEND_OPT_17); //BYTE_T
#endif
...
XML_ENTRY_PRIMITIVE2("CWMP_CT_ALARM_ENABLE", cwmp_CT_Alarm_Enable, config_setting, "%hhu", config->cwmp_CT_Alarm_Enable, CWMP_CT_ALARM_ENABLE); //BYTE_T
XML_ENTRY_PRIMITIVE2("CWMP_CT_MONITOR_ENABLE", cwmp_CT_Monitor_Enable, config_setting, "%hhu", config->cwmp_CT_Monitor_Enable, CWMP_CT_MONITOR_ENABLE); //BYTE_T
#endif /*_PRMT_X_CT_COM_ALARM_MONITOR_*/

#ifdef _PRMT_X_CT_COM_USERINFO_
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_STATUS", cwmp_UserInfo_Status, config_setting, "%u", config->cwmp_UserInfo_Status, CWMP_USERINFO_STATUS); //DWORD_T
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_LIMIT", cwmp_UserInfo_Limit, config_setting, "%u", config->cwmp_UserInfo_Limit, CWMP_USERINFO_LIMIT); //DWORD_T
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_TIMES", cwmp_UserInfo_Times, config_setting, "%u", config->cwmp_UserInfo_Times, CWMP_USERINFO_TIMES); //DWORD_T
XML_ENTRY_PRIMITIVE2("CWMP_REG_INFORM_STATUS", cwmp_Reg_Inform_Status, config_setting, "%hhu", config->cwmp_Reg_Inform_Status, CWMP_REG_INFORM_STATUS); //BYTE_T
#ifdef E8B_NEW_DIAGNOSE
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_RESULT", cwmp_UserInfo_Result, config_setting, "%u", config->cwmp_UserInfo_Result, CWMP_USERINFO_RESULT); //DWORD_T
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_NEED_REBOOT", cwmp_Needreboot, config_setting, "%hhu", config->cwmp_Needreboot, CWMP_USERINFO_NEED_REBOOT); //BYTE_T
XML_ENTRY_PRIMITIVE2("CWMP_USERINFO_SERV_NUM", cwmp_UserInfo_ServiceNum, config_setting, "%d", config->cwmp_UserInfo_ServiceNum, CWMP_USERINFO_SERV_NUM); //INTEGER_T
XML_ENTRY_STRING2("CWMP_USERINFO_SERV_NAME", cwmp_UserInfo_ServiceName, config_setting, config->cwmp_UserInfo_ServiceName, CWMP_USERINFO_SERV_NAME);    //STRING_T
#endif /*E8B_NEW_DIAGNOSE*/
#endif /*_PRMT_X_CT_COM_USERINFO_*/
#ifdef _PRMT_X_CT_COM_PING_
XML_ENTRY_PRIMITIVE2("CWMP_CT_PING_ENABLE", cwmp_CT_Ping_Enable, config_setting, "%hhu", config->cwmp_CT_Ping_Enable, CWMP_CT_PING_ENABLE); //BYTE_T
...
XML_ENTRY_PRIMITIVE2("CWMP_CONFIGURABLE", cwmp_configurable, config_setting, "%hhu", config->cwmp_configurable, CWMP_CONFIGURABLE); //BYTE_T
...
XML_ENTRY_PRIMITIVE2("CWMP_TR069_ENABLE",				cwmp_TR069_Enable, 				config_setting,	"%hhu",	config->cwmp_TR069_Enable,				CWMP_TR069_ENABLE);
XML_ENTRY_PRIMITIVE2("CWMP_TR069_ENABLE_OLD",			cwmp_TR069_Enable_Old, 			config_setting,	"%hhu",	config->cwmp_TR069_Enable_Old,			CWMP_TR069_ENABLE_OLD);
XML_ENTRY_STRING2("CWMP_MIDWARE_SERVER_ADDR", 		cwmp_Midware_Server_Addr,		config_setting,	config->cwmp_Midware_Server_Addr,		CWMP_MIDWARE_SERVER_ADDR);
XML_ENTRY_STRING2("CWMP_MIDWARE_SERVER_ADDR_OLD",	cwmp_Midware_Server_Addr_Old,	config_setting,	config->cwmp_Midware_Server_Addr_Old,	CWMP_MIDWARE_SERVER_ADDR_OLD);
XML_ENTRY_PRIMITIVE2("CWMP_MIDWARE_SERVER_PORT", 		cwmp_Midware_Server_Port,		config_setting,	"%u",	config->cwmp_Midware_Server_Port,		CWMP_MIDWARE_SERVER_PORT);
XML_ENTRY_PRIMITIVE2("MIDWARE_INFORM_EVENT",			mwInformEvent, 					config_setting,	"%hhu",	config->mwInformEvent, 					MIB_MIDWARE_INFORM_EVENT);
XML_ENTRY_PRIMITIVE2("MIDWARE_FLAG",					midwareFlag , 					config_setting,	"%hhu",	config->midwareFlag, 					MIB_MIDWARE_FLAG);
...
XML_ENTRY_PRIMITIVE2("MIB_CTC_ACCOUNT_ENABLE", CTCAccountEnable, config_setting, "%hhu", config->CTCAccountEnable, MIB_CTC_ACCOUNT_ENABLE); //BYTE_T
...
#endif
XML_ENTRY_PRIMITIVE2("LAN_DNSV6_MODE", lanDnsv6Mode, config_setting, "%hhu", config->lanDnsv6Mode, MIB_LAN_DNSV6_MODE); //BYTE_T
...
XML_ENTRY_STRING2("TELNET_USER", telnet_server_username, config_setting, config->telnet_server_username, MIB_TELNET_USER); //STRING_T
XML_ENTRY_STRING2("TELNET_PASSWD", telnet_server_password, config_setting, config->telnet_server_password, MIB_TELNET_PASSWD); //STRING_T
#endif /*TELNET_ACCOUNT_INDEPENDENT*/

#ifdef FTP_ACCOUNT_INDEPENDENT
XML_ENTRY_STRING2("FTP_USER", ftp_server_username, config_setting, config->ftp_server_username, MIB_FTP_USER); //STRING_T
XML_ENTRY_STRING2("FTP_PASSWD", ftp_server_password, config_setting, config->ftp_server_password, MIB_FTP_PASSWD); //STRING_T
#endif /*FTP_ACCOUNT_INDEPENDENT*/
#ifdef CONFIG_MULTI_FTPD_ACCOUNT
XML_ENTRY_PRIMITIVE2("MIB_FTP_ANONYMOUS_ACCOUNT", ftp_annoymous_enable, config_setting, "%hhu", config->ftp_annoymous_enable, MIB_FTP_ANNONYMOUS); //BYTE_T
#endif /*CONFIG_MULTI_FTPD_ACCOUNT*/
#ifdef CONFIG_MULTI_SMBD_ACCOUNT
XML_ENTRY_PRIMITIVE2("MIB_SMB_ANONYMOUS_ACCOUNT", smb_annoymous_enable, config_setting, "%hhu", config->smb_annoymous_enable, MIB_SMB_ANNONYMOUS); //BYTE_T
#endif /*CONFIG_MULTI_SMBD_ACCOUNT*/

#if defined(CONFIG_USER_IP_QOS) && defined(_PRMT_X_CT_COM_QOS_)
XML_ENTRY_STRING2("CTQOS_MODE", ctqosmode, config_setting, config->ctqosmode, CTQOS_MODE); //STRING_T
XML_ENTRY_PRIMITIVE2("QOS_ENABLE_FORCE_WEIGHT", qosEnableForceWeight, config_setting, "%hhu", config->qosEnableForceWeight, MIB_QOS_ENABLE_FORCE_WEIGHT); //BYTE_T
XML_ENTRY_PRIMITIVE2("QOS_ENABLE_DSCP_MARK", qosEnableDscpMark, config_setting, "%hhu", config->qosEnableDscpMark, MIB_QOS_ENABLE_DSCP_MARK); //BYTE_T
XML_ENTRY_PRIMITIVE2("QOS_ENABLE_1P", qosEnable1p, config_setting, "%hhu", config->qosEnable1p, MIB_QOS_ENABLE_1P); //BYTE_T
#endif /*NEW_IP_QOS_SUPPORT*/

//Magician: E8B security
XML_ENTRY_PRIMITIVE2("FW_GRADE", fwGrade, config_setting, "%hhu", config->fwGrade, MIB_FW_GRADE); //BYTE_T
XML_ENTRY_PRIMITIVE2("MAC_FILTER_EBTABLES_ENABLE", macfilter_ebtables_enable, config_setting, "%hhu", config->macfilter_ebtables_enable, MIB_MAC_FILTER_EBTABLES_ENABLE); //BYTE_T
XML_ENTRY_PRIMITIVE2("MAC_FILTER_EBTABLES_MODE", macfilter_ebtables_mode, config_setting, "%hhu", config->macfilter_ebtables_mode, MIB_MAC_FILTER_EBTABLES_MODE); //BYTE_T
XML_ENTRY_PRIMITIVE2("IP_FILTER_ONOFF", ip_filter_enable, config_setting, "%hhu", config->ip_filter_enable, MIB_IPFILTER_ON_OFF); //BYTE_T
XML_ENTRY_PRIMITIVE2("MAC_FILTER_SRC_ENABLE", macfilter_src_enable, config_setting, "%hhu", config->macfilter_src_enable, MIB_MAC_FILTER_SRC_ENABLE); //BYTE_T
#ifdef CONFIG_USER_LAN_BANDWIDTH_CONTROL
XML_ENTRY_PRIMITIVE2("LANHOST_BANDWIDTH_CONTROL_ENABLE", lanhost_bandwidth_control_enable, config_setting, "%hhu", config->lanhost_bandwidth_control_enable, MIB_LANHOST_BANDWIDTH_CONTROL_ENABLE); //BYTE_T
#endif
#ifdef CONFIG_USER_LAN_BANDWIDTH_MONITOR
XML_ENTRY_PRIMITIVE2("LANHOST_BANDWIDTH_MONITOR_ENABLE", lanhost_bandwidth_monitor_enable, config_setting, "%hhu", config->lanhost_bandwidth_monitor_enable, MIB_LANHOST_BANDWIDTH_MONITOR_ENABLE); //BYTE_T
#endif
#if defined (CONFIG_USER_LAN_BANDWIDTH_MONITOR) || defined (CONFIG_USER_LAN_BANDWIDTH_CONTROL)
XML_ENTRY_PRIMITIVE2("LANHOST_BANDWIDTH_INTERVAL", lanhost_bandwidth_interval, config_setting, "%u", config->lanhost_bandwidth_interval, MIB_LANHOST_BANDWIDTH_INTERVAL); //DWORD_T
#endif
#ifdef SUPPORT_WEB_PUSHUP
XML_ENTRY_STRING2("FIRMWARE_DOWNURL", downUrl, config_setting, config->downUrl, MIB_FIRMWARE_DOWNURL); //STRING_T
XML_ENTRY_PRIMITIVE2("UPGRADE_WEB_PUSH_TIME", upgradeWebPushTime, config_setting, "%u", config->upgradeWebPushTime, MIB_UPGRADE_WEB_PUSH_TIME); //DWORD_T
XML_ENTRY_PRIMITIVE2("UPGRADE_MODE", upgradeMode, config_setting, "%u", config->upgradeMode, MIB_UPGRADE_MODE); //DWORD_T
XML_ENTRY_PRIMITIVE2("UPGRADE_METHOD", upgradeMethod, config_setting, "%u", config->upgradeMethod, MIB_UPGRADE_METHOD); //DWORD_T
XML_ENTRY_PRIMITIVE2("UPGRADE_ID", upgradeID, config_setting, "%u", config->upgradeID, MIB_UPGRADE_ID); //DWORD_T
#endif
// End Magician

#ifdef CONFIG_LED_INDICATOR_TIMER
XML_ENTRY_PRIMITIVE2("MIB_LED_STATUS", led_status, config_setting, "%hhu", config->led_status, MIB_LED_STATUS); //BYTE_T
#endif

#ifdef _PRMT_USBRESTORE
XML_ENTRY_PRIMITIVE2("USBRESTORE", usbrestore, config_setting, "%hhu", config->usbrestore, MIB_USBRESTORE); //BYTE_T
#endif /*_PRMT_USBRESTORE*/

#ifdef CONFIG_USER_DDNS
XML_ENTRY_PRIMITIVE2("DDNS_ENABLE", ddns_enable, config_setting, "%hhu", config->ddns_enable, MIB_DDNS_ENABLE); //BYTE_T
#endif /*CONFIG_USER_DDNS*/
//XML_ENTRY_PRIMITIVE2("DHCP_PORT_FILTER", dhcpPortFilter, config_setting, "%hu", config->dhcpPortFilter, MIB_DHCP_PORT_FILTER); //WORD_T

#ifdef CONFIG_IPV6
XML_ENTRY_STRING2("IPV6_LAN_IP_ADDR", lanipv6addr, config_setting, config->lanipv6addr, MIB_IPV6_LAN_IP_ADDR); //STRING_T
XML_ENTRY_STRING2("IPV6_LAN_PREFIX", lanipv6prefix, config_setting, config->lanipv6prefix, MIB_IPV6_LAN_PREFIX); //STRING_T
XML_ENTRY_PRIMITIVE2("IPV6_LAN_PREFIX_LEN", lanipv6prefixlen, config_setting, "%hhu", config->lanipv6prefixlen, MIB_IPV6_LAN_PREFIX_LEN); //BYTE_T
#endif /*CONFIG_IPV6*/
...
#if defined(CONFIG_IPV6) && defined(CONFIG_USER_RADVD)
XML_ENTRY_PRIMITIVE2("V6_RADVD_ENABLE", V6RadvdEnable, config_setting, "%hhu", config->V6RadvdEnable, MIB_V6_RADVD_ENABLE); //BYTE_T
#endif

#ifdef CONFIG_USER_CWMP_UPNP_DM
XML_ENTRY_PRIMITIVE2("UPNPDM_RMS_CONFIG_OVER", upnpdm_RMSConfigOver, config_setting, "%hhu", config->upnpdm_RMSConfigOver, UPNPDM_RMS_CONFIG_OVER); //BYTE_T
XML_ENTRY_PRIMITIVE2("UPNPDM_CONFIG_MODE", upnpdm_ConfigMode, config_setting, "%hhu", config->upnpdm_ConfigMode, UPNPDM_CONFIG_MODE); //BYTE_T
XML_ENTRY_PRIMITIVE2("UPNPDM_RMS_SW_CONFIG_OVER", upnpdm_RMSSWConfigOver, config_setting, "%hhu", config->upnpdm_RMSSWConfigOver, UPNPDM_RMS_SW_CONFIG_OVER); //BYTE_T
#endif

#if defined(CONFIG_IPV6) &&  defined(CONFIG_USER_DHCPV6_ISC_DHCP411)
XML_ENTRY_STRING2("DHCPV6S_MIN_ADDRESS", dhcpv6s_min_address, config_setting, config->dhcpv6s_min_address, MIB_DHCPV6S_MIN_ADDRESS); //STRING_T
XML_ENTRY_STRING2("DHCPV6S_MAX_ADDRESS", dhcpv6s_max_address, config_setting, config->dhcpv6s_max_address, MIB_DHCPV6S_MAX_ADDRESS); //STRING_T
#endif

#if defined(CONFIG_IPV6)
XML_ENTRY_PRIMITIVE2("PREFIXINFO_PREFIX_MODE", prefix_info_prefix_mode, config_setting, "%hhu", config->prefix_info_prefix_mode, MIB_PREFIXINFO_PREFIX_MODE); //BYTE_T
XML_ENTRY_PRIMITIVE2("PREFIXINFO_DELEGATED_WANCONN", prefixinfo_delegated_wanconn, config_setting, "%u", config->prefixinfo_delegated_wanconn,	MIB_PREFIXINFO_DELEGATED_WANCONN); //DWORD_T
XML_ENTRY_PRIMITIVE2("DNSINFO_WANCONN", dnsinfo_wanconn, config_setting, "%u", config->dnsinfo_wanconn,	MIB_DNSINFO_WANCONN); //DWORD_T
#endif

#ifdef CTC_DNS_SPEED_LIMIT
XML_ENTRY_PRIMITIVE2("DNS_LIMIT_ACTION", dns_limit_action, config_setting, "%hhu", config->dns_limit_action, MIB_DNS_LIMIT_ACTION); //BYTE_T
#endif

#ifdef SUPPORT_WAN_BANDWIDTH_INFO
XML_ENTRY_PRIMITIVE2("WAN_BANDWIDTH_ENABLE", bandwidthEnable, config_setting, "%hhu", config->bandwidthEnable, MIB_WAN_BANDWIDTH_ENABLE); //BYTE_T
XML_ENTRY_PRIMITIVE2("WAN_BANDWIDTH_INTERVAL", bandwidthInterval, config_setting, "%u", config->bandwidthInterval, MIB_WAN_BANDWIDTH_INTERVAL); //DWORD_T
#endif

#ifdef SUPPORT_WEB_REDIRECT
XML_ENTRY_PRIMITIVE2("REDIRECT_WELCOME_ENABLE", welcomeEnable, config_setting, "%hhu", config->welcomeEnable, MIB_REDIRECT_WELCOME_ENABLE); //BYTE_T
XML_ENTRY_STRING2("REDIRECT_WELCOME_URL", welcomeUrl, config_setting, config->welcomeUrl, MIB_REDIRECT_WELCOME_URL); //STRING_T
XML_ENTRY_PRIMITIVE2("REDIRECT_WELCOME_TIME", welcomeTime, config_setting, "%u", config->welcomeTime, MIB_REDIRECT_WELCOME_TIME); //DWORD_T
XML_ENTRY_ADDR("REDIRECT_IP", redirectIP, config_setting, config->redirectIP, MIB_REDIRECT_IP);	//IA_T
XML_ENTRY_ADDR("ITMS_ADDR", itmsAddr, config_setting, config->itmsAddr, MIB_ITMS_ADDR);	//IA_T
#endif
#endif
