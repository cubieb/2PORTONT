/* $Header: /usr/local/dslrepos/uClinux-dist/user/tcsh/mi.termios.c,v 1.1.1.1 2003/08/18 05:40:15 kaohj Exp $ */
/* termios.c - fake termios interface using sgtty interface 
 * 	       by Magnus Doell and Bruce Evans.
 *
 */
#include "sh.h"
RCSID("$Id: mi.termios.c,v 1.1.1.1 2003/08/18 05:40:15 kaohj Exp $")
