...
/* $Id: mkfs.jffs2.c,v 1.1.1.1 2003/08/18 05:41:22 kaohj Exp $ */
...
extern int rtime_compress(unsigned char *data_in, unsigned char *cpage_out, uint32_t *sourcelen, uint32_t *dstlen);
