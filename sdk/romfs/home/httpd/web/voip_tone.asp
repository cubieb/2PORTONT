...
<b><% multilang("950" "LANG_SELECT_COUNTRY"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=400>

   <tr>
     <td bgColor=#aaddff><% multilang("951" "LANG_COUNTRY"); %></td>
  <td bgColor=#ddeeff>
...
<table cellSpacing=1 cellPadding=2 border=0 width=400>
 ...
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Country" value="<% multilang("279" "LANG_APPLY"); %>" >
    </td>
 </tr>
</table>

<b><% multilang("952" "LANG_SELECT_CUSTOM_TONE"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=400>
   <tr>
     <td bgColor=#aaddff width=155><% multilang("953" "LANG_CUSTOM_TONE"); %></td>
     <td bgColor=#ddeeff width=170>
...
<p>
<b><% multilang("954" "LANG_TONE_PARAMETERS"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=400>
 <tr>
 <td bgColor=#aaddff><% multilang("955" "LANG_TONETYPE"); %></td>
 <td bgColor=#ddeeff>
 ...
 <tr>
  ...
  <td bgColor=#aaddff rowspan=3><% multilang("956" "LANG_TONECYCLE"); %></td>
...
-->
 ...
 <tr>
  <td bgColor=#ddeeff><% multilang("957" "LANG_CYCLE_NO"); %>:
 ...
 <tr>
  <td bgColor=#ddeeff><font size=1><% multilang("958" "LANG_0_CYCLE_IS_CONTINUOUS"); %></font>
  </td>
 </tr>
 ...
 <tr>
  <td bgColor=#aaddff>CadNum</td>
     <td bgColor=#ddeeff>
  <input type=text name=cadNUM size=10 maxlength=2 value=<%voip_tone_get("cadNUM");%>> <font size=1>(<% multilang("959" "LANG_1_4_FOR_ADDITIVE_MODULATED_SUCC_SUCC_ADD_1_32_FOR_FOUR_FREQ_2_FOR_STEP_INC_TWO_STEP"); %>)</font></td>
 </tr>

   <tr>
  <td bgColor=#aaddff>CadOn0</td>
     <td bgColor=#ddeeff><input type=text name=CadOn0 size=20 maxlength=9 value="<%voip_tone_get("CadOn0");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>

   <tr>
  <td bgColor=#aaddff>CadOff0</td>
     <td bgColor=#ddeeff><input type=text name=CadOff0 size=20 maxlength=9 value="<%voip_tone_get("CadOff0");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>

   <tr>
  <td bgColor=#aaddff>CadOn1</td>
     <td bgColor=#ddeeff><input type=text name=CadOn1 size=20 maxlength=9 value="<%voip_tone_get("CadOn1");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff1</td>
     <td bgColor=#ddeeff><input type=text name=CadOff1 size=20 maxlength=9 value="<%voip_tone_get("CadOff1");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn2</td>
     <td bgColor=#ddeeff><input type=text name=CadOn2 size=20 maxlength=9 value="<%voip_tone_get("CadOn2");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff2</td>
     <td bgColor=#ddeeff><input type=text name=CadOff2 size=20 maxlength=9 value="<%voip_tone_get("CadOff2");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn3</td>
     <td bgColor=#ddeeff><input type=text name=CadOn3 size=20 maxlength=9 value="<%voip_tone_get("CadOn3");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>

   <tr>
  <td bgColor=#aaddff>CadOff3</td>
     <td bgColor=#ddeeff><input type=text name=CadOff3 size=20 maxlength=9 value="<%voip_tone_get("CadOff3");%>"> <font size=1>(<% multilang("861" "LANG_MSEC");%>)</font></td>
 </tr>
...
-->
 ...
 <tr>
  <td bgColor=#ddeeff><font size=1><% multilang("962" "LANG_FREQ2_IS_SUPPORTED_WHEN_SUCC_FOUR_FREQ_STEP_INC_TWO_STEP_TONE_TYPE");%></font>
  </td>
 </tr>

    <tr>
     <td bgColor=#aaddff rowspan=2><% multilang("961" "LANG_FREQ");%>3</td>
     <td bgColor=#ddeeff>
 ...
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Tone" value="<% multilang("279" "LANG_APPLY");%>" >
      &nbsp;&nbsp;&nbsp;&nbsp;
...
<table cellSpacing=1 cellPadding=2 border=0 width=400>
 ...
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Distone" value="<% multilang("279" "LANG_APPLY"); %>" >
    </td>
 </tr>
</table>
