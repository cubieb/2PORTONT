...
function addClick()
{
 ...
 if (checkDest(document.route.destNet, document.route.subMask) == true) {
  alert("<% multilang("2310" "LANG_THE_SPECIFIED_MASK_PARAMETER_IS_INVALID_DESTINATION_MASK_DESTINATION"); %>");
  document.route.subMask.focus();
  return false;
 }
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("36" "LANG_ROUTING"); %><% multilang("212" "LANG_CONFIGURATION"); %></font></h2>

<form action=/boaform/formRouting method=POST name="route">
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("383" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_ROUTING_INFORMATION_HERE_YOU_CAN_ADD_DELETE_IP_ROUTES"); %>
  </font></td></tr>
...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  ...
  <input type="submit" value="<% multilang("386" "LANG_ADD_ROUTE"); %>" name="addRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input type="submit" value="<% multilang("387" "LANG_UPDATE"); %>" name="updateRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input type="submit" value="<% multilang("198" "LANG_DELETE_SELECTED"); %>" name="delRoute" onClick="return deleteClick()">&nbsp;&nbsp;
  <input type="button" value="<% multilang("388" "LANG_SHOW_ROUTES"); %>" name="showRoute" onClick="routeClick('/routetbl.asp')">
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><font size=2><b><% multilang("389" "LANG_STATIC_ROUTE_TABLE"); %>:</b></font></tr>
  <% showStaticRoute(); %>
</table>
  <br>
