...
function applyclick()
{
 ...
 {
  alert("<% multilang("2376" "LANG_INVALID_PIN_CODE_VALUE"); %>");
 ...
 {
  alert("<% multilang("2377" "LANG_INVALID_APN_VALUE_APN_MUST_BE_A_STRING_WITHOUT_ANY_SPACE"); %>");
 ...
 {
  alert("<% multilang("2378" "LANG_INVALID_DIAL_NUMBER_VALUE_DIAL_NUMBER_MUST_BE_A_PHONE_NUMBER"); %>");
 ...
 if( document.form3gconf.auth.selectedIndex!=3 )
 {
  ...
  if (document.form3gconf.username.value=="") {
   alert("<% multilang("2379" "LANG_USER_NAME_CANNOT_BE_EMPTY"); %>");
   document.form3gconf.username.focus();
   return false;
  }
  if (includeSpace(document.form3gconf.username.value)) {
   alert("<% multilang("2380" "LANG_CANNOT_ACCEPT_SPACE_CHARACTER_IN_USER_NAME"); %>");
   document.form3gconf.username.focus();
   return false;
  }
  ...
  if (document.form3gconf.password.value=="") {
   alert("<% multilang("2381" "LANG_PASSWORD_CANNOT_BE_EMPTY"); %>");
   document.form3gconf.password.focus();
   return false;
  }
  if (includeSpace(document.form3gconf.password.value)) {
   alert("<% multilang("2382" "LANG_CANNOT_ACCEPT_SPACE_CHARACTER_IN_PASSWORD"); %>");
   document.form3gconf.password.focus();
   return false;
  }
 ...
 if (document.form3gconf.ctype.selectedIndex == 1)
 {
  ...
  {
   alert("<% multilang("2383" "LANG_INVALID_IDLE_TIME"); %>");
 ...
 {
  alert("<% multilang("2384" "LANG_INVALID_MTU_VALUE_YOU_SHOULD_SET_A_VALUE_BETWEEN_65_1500"); %>");
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("16" "LANG_3G_SETTINGS"); %></font></h2>
<form action=/boaform/admin/form3GConf method=POST name="form3gconf">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("282" "LANG_PAGE_DESC_3G_CONFIGURE"); %>
  </font></td></tr>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr>
      <td width="30%"><font size=2><b>3G <% multilang("11" "LANG_WAN"); %>:</b></td>
      <td width="70%"><font size=2>
       <input type="radio" name="enable3g" value=0 <% fm3g_checkWrite("fm3g-enable-dis"); %> ><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
       <input type="radio" name="enable3g" value=1 <% fm3g_checkWrite("fm3g-enable-en"); %> ><% multilang("222" "LANG_ENABLE"); %>
      </td>
  </tr>
<!--ISP-related-->
  <tr>
      <td width="30%"><font size=2><b><% multilang("283" "LANG_PIN_CODE"); %>:</b></td>
      <td width="70%"><input type="text" name="pin" size="32" maxlength="4" value="<% fm3g_checkWrite("fm3g-pin"); %>"></td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("284" "LANG_APN"); %>:</b></td>
      <td width="70%"><input type="text" name="apn" size="32" maxlength="63" value="<% fm3g_checkWrite("fm3g-apn"); %>"></td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("285" "LANG_DIAL_NUMBER"); %>:</b></td>
...
<!--PPP-related-->
 ...
 <select size=1 name="auth" onChange="authchange()">
  <option <% fm3g_checkWrite("fm3g-auth-auto"); %> value=0><% multilang("151" "LANG_AUTO"); %></option>
  <option <% fm3g_checkWrite("fm3g-auth-pap"); %> value=1>PAP</option>
  <option <% fm3g_checkWrite("fm3g-auth-chap"); %> value=2>CHAP</option>
  <option <% fm3g_checkWrite("fm3g-auth-none"); %> value=3><% multilang("291" "LANG_NONE"); %></option>
 </select>
      </td>
  </tr>
  <tr>
  ...
  <tr>
      <td width="30%"><font size=2><b><% multilang("230" "LANG_CONNECTION_TYPE"); %>:</b></td>
      <td width="70%">
 <select size=1 name="ctype" onChange="ctypechange()" <% fm3g_checkWrite("fm3g-ctype-bu"); %> > <!-- paula, 3g backup PPP-->
  <option <% fm3g_checkWrite("fm3g-ctype-cont"); %> value=0><% multilang("292" "LANG_CONTINUOUS"); %></option>
  <option <% fm3g_checkWrite("fm3g-ctype-demand"); %> value=1><% multilang("293" "LANG_CONNECT_ON_DEMAND"); %></option>
  <option <% fm3g_checkWrite("fm3g-ctype-manual"); %> value=2><% multilang("406" "LANG_MANUAL"); %></option>
 </select>
      </td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("288" "LANG_IDLE_TIME_MIN"); %>:</b></td>
...
<!--Network-related-->
  <tr>
      <td width="30%"><font size=2><b><% multilang("289" "LANG_NAPT"); %>:</b></td>
      <td width="70%"><font size=2>
       <input type="radio" name="napt" value=0 <% fm3g_checkWrite("fm3g-napt-dis"); %> ><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
       <input type="radio" name="napt" value=1 <% fm3g_checkWrite("fm3g-napt-en"); %> ><% multilang("222" "LANG_ENABLE"); %>
      </td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("236" "LANG_DEFAULT_ROUTE"); %>:</b></td>
      <td width="70%"><font size=2>
   <!-- 3g backup PPP, disable default route, paula-->
       <input type="radio" name="droute" value=0 <% fm3g_checkWrite("fm3g-droute-dis"); %> <% fm3g_checkWrite("fm3g-droute-bu"); %> ><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
       <input type="radio" name="droute" value=1 <% fm3g_checkWrite("fm3g-droute-en"); %> <% fm3g_checkWrite("fm3g-droute-bu"); %> ><% multilang("222" "LANG_ENABLE"); %>
      <!-- end 3g backup PPP disable default route-->
   </td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("290" "LANG_MTU"); %>:</b></td>
      <td width="70%"><input type="text" name="mtu" size="32" maxlength="4" value="<% fm3g_checkWrite("fm3g-mtu"); %>"></td>
  </tr>
  <!--3g backup PPP, paula-->
  <tr>
      <td width="30%"><font size=2><b><% multilang("286" "LANG_BACKUP_FOR_ADSL"); %>:</b></td>
      <td width="70%"><font size=2>
       <input type="radio" name="backup" value=0 onClick="backupenable(this.value)" <% fm3g_checkWrite("fm3g-backup-dis"); %> ><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
       <input type="radio" name="backup" value=1 onClick="backupenable(this.value)" <% fm3g_checkWrite("fm3g-backup-en"); %> ><% multilang("222" "LANG_ENABLE"); %>
      </td>
  </tr>
  <tr>
      <td width="30%"><font size=2><b><% multilang("287" "LANG_BACKUP_TIMER_SEC"); %>:</b></td>
...
<br>
      ...
      <input type="reset" value="<% multilang("281" "LANG_UNDO"); %>" name="reset" onClick="window.location.reload()">
