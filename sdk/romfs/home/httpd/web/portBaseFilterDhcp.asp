...
<title><% multilang("306" "LANG_PORT_BASED_FILTER"); %></title>
...
<body onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF"><% multilang("306" "LANG_PORT_BASED_FILTER"); %></font></h2>

<table border=0 width="480" cellspacing=0 cellpadding=0>
  <tr><td><font size=2>
  <% multilang("307" "LANG_PAGE_DESC_CONFIGURE_PORT_BASED_FILTERING"); %>
  </font></td></tr>
