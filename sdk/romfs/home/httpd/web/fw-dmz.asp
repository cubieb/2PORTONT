...
<title>DMZ <% multilang("212" "LANG_CONFIGURATION"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF">DMZ <% multilang("212" "LANG_CONFIGURATION"); %></font></h2>

<table border=0 width="500" cellspacing=0 cellpadding=0>
 <tr><td><font size=2>
 <% multilang("365" "LANG_A_DEMILITARIZED_ZONE_IS_USED_TO_PROVIDE_INTERNET_SERVICES_WITHOUT_SACRIFICING_UNAUTHORIZED_ACCESS_TO_ITS_LOCAL_PRIVATE_NETWORK_TYPICALLY_THE_DMZ_HOST_CONTAINS_DEVICES_ACCESSIBLE_TO_INTERNET_TRAFFIC_SUCH_AS_WEB_HTTP_SERVERS_FTP_SERVERS_SMTP_E_MAIL_SERVERS_AND_DNS_SERVERS"); %>
 </font></td></tr>
...
<form action=/boaform/formDMZ method=POST name="formDMZ">
 <table border=0 width="500" cellspacing=0 cellpadding=0>
 <tr><td><font size=2><b><% multilang("366" "LANG_DMZ_HOST"); %>:</b></td>
       <td><font size=2>
  <input type="radio" value="0" name="dmzcap" <% checkWrite("dmz-cap0"); %> onClick="updateState()"><% multilang("221" "LANG_DISABLE"); %>&nbsp;&nbsp;
  <input type="radio" value="1" name="dmzcap" <% checkWrite("dmz-cap1"); %> onClick="updateState()"><% multilang("222" "LANG_ENABLE"); %>&nbsp;&nbsp;
       </td>
 </font></td></tr>
 <tr>
  <td><font size=2><b><% multilang("366" "LANG_DMZ_HOST"); %> <% multilang("83" "LANG_IP_ADDRESS"); %>: </b></font></td>
