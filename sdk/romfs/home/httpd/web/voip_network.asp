...
<p>
<b><% multilang("1007" "LANG_DSCP_FLAG"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=450>
     <tr>
     <td bgColor=#aaddff><% multilang("1008" "LANG_SIP_DSCP"); %></td>
  <td bgColor=#ddeeff>
  <select name=sipDscp>
 ...
 <tr>
     <td bgColor=#aaddff><% multilang("1009" "LANG_RTP_DSCP"); %></td>
  <td bgColor=#ddeeff>
  <select name=rtpDscp>
...
<tr>
    <td colspan=3 align=center>
     <input type="submit" value="<% multilang("279" "LANG_APPLY"); %>" onclick="return check_network()">
     &nbsp;&nbsp;&nbsp;&nbsp;
