...
<title><% multilang("643" "LANG_WLAN_SITE_SURVEY"); %></title>
...
function saveClickSSID()
{
 ...
 if(document.getElementById("pocket_encrypt").value == "no"){
  ...
  if(document.getElementById("pocket_wpa2_tkip_aes").value.indexOf("aes")!=-1){
   ...
   alert("<% multilang("2401" "LANG_ERROR_NOT_SUPPORTED_WPA2_CIPHER_SUITE"); %>");//Added for test
  }
 }
  ...
  if(document.getElementById("pocket_wpa_tkip_aes").value.indexOf("aes")!=-1){
   ...
   alert("<% multilang("2402" "LANG_ERROR_NOT_SUPPORTED_WPA_CIPHER_SUITE"); %>");//Added for test
  }
 }
 else{
  alert("<% multilang("2403" "LANG_ERROR_NOT_SUPPORTED_ENCRYPT"); %>");//Added for test
 }
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("643" "LANG_WLAN_SITE_SURVEY"); %></font></h2>

<table border=0 width="500" cellspacing=0 cellpadding=0>
<tr><td><font size=2>
 <% multilang("644" "LANG_THIS_PAGE_PROVIDES_TOOL_TO_SCAN_THE_WIRELESS_NETWORK_IF_ANY_ACCESS_POINT_OR_IBSS_IS_FOUND_YOU_COULD_CHOOSE_TO_CONNECT_IT_MANUALLY_WHEN_CLIENT_MODE_IS_ENABLED"); %>
</font></td></tr>
...
<br>
  ...
  <input type="button" value="<% multilang("1137" "LANG_NEXT_STEP"); %>" name="next" onClick="saveClickSSID()">
</span>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
    ...
    <tr id="show_wep_auth" style="display:none">
     <td colspan="2" width="100%">
      <table width="100%" border="0" cellpadding="0" cellspacing="4">
        ...
        <td width="70%" class="bggrey"><font size="2">
         <input name="auth_type" type=radio value="open" checked><% multilang("177" "LANG_OPEN_SYSTEM"); %>
 ...
 <tr id="show_8021x_eap" style="display:none">
  ...
  <br>
  <input type="button" value="<% multilang("1138" "LANG_BACK"); %>" name="back" onClick="return backClick()">
  <input type="submit" value="<% multilang("92" "LANG_CONNECT"); %>" name="connect" onClick="return connectClick()">
  </span>
