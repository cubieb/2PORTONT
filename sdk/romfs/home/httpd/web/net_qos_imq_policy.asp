<html>
<head>
<title>IP QoS <% multilang("212" "LANG_CONFIGURATION"); %></title>
...
function queue_display() {
 ...
 if (document.forms[0].queuepolicy[0].checked)
  hcell.innerHTML = '<% multilang("611" "LANG_PRIORITY"); %>';
 else
 ...
 for(var i = 0; i < queues.length; i++) {
  ...
  document.getElementById('displayTotalBandwidth').innerHTML=
   '<p><% multilang("612" "LANG_TOTAL_BANDWIDTH_LIMIT"); %>:<input type="text" name="totalbandwidth" id="totalbandwidth" value="1005">Kb</p>';
...
<blockquote>
 <DIV align="left" style="padding-left:20px; padding-top:5px;">
  <h2><font color="#0000FF">IP QoS <% multilang("212" "LANG_CONFIGURATION"); %></font></h2>
  ...
  <table border=0 width="500" cellspacing=4 cellpadding=0>
     <tr>
      <td><font size=2><b><% multilang("1194" "LANG_IP_QOS"); %></b></td>
     <td><font size=2><input type="radio" name=qosen value=0 onClick=qosen_click();><% multilang("221" "LANG_DISABLE"); %></td>
      <td><font size=2><input type="radio" name=qosen value=1 onClick=qosen_click();><% multilang("222" "LANG_ENABLE"); %></td>
   </tr>
    </table>

    <div id="qosPly" style="display:none">
    <p><strong>QoS <% multilang("606" "LANG_QUEUE_CONFIG"); %></strong></p>
    <p><% multilang("607" "LANG_PAGE_DESC_CONFIGURE_QOS_POLICY"); %></p>
    <table>
     <tr>
    <td><font size=2><b><% multilang("580" "LANG_POLICY"); %>:</b></td>
    <td><font size=2><input type="radio" name="queuepolicy" value="prio" onClick=qpolicy_click();><% multilang("608" "LANG_PRIO"); %></td>
    <td><font size=2><input type="radio" name="queuepolicy" value="wrr" onClick=qpolicy_click();><% multilang("609" "LANG_WRR"); %></td>
   </tr>
    </table>
   ...
   <tr class="hdb" align="center" nowrap bgcolor="#CCCCCC">
    ...
    <td><font size=2><% multilang("222" "LANG_ENABLE"); %></td>
   </tr>
    </table>
    <br>
   ...
   <tr><td ID="displayTotalBandwidth"></td></tr>
    ...
    <br><br>
    <input type="button" class="button" value="<% multilang("134" "LANG_APPLY_CHANGES"); %>" onClick="on_save();">
