...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("1123" "LANG_SET_SCRIPTS_THAT_ARE_EXECUTED_IN_SYSTEM_INITIALING"); %>
  </font></td></tr>
...
<table border=0 width="500" cellspacing=8 cellpadding=0>
  ...
  <td colspan=3><input type="file" value=<% multilang("476" "LANG_CHOOSE_FILE"); %> name="start_text" size=36></td>
  <td><input type="submit" value=<% multilang("524" "LANG_UPLOAD"); %> name="start_upload"></td>
  </form>
  </tr>
  <tr valign="top">
  <td width=50>
   <input type="submit" value=<% multilang("1124" "LANG_SHOW_SCRIPT_CONTENT"); %> name="start_show" onClick=ShowStartScriptClick("/StartScriptContent.asp")>&nbsp;
  </td>
  <td>
   <form action=/boaform/formInitStartScriptDel method=POST name="init_st_script_del" onSubmit="return confirmAction()">
   <input type="submit" value=<% multilang("1125" "LANG_DELETE_SCRIPT"); %> name="start_delete"></td>
   </form>
  </td>
  <td colspan=2>&nbsp;</td>
  </tr>
...
<table border=0 width="500" cellspacing=8 cellpadding=0>
  ...
  <td colspan=3><input type="file" value=<% multilang("476" "LANG_CHOOSE_FILE"); %> name="end_text" size=36></td>
  <td><input type="submit" value=<% multilang("524" "LANG_UPLOAD"); %> name="end_upload"></td>
  </form>
  </tr>
  <tr valign="top">
  <td width=50>
   <input type="submit" value=<% multilang("1124" "LANG_SHOW_SCRIPT_CONTENT"); %> name="end_show" onClick=ShowEndScriptClick("/EndScriptContent.asp")>&nbsp;
  </td>
  <td>
   <form action=/boaform/formInitEndScriptDel method=POST name="init_ed_script_del" onSubmit="return confirmAction()">
   <input type="submit" value=<% multilang("1125" "LANG_DELETE_SCRIPT"); %> name="end_delete"></td>
   </form>
  </td>
  <td colspan=2>&nbsp;</td>
  </tr>
