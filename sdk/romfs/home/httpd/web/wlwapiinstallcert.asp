...
{
  if (loop_num == 3) {
 alert("<% multilang("2404" "LANG_UPDATE_FIRMWARE_FAILED"); %>");
 return false;
  }
  if (time < 1)
 time = time + 0.033;
...
function sendClicked(F)
{
  if(document.uploadCert.asu_binary.value == "" && document.uploadCert==F){
   ...
   alert("<% multilang("2405" "LANG_FILE_NAME_CAN_NOT_BE_EMPTY"); %>");
   return false;
  }
...
<BODY>
<blockquote>
<h2><font color="#0000FF">WAPI <% multilang("10" "LANG_CERTIFICATION_INSTALLATION"); %></font></h2>

<form method="post" action="/boaform/formUploadWapiCert1" enctype="multipart/form-data" name="uploadCert">
<table border="0" cellspacing="4" width="500">
 <tr><font size=2>
 <% multilang("637" "LANG_THIS_PAGE_ALLOWS_YOU_TO_INSTALL_ASU_AND_USER_CERTIFICATION_FOR_YOUR_DEVICE_PLEASE_NOTE_CERTIFICATION_TYPE_X_509_IS_SUPPORTED_AT_PRESENT"); %>
 </tr>
 ...
 <!--
  ...
  -->
  <tr>
      <td width="20%"><font size=2><b>ASU <% multilang("638" "LANG_CERTIFICATION"); %>:</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td width="80%"><font size=2><input type="file" value=<% multilang("476" "LANG_CHOOSE_FILE"); %> name="asu_binary" size=20></td>
  </tr>
<!-- <tr>
...
-->
    ...
    <p> <input onclick=sendClicked(this.form) type=button value="<% multilang("524" "LANG_UPLOAD"); %>" name="send">&nbsp;&nbsp;
...
-->
  <tr>
      <td width="20%"><font size=2><b>User <% multilang("638" "LANG_CERTIFICATION"); %>:</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td width="80%"><font size=2><input type="file" value=<% multilang("476" "LANG_CHOOSE_FILE"); %> name="user_binary" size=20></td>
  </tr>
  </table>
    <p> <input onclick=sendClicked(this.form) type=button value="<% multilang("524" "LANG_UPLOAD"); %>" name="send">&nbsp;&nbsp;
        <input type="reset" value="<% multilang("196" "LANG_RESET"); %>" name="reset">
