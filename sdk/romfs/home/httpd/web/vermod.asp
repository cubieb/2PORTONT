...
<title><% multilang("622" "LANG_VERSION"); %> </title>
...
function exportClick()
{
 ...
 alert('<% multilang("1013" "LANG_PAGE_DESC_WAIT_INFO"); %>!');
...
<form action=/boaform/formVersionMod method=POST name="vermod">
 <h2><font color="#0000FF"><% multilang("622" "LANG_VERSION"); %></font></h2>
...
<table border="0" cellspacing="4" width="500">
 <tr><td><font size=2>
 <% multilang("490" "LANG_PAGE_DESC_UPGRADE_FIRMWARE"); %> </font></td></tr>
...
<blockquote>
<DIV align="left" style="padding-left:20px; padding-top:5px">
<h2><font color="#0000FF"><% multilang("1012" "LANG_OMCI"); %></font></h2>
  <form action=/boaform/formExportOMCIlog method=POST name="exportOMCIlog">
  <tr>
    <td width="40%"><font size=2><b><% multilang("1010" "LANG_EXPORT"); %>:</b></font></td>
    <td width="30%"><font size=2>
      <input type="submit" value="<% multilang("1010" "LANG_EXPORT"); %>" name="save_cs" onclick="return exportClick()">
    </font></tr>
  </form>
...
<DIV align="left" style="padding-left:20px; padding-top:5px">
  ...
  <tr>
    <td width="40%"><font size=2><b><% multilang("1011" "LANG_IMPORT"); %>:</b></font></td>
    <td width="30%"><font size=2><input type="file" value="<% multilang("476" "LANG_CHOOSE_FILE"); %>" name="binary" size=24></font></td>
    <td width="20%"><font size=2><input type="submit" value="<% multilang("1011" "LANG_IMPORT"); %>" name="load" onclick="return uploadClick()"></font></td>
  </tr>
  </form>
