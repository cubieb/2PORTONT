...
<title><% multilang("1118" "LANG_EPON_SETTINGS"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("1118" "LANG_EPON_SETTINGS"); %></font></h2>
<form action=/boaform/admin/formeponConf method=POST name="formeponconf">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("1119" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_EPON_NETWORK_ACCESS"); %>
  </font></td></tr>
...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><font size=2><b><% multilang("1120" "LANG_LLID_MAC_MAPPING_TABLE"); %>:</b></font></tr>
