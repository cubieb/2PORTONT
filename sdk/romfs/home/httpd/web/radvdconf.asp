...
<title>RADVD <% multilang("212" "LANG_CONFIGURATION"); %></title>
...
function saveChanges()
{
 if (document.radvd.MaxRtrAdvIntervalAct.value.length !=0) {
  if ( checkDigit(document.radvd.MaxRtrAdvIntervalAct.value) == 0) {
   alert("<% multilang("2264" "LANG_INVALID_MAXRTRADVINTERVAL_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( MaxRAI < 4 || MaxRAI > 1800 ) {
  alert("<% multilang("2265" "LANG_MAXRTRADVINTERVAL_MUST_BE_NO_LESS_THAN_4_SECONDS_AND_NO_GREATER_THAN_1800_SECONDS"); %>");
  document.radvd.MaxRtrAdvIntervalAct.focus();
  return false;
 }
 ...
 if (document.radvd.MinRtrAdvIntervalAct.value.length !=0) {
  if ( checkDigit(document.radvd.MinRtrAdvIntervalAct.value) == 0) {
   alert("<% multilang("2266" "LANG_INVALID_MINRTRADVINTERVAL_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( MinRAI < 3 || MinRAI > MaxRAI075 ) {
  alert("<% multilang("2267" "LANG_MINRTRADVINTERVAL_MUST_BE_NO_LESS_THAN_3_SECONDS_AND_NO_GREATER_THAN_0_75_MAXRTRADVINTERVAL"); %>");
  document.radvd.MinRtrAdvIntervalAct.focus();
  return false;
 }
 ...
 if (document.radvd.AdvCurHopLimitAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvCurHopLimitAct.value) == 0) {
   alert("<% multilang("2268" "LANG_INVALID_ADVCURHOPLIMIT_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvDefaultLifetimeAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvDefaultLifetimeAct.value) == 0) {
   alert("<% multilang("2269" "LANG_INVALID_ADVDEFAULTLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( dlt != 0 && (dlt < MaxRAI || dlt > 9000) ) {
  alert("<% multilang("2270" "LANG_ADVDEFAULTLIFETIME_MUST_BE_EITHER_ZERO_OR_BETWEEN_MAXRTRADVINTERVAL_AND_9000_SECONDS"); %>");
  document.radvd.AdvDefaultLifetimeAct.focus();
  return false;
 }
 ...
 if (document.radvd.AdvReachableTimeAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvReachableTimeAct.value) == 0) {
   alert("<% multilang("2271" "LANG_INVALID_ADVREACHABLETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvRetransTimerAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvRetransTimerAct.value) == 0) {
   alert("<% multilang("2272" "LANG_INVALID_ADVRETRANSTIMER_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvLinkMTUAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvLinkMTUAct.value) == 0) {
   alert("<% multilang("2273" "LANG_INVALID_ADVLINKMTU_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( lmtu != 0 && (lmtu < 1280 || lmtu > 1500) ) {
  alert("<% multilang("2274" "LANG_ADVLINKMTU_MUST_BE_EITHER_ZERO_OR_BETWEEN_1280_AND_1500"); %>");
  document.radvd.AdvLinkMTUAct.focus();
  return false;
 }
  ...
  if (document.radvd.ULAPrefix.value =="") {
   alert("<% multilang("2275" "LANG_ULA_PREFIX_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_FC01"); %>");
   document.radvd.ULAPrefix.focus();
   return false;
  } else {
   if ( validateKeyV6IP(document.radvd.ULAPrefix.value) == 0) {
    alert("<% multilang("2276" "LANG_INVALID_ULA_PREFIX_IP"); %>");
    document.radvd.ULAPrefix.focus();
    return false;
   }
  }
   ...
   alert("<% multilang("2277" "LANG_ULA_PREFIX_LENGTH_CANNOT_BE_EMPTY_FOR_EXAMPLE_64"); %>");
   document.radvd.ULAPrefixlen.focus();
   return false;
  } else {
   if ( checkDigit(document.radvd.ULAPrefixlen.value) == 0) {
    alert("<% multilang("2278" "LANG_INVALID_ULA_PREFIX_LENGTH_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
    document.radvd.ULAPrefixlen.focus();
    return false;
   }
  }
  ...
  if (document.radvd.ULAPrefixValidTime.value =="") {
   alert("<% multilang("2279" "LANG_ULA_PREFIX_VALID_TIME_CANNOT_BE_EMPTY_VALID_RANGE_IS_600_4294967295"); %>");
   document.radvd.ULAPrefixlen.focus();
   return false;
  } else if ( checkDigit(document.radvd.ULAPrefixValidTime.value) == 0) {
    alert("<% multilang("2280" "LANG_INVALID_ULAPREFIXVALIDTIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if (document.radvd.ULAPrefixPreferedTime.value =="") {
   ...
   return false;
    ...
    alert("<% multilang("2281" "LANG_INVALID_ULAPREFIXPREFEREDTIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.PrefixMode.value == 1) {
  if (document.radvd.prefix_ip.value =="") {
   alert("<% multilang("2282" "LANG_PREFIX_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_3FFE_501_FFFF_100"); %>");
   ...
   if ( validateKeyV6IP(document.radvd.prefix_ip.value) == 0) {
    alert("<% multilang("2283" "LANG_INVALID_PREFIX_IP"); %>");
    document.radvd.prefix_ip.focus();
    return false;
   }
  }
  ...
  if (document.radvd.prefix_len.value =="") {
   alert("<% multilang("2284" "LANG_PREFIX_LENGTH_CANNOT_BE_EMPTY"); %>");
   ...
   if ( checkDigit(document.radvd.prefix_len.value) == 0) {
    alert("<% multilang("2285" "LANG_INVALID_PREFIX_LENGTH_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
    document.radvd.prefix_len.focus();
    return false;
   }
  }
  ...
  if (document.radvd.AdvValidLifetimeAct.value.length !=0) {
   if ( checkDigit(document.radvd.AdvValidLifetimeAct.value) == 0) {
    alert("<% multilang("2286" "LANG_INVALID_ADVVALIDLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if (document.radvd.AdvPreferredLifetimeAct.value.length !=0) {
   if ( checkDigit(document.radvd.AdvPreferredLifetimeAct.value) == 0) {
    alert("<% multilang("2287" "LANG_INVALID_ADVPREFERREDLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if ( vlt <= plt ) {
   alert("<% multilang("2288" "LANG_ADVVALIDLIFETIME_MUST_BE_GREATER_THAN_ADVPREFERREDLIFETIME"); %>");
   document.radvd.AdvValidLifetimeAct.focus();
   return false;
  }
  ...
  if (document.radvd.RDNSS1.value !="") {
   if ( validateKeyV6IP(document.radvd.RDNSS1.value) == 0) {
    alert("<% multilang("2289" "LANG_INVALID_RDNSS1_IP"); %>");
  ...
  if (document.radvd.RDNSS2.value !="") {
   if ( validateKeyV6IP(document.radvd.RDNSS2.value) == 0) {
    alert("<% multilang("2290" "LANG_INVALID_RDNSS2_IP"); %>");
...
<body onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF">RADVD <% multilang("212" "LANG_CONFIGURATION"); %></font></h2>

<form action=/boaform/formRadvdSetup method=POST name="radvd">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("394" "LANG_THIS_PAGE_IS_USED_TO_SETUP_THE_RADVD_S_CONFIGURATION_OF_YOUR_DEVICE"); %>
  </font></td></tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr>
      <td width="30%"><font size=2><b><% multilang("395" "LANG_MAXRTRADVINTERVAL"); %>:</b></td>
      <td width="70%"><input type="text" name="MaxRtrAdvIntervalAct" size="15" maxlength="15" value=<% getInfo("V6MaxRtrAdvInterval"); %>></td>
  </tr>

  <tr>
      <td width="30%"><font size=2><b><% multilang("396" "LANG_MINRTRADVINTERVAL"); %>:</b></td>
      <td width="70%"><input type="text" name="MinRtrAdvIntervalAct" size="15" maxlength="15" value=<% getInfo("V6MinRtrAdvInterval"); %>></td>
  </tr>


  <tr><td width=200><font size=2><b><% multilang("403" "LANG_ADVMANAGEDFLAG"); %>:</b>&nbsp;&nbsp;</font></td>
      <td width=200><font size=2>
    <input type="radio" name="AdvManagedFlagAct" value=0 <% checkWrite("radvd_ManagedFlag0"); %>><% multilang("420" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="AdvManagedFlagAct" value=1 <% checkWrite("radvd_ManagedFlag1"); %>><% multilang("419" "LANG_ON"); %>&nbsp;&nbsp;
     </font></td>
  </tr>

  <tr><td width=200><font size=2><b><% multilang("404" "LANG_ADVOTHERCONFIGFLAG"); %>:</b>&nbsp;&nbsp;</font></td>
      <td width=200><font size=2>
    <input type="radio" name="AdvOtherConfigFlagAct" value=0 <% checkWrite("radvd_OtherConfigFlag0"); %>><% multilang("420" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="AdvOtherConfigFlagAct" value=1 <% checkWrite("radvd_OtherConfigFlag1"); %>><% multilang("419" "LANG_ON"); %>&nbsp;&nbsp;
     </font></td>
  </tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
  ...
  <tr><td width=200><font size=2><b><% multilang("402" "LANG_ADVSENDADVERT"); %>:</b>&nbsp;&nbsp;</font></td>
      <td width=200><font size=2>
    <input type="radio" name="AdvSendAdvertAct" value=0 <% checkWrite("radvd_SendAdvert0"); %>><% multilang("420" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="AdvSendAdvertAct" value=1 <% checkWrite("radvd_SendAdvert1"); %>><% multilang("419" "LANG_ON"); %>&nbsp;&nbsp;
     </font></td>
  </tr>
  </table>
  ...
  <table border=0 width="400" cellspacing=4 cellpadding=0>
  <tr><td width=200><font size=2><b><% multilang("412" "LANG_ENABLE_ULA"); %>:</b>&nbsp;&nbsp;</font></td>
      <td width=200><font size=2>
    <input type="radio" name="EnableULA" value=0 <% checkWrite("radvd_EnableULAFlag0"); %> onClick="ULASelection();"><% multilang("420" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="EnableULA" value=1 <% checkWrite("radvd_EnableULAFlag1"); %> onClick="ULASelection();"><% multilang("419" "LANG_ON"); %>&nbsp;&nbsp;
     </font></td>
  </tr>
  </table>
  ...
  <tr>
      <td width=100><font size=2><% multilang("405" "LANG_PREFIX_MODE"); %>:</td>
      <td><font size=2><select size="1" name="PrefixMode" id="prefixmode" onChange="ramodechange(this)">
          <OPTION VALUE="0" > <% multilang("151" "LANG_AUTO"); %></OPTION>
          <OPTION VALUE="1" > <% multilang("406" "LANG_MANUAL"); %></OPTION>
   </select>
      </td>
  </tr>
  ...
  <div ID="radvdID" style="display:none">
       <table border=0 width="500" cellspacing=4 cellpadding=0>
         ...
         <tr><td width=200><font size=2><b><% multilang("411" "LANG_ADVAUTONOMOUS"); %>:</b>&nbsp;&nbsp;</font></td>
             <td width=200><font size=2>
  ...
  <tr>
      <td width="30%"><font size=2><b><% multilang("417" "LANG_RDNSS_1"); %>:</b></td>
      <td width="70%"><input type="text" name="RDNSS1" size="48" maxlength="48" value=<% getInfo("V6RDNSS1"); %>></td>
  </tr>


  <tr>
      <td width="30%"><font size=2><b><% multilang("418" "LANG_RDNSS_2"); %>:</b></td>
