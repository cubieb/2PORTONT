...
//CLI_DEFINE_VAR(_name, _family, _is_int, _is_vir, _is_dec, _get, _set)
//#define DEFINE_DDR_INT_VAR(name, is_dec, get_func_body, set_func_body) 
...
//DEFINE_DDR_INT_VAR(mcr, 1, {*result=_soc.dram_info->register_set->mcr.v; }, {_soc.dram_info->register_set->mcr.v=value;});

// example
//static int x, y;
//DEFINE_DDR_INT_VAR(cas, 1, {*result=x; }, {x=value;});
//DEFINE_DDR_STR_VAR(yyy, {ltostr(result, y, 10, 0);}, {y=atoi(value);});
