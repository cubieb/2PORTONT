...
// Cacahe Coherency Attribute Encoding
#define CCAE_UC_NO_CO           (2)
#define CCAE_CA_NC_CO_WB_WA	(3)
#define CCAE_CA_CO_WB_WA_EX	(4)
#define CCAE_CA_CO_WB_WA_SH	(5)
#define CCAE_UC_AC_NO_CO        (7)
