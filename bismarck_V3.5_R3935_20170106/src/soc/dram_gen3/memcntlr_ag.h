...
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_clk_dll_type(mc_cntlr_opt_t *str) {
	printf("  clk_dll_type: %d\n", str->clk_dll_type);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_clk_dll_type(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
...
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_oride_autok_param(mc_cntlr_opt_t *str) {
	printf("  oride_autok_param: %d\n", str->oride_autok_param);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_oride_autok_param(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_rx_win_sel_mul(mc_cntlr_opt_t *str) {
	printf("  rx_win_sel_mul: %d\n", str->rx_win_sel_mul);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_rx_win_sel_mul(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_rx_win_sel_div(mc_cntlr_opt_t *str) {
	printf("  rx_win_sel_div: %d\n", str->rx_win_sel_div);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_rx_win_sel_div(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_bin_phs_sel(mc_cntlr_opt_t *str) {
	printf("  bin_phs_sel: %d\n", str->bin_phs_sel);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_bin_phs_sel(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION static inline void mc_cntlr_opt_dump(void) {
	...
	mc_dump_dll_dis(str);
	mc_dump_clk_dll_type(str);
	mc_dump_dq_dll_type(str);
	mc_dump_cal_method(str);
	mc_dump_oride_autok_param(str);
	mc_dump_rx_win_sel_mul(str);
	mc_dump_rx_win_sel_div(str);
	mc_dump_bin_phs_sel(str);
}
...
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_ana_dll1(mc_register_set_t *str) {
	printf("  ana_dll1: %08x\n", str->ana_dll1.v);
	return;
}
...
MEMCNTLR_SECTION static inline void mc_xlat_n_assign(void) {
	...
	if (meminfo.cntlr_opt->clk_dll_type != -1) {
		mc_xlat_n_assign_clk_dll_type(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	...
	if (meminfo.cntlr_opt->oride_autok_param != -1) {
		mc_xlat_n_assign_oride_autok_param(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->rx_win_sel_mul != -1) {
		mc_xlat_n_assign_rx_win_sel_mul(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->rx_win_sel_div != -1) {
		mc_xlat_n_assign_rx_win_sel_div(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->bin_phs_sel != -1) {
		mc_xlat_n_assign_bin_phs_sel(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	return;
}
