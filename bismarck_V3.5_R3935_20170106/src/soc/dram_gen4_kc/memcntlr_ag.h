...
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_ddr2_odt_val(mc_cntlr_opt_t *str) {
	printf("  rtt_nom_ohm: %d\n", str->ddr2_odt_val);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_ddr2_odt_val(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
...
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_odt_clk(mc_cntlr_opt_t *str) {
	printf("  cntlr_odt_clk: %d\n", str->cntlr_odt_clk);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_odt_clk(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_ocd_clk(mc_cntlr_opt_t *str) {
	printf("  cntlr_ocd_clk: %d\n", str->cntlr_ocd_clk);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_ocd_clk(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);

MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_odt_adr(mc_cntlr_opt_t *str) {
	printf("  cntlr_odt_adr: %d\n", str->cntlr_odt_adr);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_odt_adr(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_ocd_adr(mc_cntlr_opt_t *str) {
	printf("  cntlr_ocd_adr: %d\n", str->cntlr_ocd_adr);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_ocd_adr(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);

MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_odt_dq(mc_cntlr_opt_t *str) {
	printf("  cntlr_odt_dq: %d\n", str->cntlr_odt_dq);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_odt_dq(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
MEMCNTLR_SECTION void __attribute__ ((weak)) mc_dump_cntlr_ocd_dq(mc_cntlr_opt_t *str) {
	printf("  cntlr_ocd_dq: %d\n", str->cntlr_ocd_dq);
	return;
}
MEMCNTLR_SECTION static inline void mc_xlat_n_assign_cntlr_ocd_dq(mc_dram_param_t * __attribute__ ((unused)), mc_cntlr_opt_t * __attribute__ ((unused)), mc_register_set_t *);
...
MEMCNTLR_SECTION static inline void mc_cntlr_opt_dump(void) {
    ...
    mc_dump_ddr2_odt_val(str);
	mc_dump_rtt_nom_ohm(str);
	mc_dump_rtt_wr_ohm(str);
	mc_dump_cntlr_odt(str);
	mc_dump_cntlr_ocd(str);
	mc_dump_cntlr_odt_clk(str);
	mc_dump_cntlr_ocd_clk(str);
	mc_dump_cntlr_odt_adr(str);
	mc_dump_cntlr_ocd_adr(str);
	mc_dump_cntlr_odt_dq(str);
	mc_dump_cntlr_ocd_dq(str);
...
MEMCNTLR_SECTION static inline void mc_xlat_n_assign(void) {
	...
	if (meminfo.cntlr_opt->ddr2_odt_val != -1) {
		mc_xlat_n_assign_ddr2_odt_val(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	...
	if (meminfo.cntlr_opt->cntlr_odt_clk != -1) {
		mc_xlat_n_assign_cntlr_odt(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->cntlr_ocd_clk != -1) {
		mc_xlat_n_assign_cntlr_ocd(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}	if (meminfo.cntlr_opt->cntlr_odt_adr != -1) {
		mc_xlat_n_assign_cntlr_odt(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->cntlr_ocd_adr != -1) {
		mc_xlat_n_assign_cntlr_ocd(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}	if (meminfo.cntlr_opt->cntlr_odt_dq != -1) {
		mc_xlat_n_assign_cntlr_odt(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
	if (meminfo.cntlr_opt->cntlr_ocd_dq != -1) {
		mc_xlat_n_assign_cntlr_ocd(dp, co, rs);
		if (ISTAT_GET(xlat) != MEM_XLAT_UNINIT) return;
	}
