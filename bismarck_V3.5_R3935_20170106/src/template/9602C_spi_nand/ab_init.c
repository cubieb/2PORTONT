...
char _nsu_table_init_fail_msg[] SECTION_RECYCLE_DATA = {"EE: plr mapping table init fail\n"};
char _nsu_probe_fail_msg[] SECTION_RECYCLE_DATA = {"EE: plr probe nand flash device fail\n"};
