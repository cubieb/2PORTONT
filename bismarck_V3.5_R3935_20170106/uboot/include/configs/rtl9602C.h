...
/* for SPI NAND flash */
#ifdef CONFIG_OTTO_SPI_NAND_GEN1
#define CONFIG_CMD_SPI_NAND 1
#endif

/* for ONFI flash */
#ifdef CONFIG_OTTO_ONFI_GEN1
#define CONFIG_CMD_ONFI 1
#endif
...
#define CONFIG_SYS_PROMPT	"9602C# "		/* Monitor Command Prompt	*/
...
#define SYSTEM_RESET() do { \
    *((volatile u32_t *)0xbb000104) = 0x000000FF; \
} while(0)
...
#elif defined (CONFIG_CMD_SPI_NAND)
    /****** SPI NAND flash ******/
    #define FL_64MB (64*1024*1024)
    #define FL_MAX_USE_64MB (FL_64MB-(1280*1024)) //reserve 1280KB(10 blocks) for 512Mbit NAND flash
    #define FL_64MB_CFGFS_BASE (1*1024*1024)
    #define FL_64MB_K0_BASE    (11*1024*1024)
    #define FL_64MB_K_SIZE     (8*1024*1024)
    #define FL_64MB_R0_BASE    (FL_64MB_K0_BASE+FL_64MB_K_SIZE)
    #define FL_64MB_R_SIZE     (((FL_MAX_USE_64MB-FL_64MB_K0_BASE)>>1)-FL_64MB_K_SIZE)
    #define FL_64MB_K1_BASE    (FL_64MB_R0_BASE+FL_64MB_R_SIZE)
    #define FL_64MB_R1_BASE    (FL_64MB_K1_BASE+FL_64MB_K_SIZE)
    
    #define FL_128MB (128*1024*1024)
    #define FL_MAX_USE_128MB (FL_128MB-(2560*1024)) //reserve 2560KB(20 blocks) for 1Gbit NAND flash
    #define FL_128MB_CFGFS_BASE (1*1024*1024)
    #define FL_128MB_K0_BASE    (25*1024*1024)
    #define FL_128MB_K_SIZE     (8*1024*1024)
    #define FL_128MB_R0_BASE    (FL_128MB_K0_BASE+FL_128MB_K_SIZE)
    #define FL_128MB_R_SIZE     (((FL_MAX_USE_128MB-FL_128MB_K0_BASE)>>1)-FL_128MB_K_SIZE)
    #define FL_128MB_K1_BASE    (FL_128MB_R0_BASE+FL_128MB_R_SIZE)
    #define FL_128MB_R1_BASE    (FL_128MB_K1_BASE+FL_128MB_K_SIZE)
#elif defined (CONFIG_CMD_ONFI)
    /****** SPI NAND flash ******/
    #define FL_64MB (64*1024*1024)
    #define FL_MAX_USE_64MB (FL_64MB-(1280*1024)) //reserve 1280KB(10 blocks) for 512Mbit NAND flash
