...
#define IMEM0_MASK	(0x1)
#define IMEM1_MASK	(0x2)
#define DMEM0_MASK	(0x4)
#define DMEM1_MASK	(0x8)
#define L2MEM_MASK	(0x10)
//#define IDMEM_TEST_SEL	(IMEM0_MASK|IMEM1_MASK|DMEM0_MASK|DMEM1_MASK)
#define IDMEM_TEST_SEL	(IMEM0_MASK|DMEM0_MASK)
...
/*16KB IMEM1*/
#define IMEM1_SIZE 0x4000
/*16KB DMEM0*/
#define DMEM0_SIZE 0x4000
/*16KB DMEM1*/
#define DMEM1_SIZE 0x4000
/*0KB L2MEM*/
#define L2MEM_SIZE 0x0

#define IMEM_SIZE 0x4000
#define DMEM_SIZE 0x2000


//#define BACKUP_SIZE 0x4000
//#define BACKUP_ADDR 0xA0400000
...
#ifndef __ASSEMBLY__
extern int iDMemTestCase1(void);
extern int iDMemTestCase2(void);
extern int iDMemTestCase3(void);
extern int iDMemTestCase4(void);
extern int iDMemTestCase5(void);
extern int iDMemTestCase6(void);
extern int iDMemTestCase7(void);
extern int iDMemTestCase8(void);
extern int iDMemTestCase9(void);
extern int iDMemTestCase10(void);
extern int iDMemTestCase11(void);
extern int iDMemTestCase12(void);
#endif //__ASSEMBLY__
