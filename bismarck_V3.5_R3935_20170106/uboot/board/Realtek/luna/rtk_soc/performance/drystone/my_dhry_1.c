...
/* Global Variables: */
 ...
 __attribute__ ((section (".my_ptr"))) Rec_Pointer     Ptr_Glob;
 __attribute__ ((section (".my_ptr"))) Rec_Pointer     Next_Ptr_Glob;
 __attribute__ ((section (".my_ptr"))) Boolean         Bool_Glob;
 int             Int_Glob;
 int             Arr_1_Glob [50];
 ...
 double          Microseconds,
                 ...
                 Vax_Mips;
#endif
__attribute__ ((section (".my_ptr"))) unsigned int          Begin_Time,
                 End_Time,
                 User_Time;
 
__attribute__ ((section (".my_ptr"))) unsigned int          Microseconds,
                 Dhrystones_Per_Second,
                 Vax_Mips;
