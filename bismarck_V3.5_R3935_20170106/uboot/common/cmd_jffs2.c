...
#ifndef CONFIG_JFFS2_PART_OFFSET
static inline u32 get_jffs2_part_offset(void)
{
#error ERROR: Revise get_jffs2_part_offset() for correct JFFS2 partition offset.
	return 0;
}
#endif

#ifndef CONFIG_JFFS2_PART_SIZE
static inline u32 get_jffs2_part_size(u32 cur_off)
{
#error ERROR: Revise get_jffs2_part_size() for correct JFFS2 partition size.
	return 0;
}
#endif
